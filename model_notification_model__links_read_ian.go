...
// checks if the NotificationModelLinksReadIAN type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationModelLinksReadIAN{}

// NotificationModelLinksReadIAN struct for NotificationModelLinksReadIAN
type NotificationModelLinksReadIAN struct {
...
type _NotificationModelLinksReadIAN NotificationModelLinksReadIAN
...
func NewNotificationModelLinksReadIAN(href string) *NotificationModelLinksReadIAN {
	this := NotificationModelLinksReadIAN{}
	this.Href = href
...
func (o NotificationModelLinksReadIAN) MarshalJSON() ([]byte, error) {
...
func (o NotificationModelLinksReadIAN) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationModelLinksReadIAN) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationModelLinksReadIAN := _NotificationModelLinksReadIAN{}

	err = json.Unmarshal(data, &varNotificationModelLinksReadIAN)

	if err != nil {
		return err
	}

	*o = NotificationModelLinksReadIAN(varNotificationModelLinksReadIAN)
...
type NullableNotificationModelLinksReadIAN struct {
	value *NotificationModelLinksReadIAN
	isSet bool
}

func (v NullableNotificationModelLinksReadIAN) Get() *NotificationModelLinksReadIAN {
	return v.value
}

func (v *NullableNotificationModelLinksReadIAN) Set(val *NotificationModelLinksReadIAN) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationModelLinksReadIAN) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationModelLinksReadIAN) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationModelLinksReadIAN(val *NotificationModelLinksReadIAN) *NullableNotificationModelLinksReadIAN {
	return &NullableNotificationModelLinksReadIAN{value: val, isSet: true}
}

func (v NullableNotificationModelLinksReadIAN) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationModelLinksReadIAN) UnmarshalJSON(src []byte) error {
	v.isSet = true
