...
// checks if the MeetingModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeetingModelLinksProject{}

// MeetingModelLinksProject struct for MeetingModelLinksProject
type MeetingModelLinksProject struct {
...
type _MeetingModelLinksProject MeetingModelLinksProject
...
func (o MeetingModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o MeetingModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *MeetingModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varMeetingModelLinksProject := _MeetingModelLinksProject{}

	err = json.Unmarshal(data, &varMeetingModelLinksProject)

	if err != nil {
		return err
	}

	*o = MeetingModelLinksProject(varMeetingModelLinksProject)
...
type NullableMeetingModelLinksProject struct {
	value *MeetingModelLinksProject
	isSet bool
}

func (v NullableMeetingModelLinksProject) Get() *MeetingModelLinksProject {
	return v.value
}

func (v *NullableMeetingModelLinksProject) Set(val *MeetingModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableMeetingModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableMeetingModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeetingModelLinksProject(val *MeetingModelLinksProject) *NullableMeetingModelLinksProject {
	return &NullableMeetingModelLinksProject{value: val, isSet: true}
}

func (v NullableMeetingModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeetingModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
