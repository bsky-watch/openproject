...
// checks if the StorageWriteModelLinksType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageWriteModelLinksType{}

// StorageWriteModelLinksType struct for StorageWriteModelLinksType
type StorageWriteModelLinksType struct {
...
type _StorageWriteModelLinksType StorageWriteModelLinksType
...
func NewStorageWriteModelLinksType(href string) *StorageWriteModelLinksType {
	this := StorageWriteModelLinksType{}
	this.Href = href
...
func (o *StorageWriteModelLinksType) SetHref(v string) {
	o.Href = v
}
...
func (o *StorageWriteModelLinksType) GetMethod() string {
...
func (o StorageWriteModelLinksType) MarshalJSON() ([]byte, error) {
...
func (o StorageWriteModelLinksType) ToMap() (map[string]interface{}, error) {
...
func (o *StorageWriteModelLinksType) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageWriteModelLinksType := _StorageWriteModelLinksType{}

	err = json.Unmarshal(data, &varStorageWriteModelLinksType)

	if err != nil {
		return err
	}

	*o = StorageWriteModelLinksType(varStorageWriteModelLinksType)
...
type NullableStorageWriteModelLinksType struct {
	value *StorageWriteModelLinksType
	isSet bool
}

func (v NullableStorageWriteModelLinksType) Get() *StorageWriteModelLinksType {
	return v.value
}

func (v *NullableStorageWriteModelLinksType) Set(val *StorageWriteModelLinksType) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageWriteModelLinksType) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageWriteModelLinksType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageWriteModelLinksType(val *StorageWriteModelLinksType) *NullableStorageWriteModelLinksType {
	return &NullableStorageWriteModelLinksType{value: val, isSet: true}
}

func (v NullableStorageWriteModelLinksType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageWriteModelLinksType) UnmarshalJSON(src []byte) error {
	v.isSet = true
