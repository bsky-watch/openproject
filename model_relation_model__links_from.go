...
// checks if the RelationModelLinksFrom type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelationModelLinksFrom{}

// RelationModelLinksFrom struct for RelationModelLinksFrom
type RelationModelLinksFrom struct {
...
type _RelationModelLinksFrom RelationModelLinksFrom
...
func (o *RelationModelLinksFrom) SetHref(v string) {
	o.Href = v
}
...
func (o *RelationModelLinksFrom) GetMethod() string {
...
func (o RelationModelLinksFrom) MarshalJSON() ([]byte, error) {
...
func (o RelationModelLinksFrom) ToMap() (map[string]interface{}, error) {
...
func (o *RelationModelLinksFrom) UnmarshalJSON(data []byte) (err error) {
	...
	varRelationModelLinksFrom := _RelationModelLinksFrom{}

	err = json.Unmarshal(data, &varRelationModelLinksFrom)

	if err != nil {
		return err
	}

	*o = RelationModelLinksFrom(varRelationModelLinksFrom)
...
type NullableRelationModelLinksFrom struct {
	value *RelationModelLinksFrom
	isSet bool
}

func (v NullableRelationModelLinksFrom) Get() *RelationModelLinksFrom {
	return v.value
}

func (v *NullableRelationModelLinksFrom) Set(val *RelationModelLinksFrom) {
	v.value = val
	v.isSet = true
}

func (v NullableRelationModelLinksFrom) IsSet() bool {
	return v.isSet
}

func (v *NullableRelationModelLinksFrom) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRelationModelLinksFrom(val *RelationModelLinksFrom) *NullableRelationModelLinksFrom {
	return &NullableRelationModelLinksFrom{value: val, isSet: true}
}

func (v NullableRelationModelLinksFrom) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRelationModelLinksFrom) UnmarshalJSON(src []byte) error {
	v.isSet = true
