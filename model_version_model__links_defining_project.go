...
// checks if the VersionModelLinksDefiningProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionModelLinksDefiningProject{}

// VersionModelLinksDefiningProject struct for VersionModelLinksDefiningProject
type VersionModelLinksDefiningProject struct {
...
type _VersionModelLinksDefiningProject VersionModelLinksDefiningProject
...
func NewVersionModelLinksDefiningProject(href string) *VersionModelLinksDefiningProject {
	this := VersionModelLinksDefiningProject{}
	this.Href = href
...
func (o VersionModelLinksDefiningProject) MarshalJSON() ([]byte, error) {
...
func (o VersionModelLinksDefiningProject) ToMap() (map[string]interface{}, error) {
...
func (o *VersionModelLinksDefiningProject) UnmarshalJSON(data []byte) (err error) {
	...
	varVersionModelLinksDefiningProject := _VersionModelLinksDefiningProject{}

	err = json.Unmarshal(data, &varVersionModelLinksDefiningProject)

	if err != nil {
		return err
	}

	*o = VersionModelLinksDefiningProject(varVersionModelLinksDefiningProject)
...
type NullableVersionModelLinksDefiningProject struct {
	value *VersionModelLinksDefiningProject
	isSet bool
}

func (v NullableVersionModelLinksDefiningProject) Get() *VersionModelLinksDefiningProject {
	return v.value
}

func (v *NullableVersionModelLinksDefiningProject) Set(val *VersionModelLinksDefiningProject) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionModelLinksDefiningProject) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionModelLinksDefiningProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionModelLinksDefiningProject(val *VersionModelLinksDefiningProject) *NullableVersionModelLinksDefiningProject {
	return &NullableVersionModelLinksDefiningProject{value: val, isSet: true}
}

func (v NullableVersionModelLinksDefiningProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionModelLinksDefiningProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
