...
// checks if the TimeEntryActivityModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryActivityModel{}

// TimeEntryActivityModel struct for TimeEntryActivityModel
type TimeEntryActivityModel struct {
	...
	Links TimeEntryActivityModelLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _TimeEntryActivityModel TimeEntryActivityModel
...
func (o *TimeEntryActivityModel) GetEmbedded() TimeEntryActivityModelEmbedded {
	if o == nil {
		var ret TimeEntryActivityModelEmbedded
		return ret
	}
...
func (o *TimeEntryActivityModel) GetLinks() TimeEntryActivityModelLinks {
	if o == nil {
		var ret TimeEntryActivityModelLinks
		return ret
	}
...
func (o TimeEntryActivityModel) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryActivityModel) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryActivityModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryActivityModel := _TimeEntryActivityModel{}

	err = json.Unmarshal(data, &varTimeEntryActivityModel)

	if err != nil {
		return err
	}

	*o = TimeEntryActivityModel(varTimeEntryActivityModel)
...
type NullableTimeEntryActivityModel struct {
	value *TimeEntryActivityModel
	isSet bool
}

func (v NullableTimeEntryActivityModel) Get() *TimeEntryActivityModel {
	return v.value
}

func (v *NullableTimeEntryActivityModel) Set(val *TimeEntryActivityModel) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryActivityModel) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryActivityModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryActivityModel(val *TimeEntryActivityModel) *NullableTimeEntryActivityModel {
	return &NullableTimeEntryActivityModel{value: val, isSet: true}
}

func (v NullableTimeEntryActivityModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryActivityModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
