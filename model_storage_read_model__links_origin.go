...
// checks if the StorageReadModelLinksOrigin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageReadModelLinksOrigin{}

// StorageReadModelLinksOrigin struct for StorageReadModelLinksOrigin
type StorageReadModelLinksOrigin struct {
...
type _StorageReadModelLinksOrigin StorageReadModelLinksOrigin
...
func NewStorageReadModelLinksOrigin(href string) *StorageReadModelLinksOrigin {
	this := StorageReadModelLinksOrigin{}
	this.Href = href
...
func (o StorageReadModelLinksOrigin) MarshalJSON() ([]byte, error) {
...
func (o StorageReadModelLinksOrigin) ToMap() (map[string]interface{}, error) {
...
func (o *StorageReadModelLinksOrigin) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageReadModelLinksOrigin := _StorageReadModelLinksOrigin{}

	err = json.Unmarshal(data, &varStorageReadModelLinksOrigin)

	if err != nil {
		return err
	}

	*o = StorageReadModelLinksOrigin(varStorageReadModelLinksOrigin)
...
type NullableStorageReadModelLinksOrigin struct {
	value *StorageReadModelLinksOrigin
	isSet bool
}

func (v NullableStorageReadModelLinksOrigin) Get() *StorageReadModelLinksOrigin {
	return v.value
}

func (v *NullableStorageReadModelLinksOrigin) Set(val *StorageReadModelLinksOrigin) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageReadModelLinksOrigin) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageReadModelLinksOrigin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageReadModelLinksOrigin(val *StorageReadModelLinksOrigin) *NullableStorageReadModelLinksOrigin {
	return &NullableStorageReadModelLinksOrigin{value: val, isSet: true}
}

func (v NullableStorageReadModelLinksOrigin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageReadModelLinksOrigin) UnmarshalJSON(src []byte) error {
	v.isSet = true
