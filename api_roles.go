...
func (r ApiListRolesRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *RolesAPIService) ListRolesExecute(r ApiListRolesRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r ApiViewRoleRequest) Execute() (*RoleModel, *http.Response, error) {
	return r.ApiService.ViewRoleExecute(r)
}
...
// Execute executes the request
//  @return RoleModel
func (a *RolesAPIService) ViewRoleExecute(r ApiViewRoleRequest) (*RoleModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RolesAPIService.ViewRole")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/roles/{id}"
