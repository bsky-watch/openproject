...
// checks if the RevisionModelLinksShowRevision type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevisionModelLinksShowRevision{}

// RevisionModelLinksShowRevision struct for RevisionModelLinksShowRevision
type RevisionModelLinksShowRevision struct {
...
type _RevisionModelLinksShowRevision RevisionModelLinksShowRevision
...
func NewRevisionModelLinksShowRevision(href string) *RevisionModelLinksShowRevision {
	this := RevisionModelLinksShowRevision{}
	this.Href = href
...
func (o RevisionModelLinksShowRevision) MarshalJSON() ([]byte, error) {
...
func (o RevisionModelLinksShowRevision) ToMap() (map[string]interface{}, error) {
...
func (o *RevisionModelLinksShowRevision) UnmarshalJSON(data []byte) (err error) {
	...
	varRevisionModelLinksShowRevision := _RevisionModelLinksShowRevision{}

	err = json.Unmarshal(data, &varRevisionModelLinksShowRevision)

	if err != nil {
		return err
	}

	*o = RevisionModelLinksShowRevision(varRevisionModelLinksShowRevision)
...
type NullableRevisionModelLinksShowRevision struct {
	value *RevisionModelLinksShowRevision
	isSet bool
}

func (v NullableRevisionModelLinksShowRevision) Get() *RevisionModelLinksShowRevision {
	return v.value
}

func (v *NullableRevisionModelLinksShowRevision) Set(val *RevisionModelLinksShowRevision) {
	v.value = val
	v.isSet = true
}

func (v NullableRevisionModelLinksShowRevision) IsSet() bool {
	return v.isSet
}

func (v *NullableRevisionModelLinksShowRevision) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRevisionModelLinksShowRevision(val *RevisionModelLinksShowRevision) *NullableRevisionModelLinksShowRevision {
	return &NullableRevisionModelLinksShowRevision{value: val, isSet: true}
}

func (v NullableRevisionModelLinksShowRevision) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRevisionModelLinksShowRevision) UnmarshalJSON(src []byte) error {
	v.isSet = true
