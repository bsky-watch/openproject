...
// checks if the RelationModelLinksUpdateImmediately type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelationModelLinksUpdateImmediately{}

// RelationModelLinksUpdateImmediately struct for RelationModelLinksUpdateImmediately
type RelationModelLinksUpdateImmediately struct {
...
type _RelationModelLinksUpdateImmediately RelationModelLinksUpdateImmediately
...
func NewRelationModelLinksUpdateImmediately(href string) *RelationModelLinksUpdateImmediately {
	this := RelationModelLinksUpdateImmediately{}
	this.Href = href
...
// and a boolean to check if the value has been set.
func (o *RelationModelLinksUpdateImmediately) GetIdentifierOk() (*string, bool) {
	if o == nil || IsNil(o.Identifier) {
		return nil, false
	}
...
func (o RelationModelLinksUpdateImmediately) MarshalJSON() ([]byte, error) {
...
func (o RelationModelLinksUpdateImmediately) ToMap() (map[string]interface{}, error) {
...
func (o *RelationModelLinksUpdateImmediately) UnmarshalJSON(data []byte) (err error) {
	...
	varRelationModelLinksUpdateImmediately := _RelationModelLinksUpdateImmediately{}

	err = json.Unmarshal(data, &varRelationModelLinksUpdateImmediately)

	if err != nil {
		return err
	}

	*o = RelationModelLinksUpdateImmediately(varRelationModelLinksUpdateImmediately)
...
type NullableRelationModelLinksUpdateImmediately struct {
	value *RelationModelLinksUpdateImmediately
	isSet bool
}

func (v NullableRelationModelLinksUpdateImmediately) Get() *RelationModelLinksUpdateImmediately {
	return v.value
}

func (v *NullableRelationModelLinksUpdateImmediately) Set(val *RelationModelLinksUpdateImmediately) {
	v.value = val
	v.isSet = true
}

func (v NullableRelationModelLinksUpdateImmediately) IsSet() bool {
	return v.isSet
}

func (v *NullableRelationModelLinksUpdateImmediately) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRelationModelLinksUpdateImmediately(val *RelationModelLinksUpdateImmediately) *NullableRelationModelLinksUpdateImmediately {
	return &NullableRelationModelLinksUpdateImmediately{value: val, isSet: true}
}

func (v NullableRelationModelLinksUpdateImmediately) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRelationModelLinksUpdateImmediately) UnmarshalJSON(src []byte) error {
	v.isSet = true
