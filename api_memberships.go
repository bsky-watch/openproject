...
func (r ApiCreateMembershipRequest) MembershipWriteModel(membershipWriteModel MembershipWriteModel) ApiCreateMembershipRequest {
	r.membershipWriteModel = &membershipWriteModel
	return r
}

func (r ApiCreateMembershipRequest) Execute() (*MembershipReadModel, *http.Response, error) {
	return r.ApiService.CreateMembershipExecute(r)
}

/*
CreateMembership Create a membership
...
*/
func (a *MembershipsAPIService) CreateMembership(ctx context.Context) ApiCreateMembershipRequest {
	return ApiCreateMembershipRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MembershipsAPIService) CreateMembershipExecute(r ApiCreateMembershipRequest) (*MembershipReadModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MembershipReadModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MembershipsAPIService.CreateMembership")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/memberships"
	...
	// body params
	localVarPostBody = r.membershipWriteModel
...
func (a *MembershipsAPIService) DeleteMembershipExecute(r ApiDeleteMembershipRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/memberships/{id}"
...
type ApiFormCreateMembershipRequest struct {
	ctx context.Context
	ApiService *MembershipsAPIService
	membershipWriteModel *MembershipWriteModel
}

func (r ApiFormCreateMembershipRequest) MembershipWriteModel(membershipWriteModel MembershipWriteModel) ApiFormCreateMembershipRequest {
	r.membershipWriteModel = &membershipWriteModel
	return r
}

func (r ApiFormCreateMembershipRequest) Execute() (*MembershipFormModel, *http.Response, error) {
	return r.ApiService.FormCreateMembershipExecute(r)
}

/*
FormCreateMembership Form create membership
...
endpoint itself does not create a membership.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiFormCreateMembershipRequest
*/
func (a *MembershipsAPIService) FormCreateMembership(ctx context.Context) ApiFormCreateMembershipRequest {
	return ApiFormCreateMembershipRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MembershipsAPIService) FormCreateMembershipExecute(r ApiFormCreateMembershipRequest) (*MembershipFormModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MembershipFormModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MembershipsAPIService.FormCreateMembership")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/memberships/form"
...
func (r ApiFormUpdateMembershipRequest) MembershipWriteModel(membershipWriteModel MembershipWriteModel) ApiFormUpdateMembershipRequest {
	r.membershipWriteModel = &membershipWriteModel
	return r
}

func (r ApiFormUpdateMembershipRequest) Execute() (*MembershipReadModel, *http.Response, error) {
	return r.ApiService.FormUpdateMembershipExecute(r)
}

/*
FormUpdateMembership Form update membership
...
// Execute executes the request
//  @return MembershipReadModel
func (a *MembershipsAPIService) FormUpdateMembershipExecute(r ApiFormUpdateMembershipRequest) (*MembershipReadModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MembershipsAPIService.FormUpdateMembership")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/memberships/{id}/form"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiGetMembershipRequest) Execute() (*MembershipReadModel, *http.Response, error) {
	return r.ApiService.GetMembershipExecute(r)
}

/*
GetMembership Get a membership
...
// Execute executes the request
//  @return MembershipReadModel
func (a *MembershipsAPIService) GetMembershipExecute(r ApiGetMembershipRequest) (*MembershipReadModel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MembershipsAPIService.GetMembership")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetMembershipSchemaRequest struct {
	ctx context.Context
	ApiService *MembershipsAPIService
}

func (r ApiGetMembershipSchemaRequest) Execute() (*MembershipSchemaModel, *http.Response, error) {
	return r.ApiService.GetMembershipSchemaExecute(r)
}

/*
GetMembershipSchema Schema membership

Retrieves the schema for the membership resource object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMembershipSchemaRequest
*/
func (a *MembershipsAPIService) GetMembershipSchema(ctx context.Context) ApiGetMembershipSchemaRequest {
	return ApiGetMembershipSchemaRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MembershipsAPIService) GetMembershipSchemaExecute(r ApiGetMembershipSchemaRequest) (*MembershipSchemaModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MembershipSchemaModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MembershipsAPIService.GetMembershipSchema")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/memberships/schema"
...
type ApiGetMembershipsAvailableProjectsRequest struct {
	ctx context.Context
	ApiService *MembershipsAPIService
}

func (r ApiGetMembershipsAvailableProjectsRequest) Execute() (*ProjectCollectionModel, *http.Response, error) {
	return r.ApiService.GetMembershipsAvailableProjectsExecute(r)
}

/*
GetMembershipsAvailableProjects Available projects for memberships
...
issuing the request has the manage members permissions.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMembershipsAvailableProjectsRequest
*/
func (a *MembershipsAPIService) GetMembershipsAvailableProjects(ctx context.Context) ApiGetMembershipsAvailableProjectsRequest {
	return ApiGetMembershipsAvailableProjectsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MembershipsAPIService) GetMembershipsAvailableProjectsExecute(r ApiGetMembershipsAvailableProjectsRequest) (*ProjectCollectionModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MembershipsAPIService.GetMembershipsAvailableProjects")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/memberships/available_projects"
...
func (r ApiListMembershipsRequest) Filters(filters string) ApiListMembershipsRequest {
	r.filters = &filters
	return r
}
...
func (r ApiListMembershipsRequest) SortBy(sortBy string) ApiListMembershipsRequest {
	r.sortBy = &sortBy
	return r
}

func (r ApiListMembershipsRequest) Execute() (*MembershipCollectionModel, *http.Response, error) {
...
*/
func (a *MembershipsAPIService) ListMemberships(ctx context.Context) ApiListMembershipsRequest {
	return ApiListMembershipsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MembershipsAPIService) ListMembershipsExecute(r ApiListMembershipsRequest) (*MembershipCollectionModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MembershipCollectionModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MembershipsAPIService.ListMemberships")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateMembershipRequest) MembershipWriteModel(membershipWriteModel MembershipWriteModel) ApiUpdateMembershipRequest {
	r.membershipWriteModel = &membershipWriteModel
	return r
}

func (r ApiUpdateMembershipRequest) Execute() (*MembershipReadModel, *http.Response, error) {
...
// Execute executes the request
//  @return MembershipReadModel
func (a *MembershipsAPIService) UpdateMembershipExecute(r ApiUpdateMembershipRequest) (*MembershipReadModel, *http.Response, error) {
	var (
