...
// checks if the ProjectModelLinksDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksDelete{}

// ProjectModelLinksDelete struct for ProjectModelLinksDelete
type ProjectModelLinksDelete struct {
...
type _ProjectModelLinksDelete ProjectModelLinksDelete
...
func (o *ProjectModelLinksDelete) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectModelLinksDelete) GetMethod() string {
...
func (o ProjectModelLinksDelete) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksDelete) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksDelete) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksDelete := _ProjectModelLinksDelete{}

	err = json.Unmarshal(data, &varProjectModelLinksDelete)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksDelete(varProjectModelLinksDelete)
...
type NullableProjectModelLinksDelete struct {
	value *ProjectModelLinksDelete
	isSet bool
}

func (v NullableProjectModelLinksDelete) Get() *ProjectModelLinksDelete {
	return v.value
}

func (v *NullableProjectModelLinksDelete) Set(val *ProjectModelLinksDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksDelete(val *ProjectModelLinksDelete) *NullableProjectModelLinksDelete {
	return &NullableProjectModelLinksDelete{value: val, isSet: true}
}

func (v NullableProjectModelLinksDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
