...
// checks if the WorkPackageModelLinksType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksType{}

// WorkPackageModelLinksType struct for WorkPackageModelLinksType
type WorkPackageModelLinksType struct {
...
type _WorkPackageModelLinksType WorkPackageModelLinksType
...
func NewWorkPackageModelLinksType(href string) *WorkPackageModelLinksType {
	this := WorkPackageModelLinksType{}
	this.Href = href
...
func (o WorkPackageModelLinksType) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksType) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksType) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksType := _WorkPackageModelLinksType{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksType)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksType(varWorkPackageModelLinksType)
...
type NullableWorkPackageModelLinksType struct {
	value *WorkPackageModelLinksType
	isSet bool
}

func (v NullableWorkPackageModelLinksType) Get() *WorkPackageModelLinksType {
	return v.value
}

func (v *NullableWorkPackageModelLinksType) Set(val *WorkPackageModelLinksType) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksType) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksType(val *WorkPackageModelLinksType) *NullableWorkPackageModelLinksType {
	return &NullableWorkPackageModelLinksType{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksType) UnmarshalJSON(src []byte) error {
	v.isSet = true
