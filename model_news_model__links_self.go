...
// checks if the NewsModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewsModelLinksSelf{}

// NewsModelLinksSelf struct for NewsModelLinksSelf
type NewsModelLinksSelf struct {
...
type _NewsModelLinksSelf NewsModelLinksSelf
...
func (o *NewsModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *NewsModelLinksSelf) GetMethod() string {
...
func (o NewsModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o NewsModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *NewsModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varNewsModelLinksSelf := _NewsModelLinksSelf{}

	err = json.Unmarshal(data, &varNewsModelLinksSelf)

	if err != nil {
		return err
	}

	*o = NewsModelLinksSelf(varNewsModelLinksSelf)
...
type NullableNewsModelLinksSelf struct {
	value *NewsModelLinksSelf
	isSet bool
}

func (v NullableNewsModelLinksSelf) Get() *NewsModelLinksSelf {
	return v.value
}

func (v *NullableNewsModelLinksSelf) Set(val *NewsModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableNewsModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableNewsModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewsModelLinksSelf(val *NewsModelLinksSelf) *NullableNewsModelLinksSelf {
	return &NullableNewsModelLinksSelf{value: val, isSet: true}
}

func (v NullableNewsModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewsModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
