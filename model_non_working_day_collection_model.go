...
// checks if the NonWorkingDayCollectionModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NonWorkingDayCollectionModel{}

// NonWorkingDayCollectionModel struct for NonWorkingDayCollectionModel
...
type _NonWorkingDayCollectionModel NonWorkingDayCollectionModel
...
func (o *NonWorkingDayCollectionModel) GetLinks() NonWorkingDayCollectionModelAllOfLinks {
	if o == nil {
		var ret NonWorkingDayCollectionModelAllOfLinks
		return ret
	}
...
func (o *NonWorkingDayCollectionModel) GetEmbedded() NonWorkingDayCollectionModelAllOfEmbedded {
	if o == nil {
		var ret NonWorkingDayCollectionModelAllOfEmbedded
		return ret
	}
...
func (o NonWorkingDayCollectionModel) MarshalJSON() ([]byte, error) {
...
func (o NonWorkingDayCollectionModel) ToMap() (map[string]interface{}, error) {
...
func (o *NonWorkingDayCollectionModel) UnmarshalJSON(data []byte) (err error) {
	...
	varNonWorkingDayCollectionModel := _NonWorkingDayCollectionModel{}

	err = json.Unmarshal(data, &varNonWorkingDayCollectionModel)

	if err != nil {
		return err
	}

	*o = NonWorkingDayCollectionModel(varNonWorkingDayCollectionModel)
...
type NullableNonWorkingDayCollectionModel struct {
	value *NonWorkingDayCollectionModel
	isSet bool
}

func (v NullableNonWorkingDayCollectionModel) Get() *NonWorkingDayCollectionModel {
	return v.value
}

func (v *NullableNonWorkingDayCollectionModel) Set(val *NonWorkingDayCollectionModel) {
	v.value = val
	v.isSet = true
}

func (v NullableNonWorkingDayCollectionModel) IsSet() bool {
	return v.isSet
}

func (v *NullableNonWorkingDayCollectionModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNonWorkingDayCollectionModel(val *NonWorkingDayCollectionModel) *NullableNonWorkingDayCollectionModel {
	return &NullableNonWorkingDayCollectionModel{value: val, isSet: true}
}

func (v NullableNonWorkingDayCollectionModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNonWorkingDayCollectionModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
