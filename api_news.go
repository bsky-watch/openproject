...
func (r ApiListNewsRequest) SortBy(sortBy string) ApiListNewsRequest {
	r.sortBy = &sortBy
	return r
}
...
func (r ApiListNewsRequest) Filters(filters string) ApiListNewsRequest {
	r.filters = &filters
	return r
}

func (r ApiListNewsRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *NewsAPIService) ListNewsExecute(r ApiListNewsRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v3/news"
...
func (r ApiViewNewsRequest) Execute() (*NewsModel, *http.Response, error) {
	return r.ApiService.ViewNewsExecute(r)
}
...
// Execute executes the request
//  @return NewsModel
func (a *NewsAPIService) ViewNewsExecute(r ApiViewNewsRequest) (*NewsModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NewsModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NewsAPIService.ViewNews")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/news/{id}"
