...
// checks if the CategoryModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryModelLinksProject{}

// CategoryModelLinksProject struct for CategoryModelLinksProject
type CategoryModelLinksProject struct {
...
type _CategoryModelLinksProject CategoryModelLinksProject
...
func NewCategoryModelLinksProject(href string) *CategoryModelLinksProject {
	this := CategoryModelLinksProject{}
	this.Href = href
...
func (o *CategoryModelLinksProject) SetHref(v string) {
	o.Href = v
}
...
func (o *CategoryModelLinksProject) GetMethod() string {
...
func (o CategoryModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o CategoryModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryModelLinksProject := _CategoryModelLinksProject{}

	err = json.Unmarshal(data, &varCategoryModelLinksProject)

	if err != nil {
		return err
	}

	*o = CategoryModelLinksProject(varCategoryModelLinksProject)
...
type NullableCategoryModelLinksProject struct {
	value *CategoryModelLinksProject
	isSet bool
}

func (v NullableCategoryModelLinksProject) Get() *CategoryModelLinksProject {
	return v.value
}

func (v *NullableCategoryModelLinksProject) Set(val *CategoryModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryModelLinksProject(val *CategoryModelLinksProject) *NullableCategoryModelLinksProject {
	return &NullableCategoryModelLinksProject{value: val, isSet: true}
}

func (v NullableCategoryModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
