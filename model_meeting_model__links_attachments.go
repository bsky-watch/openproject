...
// checks if the MeetingModelLinksAttachments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeetingModelLinksAttachments{}

// MeetingModelLinksAttachments struct for MeetingModelLinksAttachments
type MeetingModelLinksAttachments struct {
...
type _MeetingModelLinksAttachments MeetingModelLinksAttachments
...
func NewMeetingModelLinksAttachments(href string) *MeetingModelLinksAttachments {
	this := MeetingModelLinksAttachments{}
	this.Href = href
...
func (o *MeetingModelLinksAttachments) SetHref(v string) {
	o.Href = v
}
...
func (o *MeetingModelLinksAttachments) GetMethod() string {
...
func (o MeetingModelLinksAttachments) MarshalJSON() ([]byte, error) {
...
func (o MeetingModelLinksAttachments) ToMap() (map[string]interface{}, error) {
...
func (o *MeetingModelLinksAttachments) UnmarshalJSON(data []byte) (err error) {
	...
	varMeetingModelLinksAttachments := _MeetingModelLinksAttachments{}

	err = json.Unmarshal(data, &varMeetingModelLinksAttachments)

	if err != nil {
		return err
	}

	*o = MeetingModelLinksAttachments(varMeetingModelLinksAttachments)
...
type NullableMeetingModelLinksAttachments struct {
	value *MeetingModelLinksAttachments
	isSet bool
}

func (v NullableMeetingModelLinksAttachments) Get() *MeetingModelLinksAttachments {
	return v.value
}

func (v *NullableMeetingModelLinksAttachments) Set(val *MeetingModelLinksAttachments) {
	v.value = val
	v.isSet = true
}

func (v NullableMeetingModelLinksAttachments) IsSet() bool {
	return v.isSet
}

func (v *NullableMeetingModelLinksAttachments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeetingModelLinksAttachments(val *MeetingModelLinksAttachments) *NullableMeetingModelLinksAttachments {
	return &NullableMeetingModelLinksAttachments{value: val, isSet: true}
}

func (v NullableMeetingModelLinksAttachments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeetingModelLinksAttachments) UnmarshalJSON(src []byte) error {
	v.isSet = true
