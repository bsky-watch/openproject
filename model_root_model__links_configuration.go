...
// checks if the RootModelLinksConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksConfiguration{}

// RootModelLinksConfiguration struct for RootModelLinksConfiguration
type RootModelLinksConfiguration struct {
...
type _RootModelLinksConfiguration RootModelLinksConfiguration
...
func NewRootModelLinksConfiguration(href string) *RootModelLinksConfiguration {
	this := RootModelLinksConfiguration{}
	this.Href = href
...
func (o *RootModelLinksConfiguration) SetHref(v string) {
	o.Href = v
}
...
func (o *RootModelLinksConfiguration) GetMethod() string {
...
func (o RootModelLinksConfiguration) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksConfiguration := _RootModelLinksConfiguration{}

	err = json.Unmarshal(data, &varRootModelLinksConfiguration)

	if err != nil {
		return err
	}

	*o = RootModelLinksConfiguration(varRootModelLinksConfiguration)
...
type NullableRootModelLinksConfiguration struct {
	value *RootModelLinksConfiguration
	isSet bool
}

func (v NullableRootModelLinksConfiguration) Get() *RootModelLinksConfiguration {
	return v.value
}

func (v *NullableRootModelLinksConfiguration) Set(val *RootModelLinksConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksConfiguration(val *RootModelLinksConfiguration) *NullableRootModelLinksConfiguration {
	return &NullableRootModelLinksConfiguration{value: val, isSet: true}
}

func (v NullableRootModelLinksConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
