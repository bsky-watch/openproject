...
// checks if the WorkPackageModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksProject{}

// WorkPackageModelLinksProject struct for WorkPackageModelLinksProject
type WorkPackageModelLinksProject struct {
...
type _WorkPackageModelLinksProject WorkPackageModelLinksProject
...
func NewWorkPackageModelLinksProject(href string) *WorkPackageModelLinksProject {
	this := WorkPackageModelLinksProject{}
	this.Href = href
...
func (o WorkPackageModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksProject := _WorkPackageModelLinksProject{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksProject)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksProject(varWorkPackageModelLinksProject)
...
type NullableWorkPackageModelLinksProject struct {
	value *WorkPackageModelLinksProject
	isSet bool
}

func (v NullableWorkPackageModelLinksProject) Get() *WorkPackageModelLinksProject {
	return v.value
}

func (v *NullableWorkPackageModelLinksProject) Set(val *WorkPackageModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksProject(val *WorkPackageModelLinksProject) *NullableWorkPackageModelLinksProject {
	return &NullableWorkPackageModelLinksProject{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
