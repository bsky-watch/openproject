...
// checks if the WorkPackageModelLinksUnwatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksUnwatch{}

// WorkPackageModelLinksUnwatch struct for WorkPackageModelLinksUnwatch
type WorkPackageModelLinksUnwatch struct {
...
type _WorkPackageModelLinksUnwatch WorkPackageModelLinksUnwatch
...
func NewWorkPackageModelLinksUnwatch(href string) *WorkPackageModelLinksUnwatch {
	this := WorkPackageModelLinksUnwatch{}
	this.Href = href
...
func (o *WorkPackageModelLinksUnwatch) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksUnwatch) GetMethod() string {
...
func (o WorkPackageModelLinksUnwatch) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksUnwatch) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksUnwatch) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksUnwatch := _WorkPackageModelLinksUnwatch{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksUnwatch)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksUnwatch(varWorkPackageModelLinksUnwatch)
...
type NullableWorkPackageModelLinksUnwatch struct {
	value *WorkPackageModelLinksUnwatch
	isSet bool
}

func (v NullableWorkPackageModelLinksUnwatch) Get() *WorkPackageModelLinksUnwatch {
	return v.value
}

func (v *NullableWorkPackageModelLinksUnwatch) Set(val *WorkPackageModelLinksUnwatch) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksUnwatch) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksUnwatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksUnwatch(val *WorkPackageModelLinksUnwatch) *NullableWorkPackageModelLinksUnwatch {
	return &NullableWorkPackageModelLinksUnwatch{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksUnwatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksUnwatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
