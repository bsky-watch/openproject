...
func (o *ConfigurationModel) GetMaximumAttachmentFileSizeOk() (*int64, bool) {
	...
	return o.MaximumAttachmentFileSize, true
}
...
// GetActiveFeatureFlags returns the ActiveFeatureFlags field value if set, zero value otherwise.
func (o *ConfigurationModel) GetActiveFeatureFlags() []string {
	if o == nil || IsNil(o.ActiveFeatureFlags) {
		var ret []string
		return ret
	}
	return o.ActiveFeatureFlags
}

// GetActiveFeatureFlagsOk returns a tuple with the ActiveFeatureFlags field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigurationModel) GetActiveFeatureFlagsOk() ([]string, bool) {
	if o == nil || IsNil(o.ActiveFeatureFlags) {
		return nil, false
	}
	return o.ActiveFeatureFlags, true
}
...
// SetActiveFeatureFlags gets a reference to the given []string and assigns it to the ActiveFeatureFlags field.
func (o *ConfigurationModel) SetActiveFeatureFlags(v []string) {
	o.ActiveFeatureFlags = v
}
...
func (o ConfigurationModel) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaximumAttachmentFileSize) {
		toSerialize["maximumAttachmentFileSize"] = o.MaximumAttachmentFileSize
	}
	if !IsNil(o.HostName) {
		toSerialize["hostName"] = o.HostName
	}
	if !IsNil(o.PerPageOptions) {
		toSerialize["perPageOptions"] = o.PerPageOptions
	}
	if !IsNil(o.ActiveFeatureFlags) {
		toSerialize["activeFeatureFlags"] = o.ActiveFeatureFlags
	}
...
func (o *ConfigurationModel) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConfigurationModel)
	...
	*o = ConfigurationModel(varConfigurationModel)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "maximumAttachmentFileSize")
		delete(additionalProperties, "hostName")
		delete(additionalProperties, "perPageOptions")
		delete(additionalProperties, "activeFeatureFlags")
