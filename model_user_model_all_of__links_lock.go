...
// checks if the UserModelAllOfLinksLock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserModelAllOfLinksLock{}

// UserModelAllOfLinksLock struct for UserModelAllOfLinksLock
type UserModelAllOfLinksLock struct {
...
type _UserModelAllOfLinksLock UserModelAllOfLinksLock
...
func (o UserModelAllOfLinksLock) MarshalJSON() ([]byte, error) {
...
func (o UserModelAllOfLinksLock) ToMap() (map[string]interface{}, error) {
...
func (o *UserModelAllOfLinksLock) UnmarshalJSON(data []byte) (err error) {
	...
	varUserModelAllOfLinksLock := _UserModelAllOfLinksLock{}

	err = json.Unmarshal(data, &varUserModelAllOfLinksLock)

	if err != nil {
		return err
	}

	*o = UserModelAllOfLinksLock(varUserModelAllOfLinksLock)
...
type NullableUserModelAllOfLinksLock struct {
	value *UserModelAllOfLinksLock
	isSet bool
}

func (v NullableUserModelAllOfLinksLock) Get() *UserModelAllOfLinksLock {
	return v.value
}

func (v *NullableUserModelAllOfLinksLock) Set(val *UserModelAllOfLinksLock) {
	v.value = val
	v.isSet = true
}

func (v NullableUserModelAllOfLinksLock) IsSet() bool {
	return v.isSet
}

func (v *NullableUserModelAllOfLinksLock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserModelAllOfLinksLock(val *UserModelAllOfLinksLock) *NullableUserModelAllOfLinksLock {
	return &NullableUserModelAllOfLinksLock{value: val, isSet: true}
}

func (v NullableUserModelAllOfLinksLock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserModelAllOfLinksLock) UnmarshalJSON(src []byte) error {
	v.isSet = true
