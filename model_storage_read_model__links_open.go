...
// checks if the StorageReadModelLinksOpen type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageReadModelLinksOpen{}

// StorageReadModelLinksOpen struct for StorageReadModelLinksOpen
type StorageReadModelLinksOpen struct {
...
type _StorageReadModelLinksOpen StorageReadModelLinksOpen
...
func NewStorageReadModelLinksOpen(href string) *StorageReadModelLinksOpen {
	this := StorageReadModelLinksOpen{}
	this.Href = href
...
func (o *StorageReadModelLinksOpen) SetHref(v string) {
	o.Href = v
}
...
func (o *StorageReadModelLinksOpen) GetMethod() string {
...
func (o StorageReadModelLinksOpen) MarshalJSON() ([]byte, error) {
...
func (o StorageReadModelLinksOpen) ToMap() (map[string]interface{}, error) {
...
func (o *StorageReadModelLinksOpen) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageReadModelLinksOpen := _StorageReadModelLinksOpen{}

	err = json.Unmarshal(data, &varStorageReadModelLinksOpen)

	if err != nil {
		return err
	}

	*o = StorageReadModelLinksOpen(varStorageReadModelLinksOpen)
...
type NullableStorageReadModelLinksOpen struct {
	value *StorageReadModelLinksOpen
	isSet bool
}

func (v NullableStorageReadModelLinksOpen) Get() *StorageReadModelLinksOpen {
	return v.value
}

func (v *NullableStorageReadModelLinksOpen) Set(val *StorageReadModelLinksOpen) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageReadModelLinksOpen) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageReadModelLinksOpen) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageReadModelLinksOpen(val *StorageReadModelLinksOpen) *NullableStorageReadModelLinksOpen {
	return &NullableStorageReadModelLinksOpen{value: val, isSet: true}
}

func (v NullableStorageReadModelLinksOpen) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageReadModelLinksOpen) UnmarshalJSON(src []byte) error {
	v.isSet = true
