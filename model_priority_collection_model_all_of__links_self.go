...
// checks if the PriorityCollectionModelAllOfLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriorityCollectionModelAllOfLinksSelf{}

// PriorityCollectionModelAllOfLinksSelf struct for PriorityCollectionModelAllOfLinksSelf
type PriorityCollectionModelAllOfLinksSelf struct {
	...
	Self *PriorityCollectionModelAllOfLinksSelfAllOfSelf `json:"self,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PriorityCollectionModelAllOfLinksSelf PriorityCollectionModelAllOfLinksSelf
...
func NewPriorityCollectionModelAllOfLinksSelf(href string) *PriorityCollectionModelAllOfLinksSelf {
	this := PriorityCollectionModelAllOfLinksSelf{}
	this.Href = href
...
func (o *PriorityCollectionModelAllOfLinksSelf) GetSelf() PriorityCollectionModelAllOfLinksSelfAllOfSelf {
	if o == nil || IsNil(o.Self) {
		var ret PriorityCollectionModelAllOfLinksSelfAllOfSelf
		return ret
	}
	return *o.Self
}
...
// SetSelf gets a reference to the given PriorityCollectionModelAllOfLinksSelfAllOfSelf and assigns it to the Self field.
func (o *PriorityCollectionModelAllOfLinksSelf) SetSelf(v PriorityCollectionModelAllOfLinksSelfAllOfSelf) {
	o.Self = &v
}

func (o PriorityCollectionModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o PriorityCollectionModelAllOfLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *PriorityCollectionModelAllOfLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varPriorityCollectionModelAllOfLinksSelf := _PriorityCollectionModelAllOfLinksSelf{}

	err = json.Unmarshal(data, &varPriorityCollectionModelAllOfLinksSelf)

	if err != nil {
		return err
	}

	*o = PriorityCollectionModelAllOfLinksSelf(varPriorityCollectionModelAllOfLinksSelf)
...
type NullablePriorityCollectionModelAllOfLinksSelf struct {
	value *PriorityCollectionModelAllOfLinksSelf
	isSet bool
}

func (v NullablePriorityCollectionModelAllOfLinksSelf) Get() *PriorityCollectionModelAllOfLinksSelf {
	return v.value
}

func (v *NullablePriorityCollectionModelAllOfLinksSelf) Set(val *PriorityCollectionModelAllOfLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullablePriorityCollectionModelAllOfLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullablePriorityCollectionModelAllOfLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriorityCollectionModelAllOfLinksSelf(val *PriorityCollectionModelAllOfLinksSelf) *NullablePriorityCollectionModelAllOfLinksSelf {
	return &NullablePriorityCollectionModelAllOfLinksSelf{value: val, isSet: true}
}

func (v NullablePriorityCollectionModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriorityCollectionModelAllOfLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
