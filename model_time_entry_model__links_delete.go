...
// checks if the TimeEntryModelLinksDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryModelLinksDelete{}

// TimeEntryModelLinksDelete struct for TimeEntryModelLinksDelete
type TimeEntryModelLinksDelete struct {
...
type _TimeEntryModelLinksDelete TimeEntryModelLinksDelete
...
func NewTimeEntryModelLinksDelete(href string) *TimeEntryModelLinksDelete {
	this := TimeEntryModelLinksDelete{}
	this.Href = href
...
func (o *TimeEntryModelLinksDelete) SetHref(v string) {
	o.Href = v
}
...
func (o *TimeEntryModelLinksDelete) GetMethod() string {
...
func (o TimeEntryModelLinksDelete) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryModelLinksDelete) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryModelLinksDelete) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryModelLinksDelete := _TimeEntryModelLinksDelete{}

	err = json.Unmarshal(data, &varTimeEntryModelLinksDelete)

	if err != nil {
		return err
	}

	*o = TimeEntryModelLinksDelete(varTimeEntryModelLinksDelete)
...
type NullableTimeEntryModelLinksDelete struct {
	value *TimeEntryModelLinksDelete
	isSet bool
}

func (v NullableTimeEntryModelLinksDelete) Get() *TimeEntryModelLinksDelete {
	return v.value
}

func (v *NullableTimeEntryModelLinksDelete) Set(val *TimeEntryModelLinksDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryModelLinksDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryModelLinksDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryModelLinksDelete(val *TimeEntryModelLinksDelete) *NullableTimeEntryModelLinksDelete {
	return &NullableTimeEntryModelLinksDelete{value: val, isSet: true}
}

func (v NullableTimeEntryModelLinksDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryModelLinksDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
