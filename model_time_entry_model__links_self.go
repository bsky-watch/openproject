...
// checks if the TimeEntryModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryModelLinksSelf{}

// TimeEntryModelLinksSelf struct for TimeEntryModelLinksSelf
type TimeEntryModelLinksSelf struct {
...
type _TimeEntryModelLinksSelf TimeEntryModelLinksSelf
...
func (o *TimeEntryModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *TimeEntryModelLinksSelf) GetMethod() string {
...
func (o TimeEntryModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryModelLinksSelf := _TimeEntryModelLinksSelf{}

	err = json.Unmarshal(data, &varTimeEntryModelLinksSelf)

	if err != nil {
		return err
	}

	*o = TimeEntryModelLinksSelf(varTimeEntryModelLinksSelf)
...
type NullableTimeEntryModelLinksSelf struct {
	value *TimeEntryModelLinksSelf
	isSet bool
}

func (v NullableTimeEntryModelLinksSelf) Get() *TimeEntryModelLinksSelf {
	return v.value
}

func (v *NullableTimeEntryModelLinksSelf) Set(val *TimeEntryModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryModelLinksSelf(val *TimeEntryModelLinksSelf) *NullableTimeEntryModelLinksSelf {
	return &NullableTimeEntryModelLinksSelf{value: val, isSet: true}
}

func (v NullableTimeEntryModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
