...
// checks if the NotificationModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationModelLinksProject{}

// NotificationModelLinksProject struct for NotificationModelLinksProject
type NotificationModelLinksProject struct {
...
type _NotificationModelLinksProject NotificationModelLinksProject
...
func NewNotificationModelLinksProject(href string) *NotificationModelLinksProject {
	this := NotificationModelLinksProject{}
	this.Href = href
...
func (o NotificationModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o NotificationModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationModelLinksProject := _NotificationModelLinksProject{}

	err = json.Unmarshal(data, &varNotificationModelLinksProject)

	if err != nil {
		return err
	}

	*o = NotificationModelLinksProject(varNotificationModelLinksProject)
...
type NullableNotificationModelLinksProject struct {
	value *NotificationModelLinksProject
	isSet bool
}

func (v NullableNotificationModelLinksProject) Get() *NotificationModelLinksProject {
	return v.value
}

func (v *NullableNotificationModelLinksProject) Set(val *NotificationModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationModelLinksProject(val *NotificationModelLinksProject) *NullableNotificationModelLinksProject {
	return &NullableNotificationModelLinksProject{value: val, isSet: true}
}

func (v NullableNotificationModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
