...
// checks if the GroupModelAllOfLinksMembers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupModelAllOfLinksMembers{}

// GroupModelAllOfLinksMembers struct for GroupModelAllOfLinksMembers
type GroupModelAllOfLinksMembers struct {
...
type _GroupModelAllOfLinksMembers GroupModelAllOfLinksMembers
...
func NewGroupModelAllOfLinksMembers(href string) *GroupModelAllOfLinksMembers {
	this := GroupModelAllOfLinksMembers{}
	this.Href = href
...
func (o GroupModelAllOfLinksMembers) MarshalJSON() ([]byte, error) {
...
func (o GroupModelAllOfLinksMembers) ToMap() (map[string]interface{}, error) {
...
func (o *GroupModelAllOfLinksMembers) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupModelAllOfLinksMembers := _GroupModelAllOfLinksMembers{}

	err = json.Unmarshal(data, &varGroupModelAllOfLinksMembers)

	if err != nil {
		return err
	}

	*o = GroupModelAllOfLinksMembers(varGroupModelAllOfLinksMembers)
...
type NullableGroupModelAllOfLinksMembers struct {
	value *GroupModelAllOfLinksMembers
	isSet bool
}

func (v NullableGroupModelAllOfLinksMembers) Get() *GroupModelAllOfLinksMembers {
	return v.value
}

func (v *NullableGroupModelAllOfLinksMembers) Set(val *GroupModelAllOfLinksMembers) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupModelAllOfLinksMembers) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupModelAllOfLinksMembers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupModelAllOfLinksMembers(val *GroupModelAllOfLinksMembers) *NullableGroupModelAllOfLinksMembers {
	return &NullableGroupModelAllOfLinksMembers{value: val, isSet: true}
}

func (v NullableGroupModelAllOfLinksMembers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupModelAllOfLinksMembers) UnmarshalJSON(src []byte) error {
	v.isSet = true
