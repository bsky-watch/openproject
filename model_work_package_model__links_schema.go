...
// checks if the WorkPackageModelLinksSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksSchema{}

// WorkPackageModelLinksSchema struct for WorkPackageModelLinksSchema
type WorkPackageModelLinksSchema struct {
...
type _WorkPackageModelLinksSchema WorkPackageModelLinksSchema
...
func NewWorkPackageModelLinksSchema(href string) *WorkPackageModelLinksSchema {
	this := WorkPackageModelLinksSchema{}
	this.Href = href
...
func (o WorkPackageModelLinksSchema) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksSchema) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksSchema := _WorkPackageModelLinksSchema{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksSchema)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksSchema(varWorkPackageModelLinksSchema)
...
type NullableWorkPackageModelLinksSchema struct {
	value *WorkPackageModelLinksSchema
	isSet bool
}

func (v NullableWorkPackageModelLinksSchema) Get() *WorkPackageModelLinksSchema {
	return v.value
}

func (v *NullableWorkPackageModelLinksSchema) Set(val *WorkPackageModelLinksSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksSchema(val *WorkPackageModelLinksSchema) *NullableWorkPackageModelLinksSchema {
	return &NullableWorkPackageModelLinksSchema{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
