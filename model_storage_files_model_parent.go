...
// checks if the StorageFilesModelParent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageFilesModelParent{}

// StorageFilesModelParent struct for StorageFilesModelParent
type StorageFilesModelParent struct {
...
type _StorageFilesModelParent StorageFilesModelParent
...
func (o StorageFilesModelParent) MarshalJSON() ([]byte, error) {
...
func (o StorageFilesModelParent) ToMap() (map[string]interface{}, error) {
...
func (o *StorageFilesModelParent) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageFilesModelParent := _StorageFilesModelParent{}

	err = json.Unmarshal(data, &varStorageFilesModelParent)

	if err != nil {
		return err
	}

	*o = StorageFilesModelParent(varStorageFilesModelParent)
...
type NullableStorageFilesModelParent struct {
	value *StorageFilesModelParent
	isSet bool
}

func (v NullableStorageFilesModelParent) Get() *StorageFilesModelParent {
	return v.value
}

func (v *NullableStorageFilesModelParent) Set(val *StorageFilesModelParent) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageFilesModelParent) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageFilesModelParent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageFilesModelParent(val *StorageFilesModelParent) *NullableStorageFilesModelParent {
	return &NullableStorageFilesModelParent{value: val, isSet: true}
}

func (v NullableStorageFilesModelParent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageFilesModelParent) UnmarshalJSON(src []byte) error {
	v.isSet = true
