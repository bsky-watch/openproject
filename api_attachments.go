...
func (r ApiAddAttachmentToMeetingRequest) Execute() (*http.Response, error) {
	return r.ApiService.AddAttachmentToMeetingExecute(r)
}
...
func (a *AttachmentsAPIService) AddAttachmentToMeetingExecute(r ApiAddAttachmentToMeetingRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.AddAttachmentToMeeting")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/meetings/{id}/attachments"
...
func (r ApiAddAttachmentToPostRequest) Execute() (*http.Response, error) {
	return r.ApiService.AddAttachmentToPostExecute(r)
}
...
// Execute executes the request
func (a *AttachmentsAPIService) AddAttachmentToPostExecute(r ApiAddAttachmentToPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.AddAttachmentToPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/posts/{id}/attachments"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiAddAttachmentToWikiPageRequest) Execute() (*http.Response, error) {
	return r.ApiService.AddAttachmentToWikiPageExecute(r)
}
...
// Execute executes the request
func (a *AttachmentsAPIService) AddAttachmentToWikiPageExecute(r ApiAddAttachmentToWikiPageRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.AddAttachmentToWikiPage")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/wiki_pages/{id}/attachments"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiCreateAttachmentRequest) Metadata(metadata CreateAttachmentRequestMetadata) ApiCreateAttachmentRequest {
	r.metadata = &metadata
	return r
}
...
func (r ApiCreateAttachmentRequest) Execute() (*AttachmentModel, *http.Response, error) {
...
*/
func (a *AttachmentsAPIService) CreateAttachment(ctx context.Context) ApiCreateAttachmentRequest {
	return ApiCreateAttachmentRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AttachmentsAPIService) CreateAttachmentExecute(r ApiCreateAttachmentRequest) (*AttachmentModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.CreateAttachment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/attachments"
...
func (r ApiCreateWorkPackageAttachmentRequest) Metadata(metadata CreateAttachmentRequestMetadata) ApiCreateWorkPackageAttachmentRequest {
	r.metadata = &metadata
	return r
}

func (r ApiCreateWorkPackageAttachmentRequest) File(file *os.File) ApiCreateWorkPackageAttachmentRequest {
	r.file = file
	return r
}

func (r ApiCreateWorkPackageAttachmentRequest) Execute() (*AttachmentModel, *http.Response, error) {
	return r.ApiService.CreateWorkPackageAttachmentExecute(r)
}
...
// Execute executes the request
//  @return AttachmentModel
func (a *AttachmentsAPIService) CreateWorkPackageAttachmentExecute(r ApiCreateWorkPackageAttachmentRequest) (*AttachmentModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.CreateWorkPackageAttachment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/work_packages/{id}/attachments"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (a *AttachmentsAPIService) DeleteAttachmentExecute(r ApiDeleteAttachmentRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/attachments/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiListAttachmentsByMeetingRequest) Execute() (*AttachmentsModel, *http.Response, error) {
	return r.ApiService.ListAttachmentsByMeetingExecute(r)
}
...
func (a *AttachmentsAPIService) ListAttachmentsByMeetingExecute(r ApiListAttachmentsByMeetingRequest) (*AttachmentsModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AttachmentsModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.ListAttachmentsByMeeting")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListAttachmentsByPostRequest) Execute() (*AttachmentsModel, *http.Response, error) {
	return r.ApiService.ListAttachmentsByPostExecute(r)
}
...
// Execute executes the request
//  @return AttachmentsModel
func (a *AttachmentsAPIService) ListAttachmentsByPostExecute(r ApiListAttachmentsByPostRequest) (*AttachmentsModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.ListAttachmentsByPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListAttachmentsByWikiPageRequest) Execute() (*AttachmentsModel, *http.Response, error) {
	return r.ApiService.ListAttachmentsByWikiPageExecute(r)
}
...
// Execute executes the request
//  @return AttachmentsModel
func (a *AttachmentsAPIService) ListAttachmentsByWikiPageExecute(r ApiListAttachmentsByWikiPageRequest) (*AttachmentsModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.ListAttachmentsByWikiPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListWorkPackageAttachmentsRequest) Execute() (*AttachmentsModel, *http.Response, error) {
	return r.ApiService.ListWorkPackageAttachmentsExecute(r)
}
...
// Execute executes the request
//  @return AttachmentsModel
func (a *AttachmentsAPIService) ListWorkPackageAttachmentsExecute(r ApiListWorkPackageAttachmentsRequest) (*AttachmentsModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.ListWorkPackageAttachments")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiViewAttachmentRequest) Execute() (*AttachmentModel, *http.Response, error) {
	return r.ApiService.ViewAttachmentExecute(r)
}
...
// Execute executes the request
//  @return AttachmentModel
func (a *AttachmentsAPIService) ViewAttachmentExecute(r ApiViewAttachmentRequest) (*AttachmentModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.ViewAttachment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
