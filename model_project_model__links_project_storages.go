...
// checks if the ProjectModelLinksProjectStorages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksProjectStorages{}

// ProjectModelLinksProjectStorages struct for ProjectModelLinksProjectStorages
type ProjectModelLinksProjectStorages struct {
...
type _ProjectModelLinksProjectStorages ProjectModelLinksProjectStorages
...
func NewProjectModelLinksProjectStorages(href string) *ProjectModelLinksProjectStorages {
	this := ProjectModelLinksProjectStorages{}
	this.Href = href
...
func (o ProjectModelLinksProjectStorages) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksProjectStorages) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksProjectStorages) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksProjectStorages := _ProjectModelLinksProjectStorages{}

	err = json.Unmarshal(data, &varProjectModelLinksProjectStorages)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksProjectStorages(varProjectModelLinksProjectStorages)
...
type NullableProjectModelLinksProjectStorages struct {
	value *ProjectModelLinksProjectStorages
	isSet bool
}

func (v NullableProjectModelLinksProjectStorages) Get() *ProjectModelLinksProjectStorages {
	return v.value
}

func (v *NullableProjectModelLinksProjectStorages) Set(val *ProjectModelLinksProjectStorages) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksProjectStorages) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksProjectStorages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksProjectStorages(val *ProjectModelLinksProjectStorages) *NullableProjectModelLinksProjectStorages {
	return &NullableProjectModelLinksProjectStorages{value: val, isSet: true}
}

func (v NullableProjectModelLinksProjectStorages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksProjectStorages) UnmarshalJSON(src []byte) error {
	v.isSet = true
