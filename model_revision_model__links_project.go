...
// checks if the RevisionModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevisionModelLinksProject{}

// RevisionModelLinksProject struct for RevisionModelLinksProject
type RevisionModelLinksProject struct {
...
type _RevisionModelLinksProject RevisionModelLinksProject
...
func NewRevisionModelLinksProject(href string) *RevisionModelLinksProject {
	this := RevisionModelLinksProject{}
	this.Href = href
...
func (o *RevisionModelLinksProject) SetHref(v string) {
	o.Href = v
}
...
func (o *RevisionModelLinksProject) GetMethod() string {
...
func (o RevisionModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o RevisionModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *RevisionModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varRevisionModelLinksProject := _RevisionModelLinksProject{}

	err = json.Unmarshal(data, &varRevisionModelLinksProject)

	if err != nil {
		return err
	}

	*o = RevisionModelLinksProject(varRevisionModelLinksProject)
...
type NullableRevisionModelLinksProject struct {
	value *RevisionModelLinksProject
	isSet bool
}

func (v NullableRevisionModelLinksProject) Get() *RevisionModelLinksProject {
	return v.value
}

func (v *NullableRevisionModelLinksProject) Set(val *RevisionModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableRevisionModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableRevisionModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRevisionModelLinksProject(val *RevisionModelLinksProject) *NullableRevisionModelLinksProject {
	return &NullableRevisionModelLinksProject{value: val, isSet: true}
}

func (v NullableRevisionModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRevisionModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
