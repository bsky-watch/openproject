...
// checks if the StorageWriteModelLinksOrigin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageWriteModelLinksOrigin{}

// StorageWriteModelLinksOrigin struct for StorageWriteModelLinksOrigin
type StorageWriteModelLinksOrigin struct {
...
type _StorageWriteModelLinksOrigin StorageWriteModelLinksOrigin
...
func NewStorageWriteModelLinksOrigin(href string) *StorageWriteModelLinksOrigin {
	this := StorageWriteModelLinksOrigin{}
	this.Href = href
...
func (o StorageWriteModelLinksOrigin) MarshalJSON() ([]byte, error) {
...
func (o StorageWriteModelLinksOrigin) ToMap() (map[string]interface{}, error) {
...
func (o *StorageWriteModelLinksOrigin) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageWriteModelLinksOrigin := _StorageWriteModelLinksOrigin{}

	err = json.Unmarshal(data, &varStorageWriteModelLinksOrigin)

	if err != nil {
		return err
	}

	*o = StorageWriteModelLinksOrigin(varStorageWriteModelLinksOrigin)
...
type NullableStorageWriteModelLinksOrigin struct {
	value *StorageWriteModelLinksOrigin
	isSet bool
}

func (v NullableStorageWriteModelLinksOrigin) Get() *StorageWriteModelLinksOrigin {
	return v.value
}

func (v *NullableStorageWriteModelLinksOrigin) Set(val *StorageWriteModelLinksOrigin) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageWriteModelLinksOrigin) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageWriteModelLinksOrigin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageWriteModelLinksOrigin(val *StorageWriteModelLinksOrigin) *NullableStorageWriteModelLinksOrigin {
	return &NullableStorageWriteModelLinksOrigin{value: val, isSet: true}
}

func (v NullableStorageWriteModelLinksOrigin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageWriteModelLinksOrigin) UnmarshalJSON(src []byte) error {
	v.isSet = true
