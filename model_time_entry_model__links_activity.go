...
// checks if the TimeEntryModelLinksActivity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryModelLinksActivity{}

// TimeEntryModelLinksActivity struct for TimeEntryModelLinksActivity
type TimeEntryModelLinksActivity struct {
...
type _TimeEntryModelLinksActivity TimeEntryModelLinksActivity
...
func NewTimeEntryModelLinksActivity(href string) *TimeEntryModelLinksActivity {
	this := TimeEntryModelLinksActivity{}
	this.Href = href
...
func (o TimeEntryModelLinksActivity) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryModelLinksActivity) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryModelLinksActivity) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryModelLinksActivity := _TimeEntryModelLinksActivity{}

	err = json.Unmarshal(data, &varTimeEntryModelLinksActivity)

	if err != nil {
		return err
	}

	*o = TimeEntryModelLinksActivity(varTimeEntryModelLinksActivity)
...
type NullableTimeEntryModelLinksActivity struct {
	value *TimeEntryModelLinksActivity
	isSet bool
}

func (v NullableTimeEntryModelLinksActivity) Get() *TimeEntryModelLinksActivity {
	return v.value
}

func (v *NullableTimeEntryModelLinksActivity) Set(val *TimeEntryModelLinksActivity) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryModelLinksActivity) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryModelLinksActivity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryModelLinksActivity(val *TimeEntryModelLinksActivity) *NullableTimeEntryModelLinksActivity {
	return &NullableTimeEntryModelLinksActivity{value: val, isSet: true}
}

func (v NullableTimeEntryModelLinksActivity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryModelLinksActivity) UnmarshalJSON(src []byte) error {
	v.isSet = true
