...
// checks if the RelationModelLinksDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelationModelLinksDelete{}

// RelationModelLinksDelete struct for RelationModelLinksDelete
type RelationModelLinksDelete struct {
...
type _RelationModelLinksDelete RelationModelLinksDelete
...
func (o RelationModelLinksDelete) MarshalJSON() ([]byte, error) {
...
func (o RelationModelLinksDelete) ToMap() (map[string]interface{}, error) {
...
func (o *RelationModelLinksDelete) UnmarshalJSON(data []byte) (err error) {
	...
	varRelationModelLinksDelete := _RelationModelLinksDelete{}

	err = json.Unmarshal(data, &varRelationModelLinksDelete)

	if err != nil {
		return err
	}

	*o = RelationModelLinksDelete(varRelationModelLinksDelete)
...
type NullableRelationModelLinksDelete struct {
	value *RelationModelLinksDelete
	isSet bool
}

func (v NullableRelationModelLinksDelete) Get() *RelationModelLinksDelete {
	return v.value
}

func (v *NullableRelationModelLinksDelete) Set(val *RelationModelLinksDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableRelationModelLinksDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableRelationModelLinksDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRelationModelLinksDelete(val *RelationModelLinksDelete) *NullableRelationModelLinksDelete {
	return &NullableRelationModelLinksDelete{value: val, isSet: true}
}

func (v NullableRelationModelLinksDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRelationModelLinksDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
