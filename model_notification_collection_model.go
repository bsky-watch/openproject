...
// checks if the NotificationCollectionModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationCollectionModel{}

// NotificationCollectionModel struct for NotificationCollectionModel
...
type _NotificationCollectionModel NotificationCollectionModel
...
func (o *NotificationCollectionModel) GetLinks() NotificationCollectionModelAllOfLinks {
	if o == nil {
		var ret NotificationCollectionModelAllOfLinks
		return ret
	}
...
func (o *NotificationCollectionModel) GetEmbedded() NotificationCollectionModelAllOfEmbedded {
	if o == nil {
		var ret NotificationCollectionModelAllOfEmbedded
		return ret
	}
...
func (o NotificationCollectionModel) MarshalJSON() ([]byte, error) {
...
func (o NotificationCollectionModel) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationCollectionModel) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationCollectionModel := _NotificationCollectionModel{}

	err = json.Unmarshal(data, &varNotificationCollectionModel)

	if err != nil {
		return err
	}

	*o = NotificationCollectionModel(varNotificationCollectionModel)
...
type NullableNotificationCollectionModel struct {
	value *NotificationCollectionModel
	isSet bool
}

func (v NullableNotificationCollectionModel) Get() *NotificationCollectionModel {
	return v.value
}

func (v *NullableNotificationCollectionModel) Set(val *NotificationCollectionModel) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationCollectionModel) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationCollectionModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationCollectionModel(val *NotificationCollectionModel) *NullableNotificationCollectionModel {
	return &NullableNotificationCollectionModel{value: val, isSet: true}
}

func (v NullableNotificationCollectionModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationCollectionModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
