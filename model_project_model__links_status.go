...
// checks if the ProjectModelLinksStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksStatus{}

// ProjectModelLinksStatus struct for ProjectModelLinksStatus
type ProjectModelLinksStatus struct {
...
type _ProjectModelLinksStatus ProjectModelLinksStatus
...
func (o *ProjectModelLinksStatus) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectModelLinksStatus) GetMethod() string {
...
func (o ProjectModelLinksStatus) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksStatus := _ProjectModelLinksStatus{}

	err = json.Unmarshal(data, &varProjectModelLinksStatus)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksStatus(varProjectModelLinksStatus)
...
type NullableProjectModelLinksStatus struct {
	value *ProjectModelLinksStatus
	isSet bool
}

func (v NullableProjectModelLinksStatus) Get() *ProjectModelLinksStatus {
	return v.value
}

func (v *NullableProjectModelLinksStatus) Set(val *ProjectModelLinksStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksStatus(val *ProjectModelLinksStatus) *NullableProjectModelLinksStatus {
	return &NullableProjectModelLinksStatus{value: val, isSet: true}
}

func (v NullableProjectModelLinksStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
