...
// checks if the MeetingModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeetingModelLinksSelf{}

// MeetingModelLinksSelf struct for MeetingModelLinksSelf
type MeetingModelLinksSelf struct {
...
type _MeetingModelLinksSelf MeetingModelLinksSelf
...
func (o *MeetingModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *MeetingModelLinksSelf) GetMethod() string {
...
func (o MeetingModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o MeetingModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *MeetingModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varMeetingModelLinksSelf := _MeetingModelLinksSelf{}

	err = json.Unmarshal(data, &varMeetingModelLinksSelf)

	if err != nil {
		return err
	}

	*o = MeetingModelLinksSelf(varMeetingModelLinksSelf)
...
type NullableMeetingModelLinksSelf struct {
	value *MeetingModelLinksSelf
	isSet bool
}

func (v NullableMeetingModelLinksSelf) Get() *MeetingModelLinksSelf {
	return v.value
}

func (v *NullableMeetingModelLinksSelf) Set(val *MeetingModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableMeetingModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableMeetingModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeetingModelLinksSelf(val *MeetingModelLinksSelf) *NullableMeetingModelLinksSelf {
	return &NullableMeetingModelLinksSelf{value: val, isSet: true}
}

func (v NullableMeetingModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeetingModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
