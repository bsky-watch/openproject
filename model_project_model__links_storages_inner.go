...
// checks if the ProjectModelLinksStoragesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksStoragesInner{}

// ProjectModelLinksStoragesInner struct for ProjectModelLinksStoragesInner
type ProjectModelLinksStoragesInner struct {
...
type _ProjectModelLinksStoragesInner ProjectModelLinksStoragesInner
...
func NewProjectModelLinksStoragesInner(href string) *ProjectModelLinksStoragesInner {
	this := ProjectModelLinksStoragesInner{}
	this.Href = href
...
func (o ProjectModelLinksStoragesInner) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksStoragesInner) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksStoragesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksStoragesInner := _ProjectModelLinksStoragesInner{}

	err = json.Unmarshal(data, &varProjectModelLinksStoragesInner)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksStoragesInner(varProjectModelLinksStoragesInner)
...
type NullableProjectModelLinksStoragesInner struct {
	value *ProjectModelLinksStoragesInner
	isSet bool
}

func (v NullableProjectModelLinksStoragesInner) Get() *ProjectModelLinksStoragesInner {
	return v.value
}

func (v *NullableProjectModelLinksStoragesInner) Set(val *ProjectModelLinksStoragesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksStoragesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksStoragesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksStoragesInner(val *ProjectModelLinksStoragesInner) *NullableProjectModelLinksStoragesInner {
	return &NullableProjectModelLinksStoragesInner{value: val, isSet: true}
}

func (v NullableProjectModelLinksStoragesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksStoragesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
