...
// checks if the RelationModelLinksTo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelationModelLinksTo{}

// RelationModelLinksTo struct for RelationModelLinksTo
type RelationModelLinksTo struct {
...
type _RelationModelLinksTo RelationModelLinksTo
...
func (o RelationModelLinksTo) MarshalJSON() ([]byte, error) {
...
func (o RelationModelLinksTo) ToMap() (map[string]interface{}, error) {
...
func (o *RelationModelLinksTo) UnmarshalJSON(data []byte) (err error) {
	...
	varRelationModelLinksTo := _RelationModelLinksTo{}

	err = json.Unmarshal(data, &varRelationModelLinksTo)

	if err != nil {
		return err
	}

	*o = RelationModelLinksTo(varRelationModelLinksTo)
...
type NullableRelationModelLinksTo struct {
	value *RelationModelLinksTo
	isSet bool
}

func (v NullableRelationModelLinksTo) Get() *RelationModelLinksTo {
	return v.value
}

func (v *NullableRelationModelLinksTo) Set(val *RelationModelLinksTo) {
	v.value = val
	v.isSet = true
}

func (v NullableRelationModelLinksTo) IsSet() bool {
	return v.isSet
}

func (v *NullableRelationModelLinksTo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRelationModelLinksTo(val *RelationModelLinksTo) *NullableRelationModelLinksTo {
	return &NullableRelationModelLinksTo{value: val, isSet: true}
}

func (v NullableRelationModelLinksTo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRelationModelLinksTo) UnmarshalJSON(src []byte) error {
	v.isSet = true
