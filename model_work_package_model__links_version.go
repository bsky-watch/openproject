...
// checks if the WorkPackageModelLinksVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksVersion{}

// WorkPackageModelLinksVersion struct for WorkPackageModelLinksVersion
type WorkPackageModelLinksVersion struct {
...
type _WorkPackageModelLinksVersion WorkPackageModelLinksVersion
...
func NewWorkPackageModelLinksVersion(href string) *WorkPackageModelLinksVersion {
	this := WorkPackageModelLinksVersion{}
	this.Href = href
...
func (o WorkPackageModelLinksVersion) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksVersion) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksVersion) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksVersion := _WorkPackageModelLinksVersion{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksVersion)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksVersion(varWorkPackageModelLinksVersion)
...
type NullableWorkPackageModelLinksVersion struct {
	value *WorkPackageModelLinksVersion
	isSet bool
}

func (v NullableWorkPackageModelLinksVersion) Get() *WorkPackageModelLinksVersion {
	return v.value
}

func (v *NullableWorkPackageModelLinksVersion) Set(val *WorkPackageModelLinksVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksVersion(val *WorkPackageModelLinksVersion) *NullableWorkPackageModelLinksVersion {
	return &NullableWorkPackageModelLinksVersion{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
