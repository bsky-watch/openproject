...
// checks if the WorkPackageModelLinksParent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksParent{}

// WorkPackageModelLinksParent struct for WorkPackageModelLinksParent
type WorkPackageModelLinksParent struct {
...
type _WorkPackageModelLinksParent WorkPackageModelLinksParent
...
func NewWorkPackageModelLinksParent(href string) *WorkPackageModelLinksParent {
	this := WorkPackageModelLinksParent{}
	this.Href = href
...
func (o *WorkPackageModelLinksParent) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksParent) GetMethod() string {
...
func (o WorkPackageModelLinksParent) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksParent) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksParent) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksParent := _WorkPackageModelLinksParent{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksParent)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksParent(varWorkPackageModelLinksParent)
...
type NullableWorkPackageModelLinksParent struct {
	value *WorkPackageModelLinksParent
	isSet bool
}

func (v NullableWorkPackageModelLinksParent) Get() *WorkPackageModelLinksParent {
	return v.value
}

func (v *NullableWorkPackageModelLinksParent) Set(val *WorkPackageModelLinksParent) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksParent) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksParent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksParent(val *WorkPackageModelLinksParent) *NullableWorkPackageModelLinksParent {
	return &NullableWorkPackageModelLinksParent{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksParent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksParent) UnmarshalJSON(src []byte) error {
	v.isSet = true
