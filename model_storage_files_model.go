...
// checks if the StorageFilesModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageFilesModel{}

// StorageFilesModel struct for StorageFilesModel
type StorageFilesModel struct {
	Type string `json:"_type"`
	// List of files provided by the selected storage.
	Files []StorageFileModel `json:"files"`
	Parent StorageFilesModelParent `json:"parent"`
	// List of ancestors of the parent directory. Can be empty, if parent directory was root directory.
	Ancestors []StorageFileModel `json:"ancestors"`
	Links StorageFileModelAllOfLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _StorageFilesModel StorageFilesModel
...
func (o *StorageFilesModel) GetParent() StorageFilesModelParent {
	if o == nil {
		var ret StorageFilesModelParent
		return ret
	}
...
func (o StorageFilesModel) MarshalJSON() ([]byte, error) {
...
func (o StorageFilesModel) ToMap() (map[string]interface{}, error) {
...
func (o *StorageFilesModel) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageFilesModel := _StorageFilesModel{}

	err = json.Unmarshal(data, &varStorageFilesModel)

	if err != nil {
		return err
	}

	*o = StorageFilesModel(varStorageFilesModel)
...
type NullableStorageFilesModel struct {
	value *StorageFilesModel
	isSet bool
}

func (v NullableStorageFilesModel) Get() *StorageFilesModel {
	return v.value
}

func (v *NullableStorageFilesModel) Set(val *StorageFilesModel) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageFilesModel) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageFilesModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageFilesModel(val *StorageFilesModel) *NullableStorageFilesModel {
	return &NullableStorageFilesModel{value: val, isSet: true}
}

func (v NullableStorageFilesModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageFilesModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
