...
// checks if the PrincipalCollectionModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrincipalCollectionModel{}

// PrincipalCollectionModel struct for PrincipalCollectionModel
...
type _PrincipalCollectionModel PrincipalCollectionModel
...
func (o *PrincipalCollectionModel) GetLinks() PrincipalCollectionModelAllOfLinks {
	if o == nil {
		var ret PrincipalCollectionModelAllOfLinks
		return ret
	}
...
func (o *PrincipalCollectionModel) GetEmbedded() PrincipalCollectionModelAllOfEmbedded {
	if o == nil {
		var ret PrincipalCollectionModelAllOfEmbedded
		return ret
	}
...
func (o PrincipalCollectionModel) MarshalJSON() ([]byte, error) {
...
func (o PrincipalCollectionModel) ToMap() (map[string]interface{}, error) {
...
func (o *PrincipalCollectionModel) UnmarshalJSON(data []byte) (err error) {
	...
	varPrincipalCollectionModel := _PrincipalCollectionModel{}

	err = json.Unmarshal(data, &varPrincipalCollectionModel)

	if err != nil {
		return err
	}

	*o = PrincipalCollectionModel(varPrincipalCollectionModel)
...
type NullablePrincipalCollectionModel struct {
	value *PrincipalCollectionModel
	isSet bool
}

func (v NullablePrincipalCollectionModel) Get() *PrincipalCollectionModel {
	return v.value
}

func (v *NullablePrincipalCollectionModel) Set(val *PrincipalCollectionModel) {
	v.value = val
	v.isSet = true
}

func (v NullablePrincipalCollectionModel) IsSet() bool {
	return v.isSet
}

func (v *NullablePrincipalCollectionModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrincipalCollectionModel(val *PrincipalCollectionModel) *NullablePrincipalCollectionModel {
	return &NullablePrincipalCollectionModel{value: val, isSet: true}
}

func (v NullablePrincipalCollectionModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrincipalCollectionModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
