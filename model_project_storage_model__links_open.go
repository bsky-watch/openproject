...
// checks if the ProjectStorageModelLinksOpen type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectStorageModelLinksOpen{}

// ProjectStorageModelLinksOpen struct for ProjectStorageModelLinksOpen
type ProjectStorageModelLinksOpen struct {
...
type _ProjectStorageModelLinksOpen ProjectStorageModelLinksOpen
...
func NewProjectStorageModelLinksOpen(href string) *ProjectStorageModelLinksOpen {
	this := ProjectStorageModelLinksOpen{}
	this.Href = href
...
func (o *ProjectStorageModelLinksOpen) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectStorageModelLinksOpen) GetMethod() string {
...
func (o ProjectStorageModelLinksOpen) MarshalJSON() ([]byte, error) {
...
func (o ProjectStorageModelLinksOpen) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectStorageModelLinksOpen) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectStorageModelLinksOpen := _ProjectStorageModelLinksOpen{}

	err = json.Unmarshal(data, &varProjectStorageModelLinksOpen)

	if err != nil {
		return err
	}

	*o = ProjectStorageModelLinksOpen(varProjectStorageModelLinksOpen)
...
type NullableProjectStorageModelLinksOpen struct {
	value *ProjectStorageModelLinksOpen
	isSet bool
}

func (v NullableProjectStorageModelLinksOpen) Get() *ProjectStorageModelLinksOpen {
	return v.value
}

func (v *NullableProjectStorageModelLinksOpen) Set(val *ProjectStorageModelLinksOpen) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectStorageModelLinksOpen) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectStorageModelLinksOpen) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectStorageModelLinksOpen(val *ProjectStorageModelLinksOpen) *NullableProjectStorageModelLinksOpen {
	return &NullableProjectStorageModelLinksOpen{value: val, isSet: true}
}

func (v NullableProjectStorageModelLinksOpen) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectStorageModelLinksOpen) UnmarshalJSON(src []byte) error {
	v.isSet = true
