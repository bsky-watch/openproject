...
// checks if the WorkPackageModelLinksPriority type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksPriority{}

// WorkPackageModelLinksPriority struct for WorkPackageModelLinksPriority
type WorkPackageModelLinksPriority struct {
...
type _WorkPackageModelLinksPriority WorkPackageModelLinksPriority
...
func NewWorkPackageModelLinksPriority(href string) *WorkPackageModelLinksPriority {
	this := WorkPackageModelLinksPriority{}
	this.Href = href
...
func (o *WorkPackageModelLinksPriority) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksPriority) GetMethod() string {
...
func (o WorkPackageModelLinksPriority) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksPriority) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksPriority) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksPriority := _WorkPackageModelLinksPriority{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksPriority)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksPriority(varWorkPackageModelLinksPriority)
...
type NullableWorkPackageModelLinksPriority struct {
	value *WorkPackageModelLinksPriority
	isSet bool
}

func (v NullableWorkPackageModelLinksPriority) Get() *WorkPackageModelLinksPriority {
	return v.value
}

func (v *NullableWorkPackageModelLinksPriority) Set(val *WorkPackageModelLinksPriority) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksPriority) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksPriority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksPriority(val *WorkPackageModelLinksPriority) *NullableWorkPackageModelLinksPriority {
	return &NullableWorkPackageModelLinksPriority{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksPriority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksPriority) UnmarshalJSON(src []byte) error {
	v.isSet = true
