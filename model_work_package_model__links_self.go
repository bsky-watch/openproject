...
// checks if the WorkPackageModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksSelf{}

// WorkPackageModelLinksSelf struct for WorkPackageModelLinksSelf
type WorkPackageModelLinksSelf struct {
...
type _WorkPackageModelLinksSelf WorkPackageModelLinksSelf
...
func NewWorkPackageModelLinksSelf(href string) *WorkPackageModelLinksSelf {
	this := WorkPackageModelLinksSelf{}
	this.Href = href
...
func (o *WorkPackageModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksSelf) GetMethod() string {
...
func (o WorkPackageModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksSelf := _WorkPackageModelLinksSelf{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksSelf)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksSelf(varWorkPackageModelLinksSelf)
...
type NullableWorkPackageModelLinksSelf struct {
	value *WorkPackageModelLinksSelf
	isSet bool
}

func (v NullableWorkPackageModelLinksSelf) Get() *WorkPackageModelLinksSelf {
	return v.value
}

func (v *NullableWorkPackageModelLinksSelf) Set(val *WorkPackageModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksSelf(val *WorkPackageModelLinksSelf) *NullableWorkPackageModelLinksSelf {
	return &NullableWorkPackageModelLinksSelf{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
