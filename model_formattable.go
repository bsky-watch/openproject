...
// checks if the Formattable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Formattable{}

// Formattable struct for Formattable
...
func (o Formattable) MarshalJSON() ([]byte, error) {
...
func (o Formattable) ToMap() (map[string]interface{}, error) {
...
func (o *Formattable) UnmarshalJSON(data []byte) (err error) {
	...
	varFormattable := _Formattable{}

	err = json.Unmarshal(data, &varFormattable)

	if err != nil {
		return err
	}

	*o = Formattable(varFormattable)
...
type NullableFormattable struct {
	value *Formattable
	isSet bool
}

func (v NullableFormattable) Get() *Formattable {
	return v.value
}

func (v *NullableFormattable) Set(val *Formattable) {
	v.value = val
	v.isSet = true
}

func (v NullableFormattable) IsSet() bool {
	return v.isSet
}

func (v *NullableFormattable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormattable(val *Formattable) *NullableFormattable {
	return &NullableFormattable{value: val, isSet: true}
}

func (v NullableFormattable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormattable) UnmarshalJSON(src []byte) error {
	v.isSet = true
