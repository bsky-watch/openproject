...
// checks if the TimeEntryModelLinksSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryModelLinksSchema{}

// TimeEntryModelLinksSchema struct for TimeEntryModelLinksSchema
type TimeEntryModelLinksSchema struct {
...
type _TimeEntryModelLinksSchema TimeEntryModelLinksSchema
...
func NewTimeEntryModelLinksSchema(href string) *TimeEntryModelLinksSchema {
	this := TimeEntryModelLinksSchema{}
	this.Href = href
...
func (o *TimeEntryModelLinksSchema) SetHref(v string) {
	o.Href = v
}
...
func (o *TimeEntryModelLinksSchema) GetMethod() string {
...
func (o TimeEntryModelLinksSchema) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryModelLinksSchema) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryModelLinksSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryModelLinksSchema := _TimeEntryModelLinksSchema{}

	err = json.Unmarshal(data, &varTimeEntryModelLinksSchema)

	if err != nil {
		return err
	}

	*o = TimeEntryModelLinksSchema(varTimeEntryModelLinksSchema)
...
type NullableTimeEntryModelLinksSchema struct {
	value *TimeEntryModelLinksSchema
	isSet bool
}

func (v NullableTimeEntryModelLinksSchema) Get() *TimeEntryModelLinksSchema {
	return v.value
}

func (v *NullableTimeEntryModelLinksSchema) Set(val *TimeEntryModelLinksSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryModelLinksSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryModelLinksSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryModelLinksSchema(val *TimeEntryModelLinksSchema) *NullableTimeEntryModelLinksSchema {
	return &NullableTimeEntryModelLinksSchema{value: val, isSet: true}
}

func (v NullableTimeEntryModelLinksSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryModelLinksSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
