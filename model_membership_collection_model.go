...
// checks if the MembershipCollectionModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipCollectionModel{}

// MembershipCollectionModel struct for MembershipCollectionModel
...
type _MembershipCollectionModel MembershipCollectionModel
...
func (o *MembershipCollectionModel) GetLinks() PaginatedCollectionModelAllOfLinks {
	if o == nil {
		var ret PaginatedCollectionModelAllOfLinks
		return ret
	}
...
func (o *MembershipCollectionModel) GetEmbedded() MembershipCollectionModelAllOfEmbedded {
	if o == nil {
		var ret MembershipCollectionModelAllOfEmbedded
		return ret
	}
...
func (o MembershipCollectionModel) MarshalJSON() ([]byte, error) {
...
func (o MembershipCollectionModel) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipCollectionModel) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipCollectionModel := _MembershipCollectionModel{}

	err = json.Unmarshal(data, &varMembershipCollectionModel)

	if err != nil {
		return err
	}

	*o = MembershipCollectionModel(varMembershipCollectionModel)
...
type NullableMembershipCollectionModel struct {
	value *MembershipCollectionModel
	isSet bool
}

func (v NullableMembershipCollectionModel) Get() *MembershipCollectionModel {
	return v.value
}

func (v *NullableMembershipCollectionModel) Set(val *MembershipCollectionModel) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipCollectionModel) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipCollectionModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipCollectionModel(val *MembershipCollectionModel) *NullableMembershipCollectionModel {
	return &NullableMembershipCollectionModel{value: val, isSet: true}
}

func (v NullableMembershipCollectionModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipCollectionModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
