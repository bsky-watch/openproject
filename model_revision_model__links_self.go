...
// checks if the RevisionModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevisionModelLinksSelf{}

// RevisionModelLinksSelf struct for RevisionModelLinksSelf
type RevisionModelLinksSelf struct {
...
type _RevisionModelLinksSelf RevisionModelLinksSelf
...
func (o *RevisionModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *RevisionModelLinksSelf) GetMethod() string {
...
func (o RevisionModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o RevisionModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *RevisionModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varRevisionModelLinksSelf := _RevisionModelLinksSelf{}

	err = json.Unmarshal(data, &varRevisionModelLinksSelf)

	if err != nil {
		return err
	}

	*o = RevisionModelLinksSelf(varRevisionModelLinksSelf)
...
type NullableRevisionModelLinksSelf struct {
	value *RevisionModelLinksSelf
	isSet bool
}

func (v NullableRevisionModelLinksSelf) Get() *RevisionModelLinksSelf {
	return v.value
}

func (v *NullableRevisionModelLinksSelf) Set(val *RevisionModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableRevisionModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableRevisionModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRevisionModelLinksSelf(val *RevisionModelLinksSelf) *NullableRevisionModelLinksSelf {
	return &NullableRevisionModelLinksSelf{value: val, isSet: true}
}

func (v NullableRevisionModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRevisionModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
