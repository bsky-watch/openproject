...
// CustomOptionsAPIService CustomOptionsAPI service
type CustomOptionsAPIService service
...
func (r ApiViewCustomOptionRequest) Execute() (*CustomOptionModel, *http.Response, error) {
	return r.ApiService.ViewCustomOptionExecute(r)
}
...
func (a *CustomOptionsAPIService) ViewCustomOptionExecute(r ApiViewCustomOptionRequest) (*CustomOptionModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CustomOptionModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomOptionsAPIService.ViewCustomOption")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/custom_options/{id}"
