...
func (r ApiGetOauthApplicationRequest) Execute() (*OAuthApplicationReadModel, *http.Response, error) {
	return r.ApiService.GetOauthApplicationExecute(r)
}
...
func (a *OAuth2APIService) GetOauthApplicationExecute(r ApiGetOauthApplicationRequest) (*OAuthApplicationReadModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OAuthApplicationReadModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2APIService.GetOauthApplication")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/oauth_applications/{id}"
...
func (r ApiGetOauthClientCredentialsRequest) Execute() (*OAuthClientCredentialsReadModel, *http.Response, error) {
	return r.ApiService.GetOauthClientCredentialsExecute(r)
}
...
func (a *OAuth2APIService) GetOauthClientCredentialsExecute(r ApiGetOauthClientCredentialsRequest) (*OAuthClientCredentialsReadModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OAuthClientCredentialsReadModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2APIService.GetOauthClientCredentials")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/oauth_client_credentials/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
