...
// checks if the NonWorkingDayModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NonWorkingDayModelLinksSelf{}

// NonWorkingDayModelLinksSelf struct for NonWorkingDayModelLinksSelf
type NonWorkingDayModelLinksSelf struct {
...
type _NonWorkingDayModelLinksSelf NonWorkingDayModelLinksSelf
...
func NewNonWorkingDayModelLinksSelf(href string) *NonWorkingDayModelLinksSelf {
	this := NonWorkingDayModelLinksSelf{}
	this.Href = href
...
func (o NonWorkingDayModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o NonWorkingDayModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *NonWorkingDayModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varNonWorkingDayModelLinksSelf := _NonWorkingDayModelLinksSelf{}

	err = json.Unmarshal(data, &varNonWorkingDayModelLinksSelf)

	if err != nil {
		return err
	}

	*o = NonWorkingDayModelLinksSelf(varNonWorkingDayModelLinksSelf)
...
type NullableNonWorkingDayModelLinksSelf struct {
	value *NonWorkingDayModelLinksSelf
	isSet bool
}

func (v NullableNonWorkingDayModelLinksSelf) Get() *NonWorkingDayModelLinksSelf {
	return v.value
}

func (v *NullableNonWorkingDayModelLinksSelf) Set(val *NonWorkingDayModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableNonWorkingDayModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableNonWorkingDayModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNonWorkingDayModelLinksSelf(val *NonWorkingDayModelLinksSelf) *NullableNonWorkingDayModelLinksSelf {
	return &NullableNonWorkingDayModelLinksSelf{value: val, isSet: true}
}

func (v NullableNonWorkingDayModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNonWorkingDayModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
