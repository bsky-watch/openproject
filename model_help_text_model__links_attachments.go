...
// checks if the HelpTextModelLinksAttachments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HelpTextModelLinksAttachments{}

// HelpTextModelLinksAttachments struct for HelpTextModelLinksAttachments
type HelpTextModelLinksAttachments struct {
...
type _HelpTextModelLinksAttachments HelpTextModelLinksAttachments
...
func NewHelpTextModelLinksAttachments(href string) *HelpTextModelLinksAttachments {
	this := HelpTextModelLinksAttachments{}
	this.Href = href
...
func (o HelpTextModelLinksAttachments) MarshalJSON() ([]byte, error) {
...
func (o HelpTextModelLinksAttachments) ToMap() (map[string]interface{}, error) {
...
func (o *HelpTextModelLinksAttachments) UnmarshalJSON(data []byte) (err error) {
	...
	varHelpTextModelLinksAttachments := _HelpTextModelLinksAttachments{}

	err = json.Unmarshal(data, &varHelpTextModelLinksAttachments)

	if err != nil {
		return err
	}

	*o = HelpTextModelLinksAttachments(varHelpTextModelLinksAttachments)
...
type NullableHelpTextModelLinksAttachments struct {
	value *HelpTextModelLinksAttachments
	isSet bool
}

func (v NullableHelpTextModelLinksAttachments) Get() *HelpTextModelLinksAttachments {
	return v.value
}

func (v *NullableHelpTextModelLinksAttachments) Set(val *HelpTextModelLinksAttachments) {
	v.value = val
	v.isSet = true
}

func (v NullableHelpTextModelLinksAttachments) IsSet() bool {
	return v.isSet
}

func (v *NullableHelpTextModelLinksAttachments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHelpTextModelLinksAttachments(val *HelpTextModelLinksAttachments) *NullableHelpTextModelLinksAttachments {
	return &NullableHelpTextModelLinksAttachments{value: val, isSet: true}
}

func (v NullableHelpTextModelLinksAttachments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHelpTextModelLinksAttachments) UnmarshalJSON(src []byte) error {
	v.isSet = true
