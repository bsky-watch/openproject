...
// checks if the ProjectModelLinksWorkPackages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksWorkPackages{}

// ProjectModelLinksWorkPackages struct for ProjectModelLinksWorkPackages
type ProjectModelLinksWorkPackages struct {
...
type _ProjectModelLinksWorkPackages ProjectModelLinksWorkPackages
...
func NewProjectModelLinksWorkPackages(href string) *ProjectModelLinksWorkPackages {
	this := ProjectModelLinksWorkPackages{}
	this.Href = href
...
func (o *ProjectModelLinksWorkPackages) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectModelLinksWorkPackages) GetMethod() string {
...
func (o ProjectModelLinksWorkPackages) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksWorkPackages) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksWorkPackages) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksWorkPackages := _ProjectModelLinksWorkPackages{}

	err = json.Unmarshal(data, &varProjectModelLinksWorkPackages)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksWorkPackages(varProjectModelLinksWorkPackages)
...
type NullableProjectModelLinksWorkPackages struct {
	value *ProjectModelLinksWorkPackages
	isSet bool
}

func (v NullableProjectModelLinksWorkPackages) Get() *ProjectModelLinksWorkPackages {
	return v.value
}

func (v *NullableProjectModelLinksWorkPackages) Set(val *ProjectModelLinksWorkPackages) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksWorkPackages) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksWorkPackages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksWorkPackages(val *ProjectModelLinksWorkPackages) *NullableProjectModelLinksWorkPackages {
	return &NullableProjectModelLinksWorkPackages{value: val, isSet: true}
}

func (v NullableProjectModelLinksWorkPackages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksWorkPackages) UnmarshalJSON(src []byte) error {
	v.isSet = true
