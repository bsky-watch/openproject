...
// checks if the TimeEntryActivityModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryActivityModelLinksSelf{}

// TimeEntryActivityModelLinksSelf struct for TimeEntryActivityModelLinksSelf
type TimeEntryActivityModelLinksSelf struct {
...
type _TimeEntryActivityModelLinksSelf TimeEntryActivityModelLinksSelf
...
func NewTimeEntryActivityModelLinksSelf(href string) *TimeEntryActivityModelLinksSelf {
	this := TimeEntryActivityModelLinksSelf{}
	this.Href = href
...
func (o TimeEntryActivityModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryActivityModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryActivityModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryActivityModelLinksSelf := _TimeEntryActivityModelLinksSelf{}

	err = json.Unmarshal(data, &varTimeEntryActivityModelLinksSelf)

	if err != nil {
		return err
	}

	*o = TimeEntryActivityModelLinksSelf(varTimeEntryActivityModelLinksSelf)
...
type NullableTimeEntryActivityModelLinksSelf struct {
	value *TimeEntryActivityModelLinksSelf
	isSet bool
}

func (v NullableTimeEntryActivityModelLinksSelf) Get() *TimeEntryActivityModelLinksSelf {
	return v.value
}

func (v *NullableTimeEntryActivityModelLinksSelf) Set(val *TimeEntryActivityModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryActivityModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryActivityModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryActivityModelLinksSelf(val *TimeEntryActivityModelLinksSelf) *NullableTimeEntryActivityModelLinksSelf {
	return &NullableTimeEntryActivityModelLinksSelf{value: val, isSet: true}
}

func (v NullableTimeEntryActivityModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryActivityModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
