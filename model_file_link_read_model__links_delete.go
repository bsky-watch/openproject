...
// checks if the FileLinkReadModelLinksDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileLinkReadModelLinksDelete{}

// FileLinkReadModelLinksDelete struct for FileLinkReadModelLinksDelete
type FileLinkReadModelLinksDelete struct {
...
type _FileLinkReadModelLinksDelete FileLinkReadModelLinksDelete
...
func NewFileLinkReadModelLinksDelete(href string) *FileLinkReadModelLinksDelete {
	this := FileLinkReadModelLinksDelete{}
	this.Href = href
...
func (o *FileLinkReadModelLinksDelete) SetHref(v string) {
	o.Href = v
}
...
func (o *FileLinkReadModelLinksDelete) GetMethod() string {
...
func (o FileLinkReadModelLinksDelete) MarshalJSON() ([]byte, error) {
...
func (o FileLinkReadModelLinksDelete) ToMap() (map[string]interface{}, error) {
...
func (o *FileLinkReadModelLinksDelete) UnmarshalJSON(data []byte) (err error) {
	...
	varFileLinkReadModelLinksDelete := _FileLinkReadModelLinksDelete{}

	err = json.Unmarshal(data, &varFileLinkReadModelLinksDelete)

	if err != nil {
		return err
	}

	*o = FileLinkReadModelLinksDelete(varFileLinkReadModelLinksDelete)
...
type NullableFileLinkReadModelLinksDelete struct {
	value *FileLinkReadModelLinksDelete
	isSet bool
}

func (v NullableFileLinkReadModelLinksDelete) Get() *FileLinkReadModelLinksDelete {
	return v.value
}

func (v *NullableFileLinkReadModelLinksDelete) Set(val *FileLinkReadModelLinksDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableFileLinkReadModelLinksDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableFileLinkReadModelLinksDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileLinkReadModelLinksDelete(val *FileLinkReadModelLinksDelete) *NullableFileLinkReadModelLinksDelete {
	return &NullableFileLinkReadModelLinksDelete{value: val, isSet: true}
}

func (v NullableFileLinkReadModelLinksDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileLinkReadModelLinksDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
