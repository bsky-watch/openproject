...
// checks if the UserModelAllOfLinksAuthSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserModelAllOfLinksAuthSource{}

// UserModelAllOfLinksAuthSource struct for UserModelAllOfLinksAuthSource
type UserModelAllOfLinksAuthSource struct {
...
type _UserModelAllOfLinksAuthSource UserModelAllOfLinksAuthSource
...
func NewUserModelAllOfLinksAuthSource(href string) *UserModelAllOfLinksAuthSource {
	this := UserModelAllOfLinksAuthSource{}
	this.Href = href
...
func (o UserModelAllOfLinksAuthSource) MarshalJSON() ([]byte, error) {
...
func (o UserModelAllOfLinksAuthSource) ToMap() (map[string]interface{}, error) {
...
func (o *UserModelAllOfLinksAuthSource) UnmarshalJSON(data []byte) (err error) {
	...
	varUserModelAllOfLinksAuthSource := _UserModelAllOfLinksAuthSource{}

	err = json.Unmarshal(data, &varUserModelAllOfLinksAuthSource)

	if err != nil {
		return err
	}

	*o = UserModelAllOfLinksAuthSource(varUserModelAllOfLinksAuthSource)
...
type NullableUserModelAllOfLinksAuthSource struct {
	value *UserModelAllOfLinksAuthSource
	isSet bool
}

func (v NullableUserModelAllOfLinksAuthSource) Get() *UserModelAllOfLinksAuthSource {
	return v.value
}

func (v *NullableUserModelAllOfLinksAuthSource) Set(val *UserModelAllOfLinksAuthSource) {
	v.value = val
	v.isSet = true
}

func (v NullableUserModelAllOfLinksAuthSource) IsSet() bool {
	return v.isSet
}

func (v *NullableUserModelAllOfLinksAuthSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserModelAllOfLinksAuthSource(val *UserModelAllOfLinksAuthSource) *NullableUserModelAllOfLinksAuthSource {
	return &NullableUserModelAllOfLinksAuthSource{value: val, isSet: true}
}

func (v NullableUserModelAllOfLinksAuthSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserModelAllOfLinksAuthSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
