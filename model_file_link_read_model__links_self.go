...
// checks if the FileLinkReadModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileLinkReadModelLinksSelf{}

// FileLinkReadModelLinksSelf struct for FileLinkReadModelLinksSelf
type FileLinkReadModelLinksSelf struct {
...
type _FileLinkReadModelLinksSelf FileLinkReadModelLinksSelf
...
func NewFileLinkReadModelLinksSelf(href string) *FileLinkReadModelLinksSelf {
	this := FileLinkReadModelLinksSelf{}
	this.Href = href
...
func (o FileLinkReadModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o FileLinkReadModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *FileLinkReadModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varFileLinkReadModelLinksSelf := _FileLinkReadModelLinksSelf{}

	err = json.Unmarshal(data, &varFileLinkReadModelLinksSelf)

	if err != nil {
		return err
	}

	*o = FileLinkReadModelLinksSelf(varFileLinkReadModelLinksSelf)
...
type NullableFileLinkReadModelLinksSelf struct {
	value *FileLinkReadModelLinksSelf
	isSet bool
}

func (v NullableFileLinkReadModelLinksSelf) Get() *FileLinkReadModelLinksSelf {
	return v.value
}

func (v *NullableFileLinkReadModelLinksSelf) Set(val *FileLinkReadModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableFileLinkReadModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableFileLinkReadModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileLinkReadModelLinksSelf(val *FileLinkReadModelLinksSelf) *NullableFileLinkReadModelLinksSelf {
	return &NullableFileLinkReadModelLinksSelf{value: val, isSet: true}
}

func (v NullableFileLinkReadModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileLinkReadModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
