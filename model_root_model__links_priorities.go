...
// checks if the RootModelLinksPriorities type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksPriorities{}

// RootModelLinksPriorities struct for RootModelLinksPriorities
type RootModelLinksPriorities struct {
...
type _RootModelLinksPriorities RootModelLinksPriorities
...
func (o RootModelLinksPriorities) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksPriorities) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksPriorities) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksPriorities := _RootModelLinksPriorities{}

	err = json.Unmarshal(data, &varRootModelLinksPriorities)

	if err != nil {
		return err
	}

	*o = RootModelLinksPriorities(varRootModelLinksPriorities)
...
type NullableRootModelLinksPriorities struct {
	value *RootModelLinksPriorities
	isSet bool
}

func (v NullableRootModelLinksPriorities) Get() *RootModelLinksPriorities {
	return v.value
}

func (v *NullableRootModelLinksPriorities) Set(val *RootModelLinksPriorities) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksPriorities) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksPriorities) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksPriorities(val *RootModelLinksPriorities) *NullableRootModelLinksPriorities {
	return &NullableRootModelLinksPriorities{value: val, isSet: true}
}

func (v NullableRootModelLinksPriorities) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksPriorities) UnmarshalJSON(src []byte) error {
	v.isSet = true
