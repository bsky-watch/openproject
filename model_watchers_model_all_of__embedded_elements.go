...
// checks if the WatchersModelAllOfEmbeddedElements type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatchersModelAllOfEmbeddedElements{}

// WatchersModelAllOfEmbeddedElements struct for WatchersModelAllOfEmbeddedElements
type WatchersModelAllOfEmbeddedElements struct {
...
type _WatchersModelAllOfEmbeddedElements WatchersModelAllOfEmbeddedElements
...
func NewWatchersModelAllOfEmbeddedElements(type_ string, id int, name string, links UserModelAllOfLinks, avatar string) *WatchersModelAllOfEmbeddedElements {
	this := WatchersModelAllOfEmbeddedElements{}
	this.Type = type_
	this.Id = id
	this.Name = name
	this.Links = links
...
func (o *WatchersModelAllOfEmbeddedElements) GetId() int {
	if o == nil {
		var ret int
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WatchersModelAllOfEmbeddedElements) GetIdOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *WatchersModelAllOfEmbeddedElements) SetId(v int) {
	o.Id = v
}
...
func (o *WatchersModelAllOfEmbeddedElements) SetIdentityUrlNil() {
	o.IdentityUrl.Set(nil)
}

// UnsetIdentityUrl ensures that no value is present for IdentityUrl, not even an explicit nil
func (o *WatchersModelAllOfEmbeddedElements) UnsetIdentityUrl() {
	o.IdentityUrl.Unset()
}

func (o WatchersModelAllOfEmbeddedElements) MarshalJSON() ([]byte, error) {
...
func (o WatchersModelAllOfEmbeddedElements) ToMap() (map[string]interface{}, error) {
...
func (o *WatchersModelAllOfEmbeddedElements) UnmarshalJSON(data []byte) (err error) {
	...
	varWatchersModelAllOfEmbeddedElements := _WatchersModelAllOfEmbeddedElements{}

	err = json.Unmarshal(data, &varWatchersModelAllOfEmbeddedElements)

	if err != nil {
		return err
	}

	*o = WatchersModelAllOfEmbeddedElements(varWatchersModelAllOfEmbeddedElements)
...
type NullableWatchersModelAllOfEmbeddedElements struct {
	value *WatchersModelAllOfEmbeddedElements
	isSet bool
}

func (v NullableWatchersModelAllOfEmbeddedElements) Get() *WatchersModelAllOfEmbeddedElements {
	return v.value
}

func (v *NullableWatchersModelAllOfEmbeddedElements) Set(val *WatchersModelAllOfEmbeddedElements) {
	v.value = val
	v.isSet = true
}

func (v NullableWatchersModelAllOfEmbeddedElements) IsSet() bool {
	return v.isSet
}

func (v *NullableWatchersModelAllOfEmbeddedElements) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatchersModelAllOfEmbeddedElements(val *WatchersModelAllOfEmbeddedElements) *NullableWatchersModelAllOfEmbeddedElements {
	return &NullableWatchersModelAllOfEmbeddedElements{value: val, isSet: true}
}

func (v NullableWatchersModelAllOfEmbeddedElements) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatchersModelAllOfEmbeddedElements) UnmarshalJSON(src []byte) error {
	v.isSet = true
