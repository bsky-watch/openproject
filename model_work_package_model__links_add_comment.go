...
// checks if the WorkPackageModelLinksAddComment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksAddComment{}

// WorkPackageModelLinksAddComment struct for WorkPackageModelLinksAddComment
type WorkPackageModelLinksAddComment struct {
...
type _WorkPackageModelLinksAddComment WorkPackageModelLinksAddComment
...
func NewWorkPackageModelLinksAddComment(href string) *WorkPackageModelLinksAddComment {
	this := WorkPackageModelLinksAddComment{}
	this.Href = href
...
func (o WorkPackageModelLinksAddComment) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksAddComment) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksAddComment) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksAddComment := _WorkPackageModelLinksAddComment{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksAddComment)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksAddComment(varWorkPackageModelLinksAddComment)
...
type NullableWorkPackageModelLinksAddComment struct {
	value *WorkPackageModelLinksAddComment
	isSet bool
}

func (v NullableWorkPackageModelLinksAddComment) Get() *WorkPackageModelLinksAddComment {
	return v.value
}

func (v *NullableWorkPackageModelLinksAddComment) Set(val *WorkPackageModelLinksAddComment) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksAddComment) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksAddComment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksAddComment(val *WorkPackageModelLinksAddComment) *NullableWorkPackageModelLinksAddComment {
	return &NullableWorkPackageModelLinksAddComment{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksAddComment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksAddComment) UnmarshalJSON(src []byte) error {
	v.isSet = true
