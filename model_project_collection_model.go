...
// checks if the ProjectCollectionModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectCollectionModel{}

// ProjectCollectionModel struct for ProjectCollectionModel
...
type _ProjectCollectionModel ProjectCollectionModel
...
func (o *ProjectCollectionModel) GetLinks() ProjectCollectionModelAllOfLinks {
	if o == nil {
		var ret ProjectCollectionModelAllOfLinks
		return ret
	}
...
func (o *ProjectCollectionModel) GetEmbedded() ProjectCollectionModelAllOfEmbedded {
	if o == nil {
		var ret ProjectCollectionModelAllOfEmbedded
		return ret
	}
...
func (o ProjectCollectionModel) MarshalJSON() ([]byte, error) {
...
func (o ProjectCollectionModel) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectCollectionModel) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectCollectionModel := _ProjectCollectionModel{}

	err = json.Unmarshal(data, &varProjectCollectionModel)

	if err != nil {
		return err
	}

	*o = ProjectCollectionModel(varProjectCollectionModel)
...
type NullableProjectCollectionModel struct {
	value *ProjectCollectionModel
	isSet bool
}

func (v NullableProjectCollectionModel) Get() *ProjectCollectionModel {
	return v.value
}

func (v *NullableProjectCollectionModel) Set(val *ProjectCollectionModel) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectCollectionModel) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectCollectionModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectCollectionModel(val *ProjectCollectionModel) *NullableProjectCollectionModel {
	return &NullableProjectCollectionModel{value: val, isSet: true}
}

func (v NullableProjectCollectionModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectCollectionModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
