...
// checks if the WikiPageModelLinksAddAttachment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WikiPageModelLinksAddAttachment{}

// WikiPageModelLinksAddAttachment struct for WikiPageModelLinksAddAttachment
type WikiPageModelLinksAddAttachment struct {
...
type _WikiPageModelLinksAddAttachment WikiPageModelLinksAddAttachment
...
func NewWikiPageModelLinksAddAttachment(href string) *WikiPageModelLinksAddAttachment {
	this := WikiPageModelLinksAddAttachment{}
	this.Href = href
...
func (o WikiPageModelLinksAddAttachment) MarshalJSON() ([]byte, error) {
...
func (o WikiPageModelLinksAddAttachment) ToMap() (map[string]interface{}, error) {
...
func (o *WikiPageModelLinksAddAttachment) UnmarshalJSON(data []byte) (err error) {
	...
	varWikiPageModelLinksAddAttachment := _WikiPageModelLinksAddAttachment{}

	err = json.Unmarshal(data, &varWikiPageModelLinksAddAttachment)

	if err != nil {
		return err
	}

	*o = WikiPageModelLinksAddAttachment(varWikiPageModelLinksAddAttachment)
...
type NullableWikiPageModelLinksAddAttachment struct {
	value *WikiPageModelLinksAddAttachment
	isSet bool
}

func (v NullableWikiPageModelLinksAddAttachment) Get() *WikiPageModelLinksAddAttachment {
	return v.value
}

func (v *NullableWikiPageModelLinksAddAttachment) Set(val *WikiPageModelLinksAddAttachment) {
	v.value = val
	v.isSet = true
}

func (v NullableWikiPageModelLinksAddAttachment) IsSet() bool {
	return v.isSet
}

func (v *NullableWikiPageModelLinksAddAttachment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWikiPageModelLinksAddAttachment(val *WikiPageModelLinksAddAttachment) *NullableWikiPageModelLinksAddAttachment {
	return &NullableWikiPageModelLinksAddAttachment{value: val, isSet: true}
}

func (v NullableWikiPageModelLinksAddAttachment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWikiPageModelLinksAddAttachment) UnmarshalJSON(src []byte) error {
	v.isSet = true
