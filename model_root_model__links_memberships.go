...
// checks if the RootModelLinksMemberships type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksMemberships{}

// RootModelLinksMemberships struct for RootModelLinksMemberships
type RootModelLinksMemberships struct {
...
type _RootModelLinksMemberships RootModelLinksMemberships
...
func NewRootModelLinksMemberships(href string) *RootModelLinksMemberships {
	this := RootModelLinksMemberships{}
	this.Href = href
...
func (o *RootModelLinksMemberships) SetHref(v string) {
	o.Href = v
}
...
func (o *RootModelLinksMemberships) GetMethod() string {
...
func (o RootModelLinksMemberships) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksMemberships) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksMemberships) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksMemberships := _RootModelLinksMemberships{}

	err = json.Unmarshal(data, &varRootModelLinksMemberships)

	if err != nil {
		return err
	}

	*o = RootModelLinksMemberships(varRootModelLinksMemberships)
...
type NullableRootModelLinksMemberships struct {
	value *RootModelLinksMemberships
	isSet bool
}

func (v NullableRootModelLinksMemberships) Get() *RootModelLinksMemberships {
	return v.value
}

func (v *NullableRootModelLinksMemberships) Set(val *RootModelLinksMemberships) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksMemberships) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksMemberships) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksMemberships(val *RootModelLinksMemberships) *NullableRootModelLinksMemberships {
	return &NullableRootModelLinksMemberships{value: val, isSet: true}
}

func (v NullableRootModelLinksMemberships) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksMemberships) UnmarshalJSON(src []byte) error {
	v.isSet = true
