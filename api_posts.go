...
func (r ApiViewPostRequest) Execute() (*PostModel, *http.Response, error) {
	return r.ApiService.ViewPostExecute(r)
}
...
//  @return PostModel
func (a *PostsAPIService) ViewPostExecute(r ApiViewPostRequest) (*PostModel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PostsAPIService.ViewPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/posts/{id}"
