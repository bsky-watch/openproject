...
// checks if the WeekDayCollectionModelAllOfLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WeekDayCollectionModelAllOfLinksSelf{}

// WeekDayCollectionModelAllOfLinksSelf struct for WeekDayCollectionModelAllOfLinksSelf
type WeekDayCollectionModelAllOfLinksSelf struct {
...
type _WeekDayCollectionModelAllOfLinksSelf WeekDayCollectionModelAllOfLinksSelf
...
func NewWeekDayCollectionModelAllOfLinksSelf(href string) *WeekDayCollectionModelAllOfLinksSelf {
	this := WeekDayCollectionModelAllOfLinksSelf{}
	this.Href = href
...
func (o WeekDayCollectionModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o WeekDayCollectionModelAllOfLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *WeekDayCollectionModelAllOfLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varWeekDayCollectionModelAllOfLinksSelf := _WeekDayCollectionModelAllOfLinksSelf{}

	err = json.Unmarshal(data, &varWeekDayCollectionModelAllOfLinksSelf)

	if err != nil {
		return err
	}

	*o = WeekDayCollectionModelAllOfLinksSelf(varWeekDayCollectionModelAllOfLinksSelf)
...
type NullableWeekDayCollectionModelAllOfLinksSelf struct {
	value *WeekDayCollectionModelAllOfLinksSelf
	isSet bool
}

func (v NullableWeekDayCollectionModelAllOfLinksSelf) Get() *WeekDayCollectionModelAllOfLinksSelf {
	return v.value
}

func (v *NullableWeekDayCollectionModelAllOfLinksSelf) Set(val *WeekDayCollectionModelAllOfLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableWeekDayCollectionModelAllOfLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableWeekDayCollectionModelAllOfLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWeekDayCollectionModelAllOfLinksSelf(val *WeekDayCollectionModelAllOfLinksSelf) *NullableWeekDayCollectionModelAllOfLinksSelf {
	return &NullableWeekDayCollectionModelAllOfLinksSelf{value: val, isSet: true}
}

func (v NullableWeekDayCollectionModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWeekDayCollectionModelAllOfLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
