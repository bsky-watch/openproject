...
// checks if the RootModelLinksTimeEntries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksTimeEntries{}

// RootModelLinksTimeEntries struct for RootModelLinksTimeEntries
type RootModelLinksTimeEntries struct {
...
type _RootModelLinksTimeEntries RootModelLinksTimeEntries
...
func NewRootModelLinksTimeEntries(href string) *RootModelLinksTimeEntries {
	this := RootModelLinksTimeEntries{}
	this.Href = href
...
func (o RootModelLinksTimeEntries) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksTimeEntries) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksTimeEntries) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksTimeEntries := _RootModelLinksTimeEntries{}

	err = json.Unmarshal(data, &varRootModelLinksTimeEntries)

	if err != nil {
		return err
	}

	*o = RootModelLinksTimeEntries(varRootModelLinksTimeEntries)
...
type NullableRootModelLinksTimeEntries struct {
	value *RootModelLinksTimeEntries
	isSet bool
}

func (v NullableRootModelLinksTimeEntries) Get() *RootModelLinksTimeEntries {
	return v.value
}

func (v *NullableRootModelLinksTimeEntries) Set(val *RootModelLinksTimeEntries) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksTimeEntries) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksTimeEntries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksTimeEntries(val *RootModelLinksTimeEntries) *NullableRootModelLinksTimeEntries {
	return &NullableRootModelLinksTimeEntries{value: val, isSet: true}
}

func (v NullableRootModelLinksTimeEntries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksTimeEntries) UnmarshalJSON(src []byte) error {
	v.isSet = true
