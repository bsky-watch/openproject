...
// checks if the ProjectModelLinksTypes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksTypes{}

// ProjectModelLinksTypes struct for ProjectModelLinksTypes
type ProjectModelLinksTypes struct {
...
type _ProjectModelLinksTypes ProjectModelLinksTypes
...
func (o *ProjectModelLinksTypes) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectModelLinksTypes) GetMethod() string {
...
func (o ProjectModelLinksTypes) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksTypes) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksTypes) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksTypes := _ProjectModelLinksTypes{}

	err = json.Unmarshal(data, &varProjectModelLinksTypes)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksTypes(varProjectModelLinksTypes)
...
type NullableProjectModelLinksTypes struct {
	value *ProjectModelLinksTypes
	isSet bool
}

func (v NullableProjectModelLinksTypes) Get() *ProjectModelLinksTypes {
	return v.value
}

func (v *NullableProjectModelLinksTypes) Set(val *ProjectModelLinksTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksTypes(val *ProjectModelLinksTypes) *NullableProjectModelLinksTypes {
	return &NullableProjectModelLinksTypes{value: val, isSet: true}
}

func (v NullableProjectModelLinksTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
