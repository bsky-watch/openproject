...
// checks if the VersionsByProjectModelAllOfEmbeddedElements type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionsByProjectModelAllOfEmbeddedElements{}
...
type VersionsByProjectModelAllOfEmbeddedElements struct {
	...
	Links *VersionModelLinks `json:"_links,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VersionsByProjectModelAllOfEmbeddedElements VersionsByProjectModelAllOfEmbeddedElements
...
func NewVersionsByProjectModelAllOfEmbeddedElements(name string, status string, sharing string, createdAt time.Time, updatedAt time.Time) *VersionsByProjectModelAllOfEmbeddedElements {
	this := VersionsByProjectModelAllOfEmbeddedElements{}
	this.Name = name
	this.Status = status
...
// SetDescription gets a reference to the given ActivityModelComment and assigns it to the Description field.
...
// SetLinks gets a reference to the given VersionModelLinks and assigns it to the Links field.
func (o *VersionsByProjectModelAllOfEmbeddedElements) SetLinks(v VersionModelLinks) {
	o.Links = &v
}

func (o VersionsByProjectModelAllOfEmbeddedElements) MarshalJSON() ([]byte, error) {
...
func (o VersionsByProjectModelAllOfEmbeddedElements) ToMap() (map[string]interface{}, error) {
...
func (o *VersionsByProjectModelAllOfEmbeddedElements) UnmarshalJSON(data []byte) (err error) {
	...
	varVersionsByProjectModelAllOfEmbeddedElements := _VersionsByProjectModelAllOfEmbeddedElements{}

	err = json.Unmarshal(data, &varVersionsByProjectModelAllOfEmbeddedElements)

	if err != nil {
		return err
	}

	*o = VersionsByProjectModelAllOfEmbeddedElements(varVersionsByProjectModelAllOfEmbeddedElements)
...
type NullableVersionsByProjectModelAllOfEmbeddedElements struct {
	value *VersionsByProjectModelAllOfEmbeddedElements
	isSet bool
}

func (v NullableVersionsByProjectModelAllOfEmbeddedElements) Get() *VersionsByProjectModelAllOfEmbeddedElements {
	return v.value
}

func (v *NullableVersionsByProjectModelAllOfEmbeddedElements) Set(val *VersionsByProjectModelAllOfEmbeddedElements) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionsByProjectModelAllOfEmbeddedElements) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionsByProjectModelAllOfEmbeddedElements) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionsByProjectModelAllOfEmbeddedElements(val *VersionsByProjectModelAllOfEmbeddedElements) *NullableVersionsByProjectModelAllOfEmbeddedElements {
	return &NullableVersionsByProjectModelAllOfEmbeddedElements{value: val, isSet: true}
}

func (v NullableVersionsByProjectModelAllOfEmbeddedElements) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionsByProjectModelAllOfEmbeddedElements) UnmarshalJSON(src []byte) error {
	v.isSet = true
