...
// checks if the UserCollectionModelAllOfLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserCollectionModelAllOfLinksSelf{}

// UserCollectionModelAllOfLinksSelf struct for UserCollectionModelAllOfLinksSelf
type UserCollectionModelAllOfLinksSelf struct {
...
type _UserCollectionModelAllOfLinksSelf UserCollectionModelAllOfLinksSelf
...
func NewUserCollectionModelAllOfLinksSelf(href string) *UserCollectionModelAllOfLinksSelf {
	this := UserCollectionModelAllOfLinksSelf{}
	this.Href = href
...
func (o UserCollectionModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o UserCollectionModelAllOfLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *UserCollectionModelAllOfLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varUserCollectionModelAllOfLinksSelf := _UserCollectionModelAllOfLinksSelf{}

	err = json.Unmarshal(data, &varUserCollectionModelAllOfLinksSelf)

	if err != nil {
		return err
	}

	*o = UserCollectionModelAllOfLinksSelf(varUserCollectionModelAllOfLinksSelf)
...
type NullableUserCollectionModelAllOfLinksSelf struct {
	value *UserCollectionModelAllOfLinksSelf
	isSet bool
}

func (v NullableUserCollectionModelAllOfLinksSelf) Get() *UserCollectionModelAllOfLinksSelf {
	return v.value
}

func (v *NullableUserCollectionModelAllOfLinksSelf) Set(val *UserCollectionModelAllOfLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableUserCollectionModelAllOfLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableUserCollectionModelAllOfLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserCollectionModelAllOfLinksSelf(val *UserCollectionModelAllOfLinksSelf) *NullableUserCollectionModelAllOfLinksSelf {
	return &NullableUserCollectionModelAllOfLinksSelf{value: val, isSet: true}
}

func (v NullableUserCollectionModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserCollectionModelAllOfLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
