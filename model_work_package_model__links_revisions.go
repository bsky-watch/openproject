...
// checks if the WorkPackageModelLinksRevisions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksRevisions{}

// WorkPackageModelLinksRevisions struct for WorkPackageModelLinksRevisions
type WorkPackageModelLinksRevisions struct {
...
type _WorkPackageModelLinksRevisions WorkPackageModelLinksRevisions
...
func NewWorkPackageModelLinksRevisions(href string) *WorkPackageModelLinksRevisions {
	this := WorkPackageModelLinksRevisions{}
	this.Href = href
...
func (o *WorkPackageModelLinksRevisions) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksRevisions) GetMethod() string {
...
func (o WorkPackageModelLinksRevisions) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksRevisions) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksRevisions) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksRevisions := _WorkPackageModelLinksRevisions{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksRevisions)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksRevisions(varWorkPackageModelLinksRevisions)
...
type NullableWorkPackageModelLinksRevisions struct {
	value *WorkPackageModelLinksRevisions
	isSet bool
}

func (v NullableWorkPackageModelLinksRevisions) Get() *WorkPackageModelLinksRevisions {
	return v.value
}

func (v *NullableWorkPackageModelLinksRevisions) Set(val *WorkPackageModelLinksRevisions) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksRevisions) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksRevisions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksRevisions(val *WorkPackageModelLinksRevisions) *NullableWorkPackageModelLinksRevisions {
	return &NullableWorkPackageModelLinksRevisions{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksRevisions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksRevisions) UnmarshalJSON(src []byte) error {
	v.isSet = true
