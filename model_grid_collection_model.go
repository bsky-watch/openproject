...
// checks if the GridCollectionModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridCollectionModel{}

// GridCollectionModel struct for GridCollectionModel
...
type _GridCollectionModel GridCollectionModel
...
func (o *GridCollectionModel) GetEmbedded() GridCollectionModelAllOfEmbedded {
	if o == nil {
		var ret GridCollectionModelAllOfEmbedded
		return ret
	}
...
func (o GridCollectionModel) MarshalJSON() ([]byte, error) {
...
func (o GridCollectionModel) ToMap() (map[string]interface{}, error) {
...
func (o *GridCollectionModel) UnmarshalJSON(data []byte) (err error) {
	...
	varGridCollectionModel := _GridCollectionModel{}

	err = json.Unmarshal(data, &varGridCollectionModel)

	if err != nil {
		return err
	}

	*o = GridCollectionModel(varGridCollectionModel)
...
type NullableGridCollectionModel struct {
	value *GridCollectionModel
	isSet bool
}

func (v NullableGridCollectionModel) Get() *GridCollectionModel {
	return v.value
}

func (v *NullableGridCollectionModel) Set(val *GridCollectionModel) {
	v.value = val
	v.isSet = true
}

func (v NullableGridCollectionModel) IsSet() bool {
	return v.isSet
}

func (v *NullableGridCollectionModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridCollectionModel(val *GridCollectionModel) *NullableGridCollectionModel {
	return &NullableGridCollectionModel{value: val, isSet: true}
}

func (v NullableGridCollectionModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridCollectionModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
