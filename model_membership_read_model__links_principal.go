...
// checks if the MembershipReadModelLinksPrincipal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipReadModelLinksPrincipal{}

// MembershipReadModelLinksPrincipal struct for MembershipReadModelLinksPrincipal
type MembershipReadModelLinksPrincipal struct {
...
type _MembershipReadModelLinksPrincipal MembershipReadModelLinksPrincipal
...
func NewMembershipReadModelLinksPrincipal(href string) *MembershipReadModelLinksPrincipal {
	this := MembershipReadModelLinksPrincipal{}
	this.Href = href
...
func (o MembershipReadModelLinksPrincipal) MarshalJSON() ([]byte, error) {
...
func (o MembershipReadModelLinksPrincipal) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipReadModelLinksPrincipal) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipReadModelLinksPrincipal := _MembershipReadModelLinksPrincipal{}

	err = json.Unmarshal(data, &varMembershipReadModelLinksPrincipal)

	if err != nil {
		return err
	}

	*o = MembershipReadModelLinksPrincipal(varMembershipReadModelLinksPrincipal)
...
type NullableMembershipReadModelLinksPrincipal struct {
	value *MembershipReadModelLinksPrincipal
	isSet bool
}

func (v NullableMembershipReadModelLinksPrincipal) Get() *MembershipReadModelLinksPrincipal {
	return v.value
}

func (v *NullableMembershipReadModelLinksPrincipal) Set(val *MembershipReadModelLinksPrincipal) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipReadModelLinksPrincipal) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipReadModelLinksPrincipal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipReadModelLinksPrincipal(val *MembershipReadModelLinksPrincipal) *NullableMembershipReadModelLinksPrincipal {
	return &NullableMembershipReadModelLinksPrincipal{value: val, isSet: true}
}

func (v NullableMembershipReadModelLinksPrincipal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipReadModelLinksPrincipal) UnmarshalJSON(src []byte) error {
	v.isSet = true
