...
// checks if the RootModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksSelf{}

// RootModelLinksSelf struct for RootModelLinksSelf
type RootModelLinksSelf struct {
...
type _RootModelLinksSelf RootModelLinksSelf
...
func (o RootModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksSelf := _RootModelLinksSelf{}

	err = json.Unmarshal(data, &varRootModelLinksSelf)

	if err != nil {
		return err
	}

	*o = RootModelLinksSelf(varRootModelLinksSelf)
...
type NullableRootModelLinksSelf struct {
	value *RootModelLinksSelf
	isSet bool
}

func (v NullableRootModelLinksSelf) Get() *RootModelLinksSelf {
	return v.value
}

func (v *NullableRootModelLinksSelf) Set(val *RootModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksSelf(val *RootModelLinksSelf) *NullableRootModelLinksSelf {
	return &NullableRootModelLinksSelf{value: val, isSet: true}
}

func (v NullableRootModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
