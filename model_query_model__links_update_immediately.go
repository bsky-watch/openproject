...
// checks if the QueryModelLinksUpdateImmediately type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryModelLinksUpdateImmediately{}

// QueryModelLinksUpdateImmediately struct for QueryModelLinksUpdateImmediately
type QueryModelLinksUpdateImmediately struct {
...
type _QueryModelLinksUpdateImmediately QueryModelLinksUpdateImmediately
...
func NewQueryModelLinksUpdateImmediately(href string) *QueryModelLinksUpdateImmediately {
	this := QueryModelLinksUpdateImmediately{}
	this.Href = href
...
func (o *QueryModelLinksUpdateImmediately) SetHref(v string) {
	o.Href = v
}
...
func (o *QueryModelLinksUpdateImmediately) GetMethod() string {
...
func (o QueryModelLinksUpdateImmediately) MarshalJSON() ([]byte, error) {
...
func (o QueryModelLinksUpdateImmediately) ToMap() (map[string]interface{}, error) {
...
func (o *QueryModelLinksUpdateImmediately) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryModelLinksUpdateImmediately := _QueryModelLinksUpdateImmediately{}

	err = json.Unmarshal(data, &varQueryModelLinksUpdateImmediately)

	if err != nil {
		return err
	}

	*o = QueryModelLinksUpdateImmediately(varQueryModelLinksUpdateImmediately)
...
type NullableQueryModelLinksUpdateImmediately struct {
	value *QueryModelLinksUpdateImmediately
	isSet bool
}

func (v NullableQueryModelLinksUpdateImmediately) Get() *QueryModelLinksUpdateImmediately {
	return v.value
}

func (v *NullableQueryModelLinksUpdateImmediately) Set(val *QueryModelLinksUpdateImmediately) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryModelLinksUpdateImmediately) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryModelLinksUpdateImmediately) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryModelLinksUpdateImmediately(val *QueryModelLinksUpdateImmediately) *NullableQueryModelLinksUpdateImmediately {
	return &NullableQueryModelLinksUpdateImmediately{value: val, isSet: true}
}

func (v NullableQueryModelLinksUpdateImmediately) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryModelLinksUpdateImmediately) UnmarshalJSON(src []byte) error {
	v.isSet = true
