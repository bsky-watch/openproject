...
// CustomActionsAPIService CustomActionsAPI service
type CustomActionsAPIService service
...
func (r ApiExecuteCustomActionRequest) ExecuteCustomActionRequest(executeCustomActionRequest ExecuteCustomActionRequest) ApiExecuteCustomActionRequest {
	r.executeCustomActionRequest = &executeCustomActionRequest
	return r
}

func (r ApiExecuteCustomActionRequest) Execute() (*http.Response, error) {
	return r.ApiService.ExecuteCustomActionExecute(r)
}
...
func (a *CustomActionsAPIService) ExecuteCustomActionExecute(r ApiExecuteCustomActionRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomActionsAPIService.ExecuteCustomAction")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/custom_actions/{id}/execute"
	...
	// body params
	localVarPostBody = r.executeCustomActionRequest
...
func (r ApiGetCustomActionRequest) Execute() (*CustomActionModel, *http.Response, error) {
	return r.ApiService.GetCustomActionExecute(r)
}
...
func (a *CustomActionsAPIService) GetCustomActionExecute(r ApiGetCustomActionRequest) (*CustomActionModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CustomActionModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomActionsAPIService.GetCustomAction")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/custom_actions/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
