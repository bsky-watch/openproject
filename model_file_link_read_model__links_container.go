...
// checks if the FileLinkReadModelLinksContainer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileLinkReadModelLinksContainer{}

// FileLinkReadModelLinksContainer struct for FileLinkReadModelLinksContainer
type FileLinkReadModelLinksContainer struct {
...
type _FileLinkReadModelLinksContainer FileLinkReadModelLinksContainer
...
func NewFileLinkReadModelLinksContainer(href string) *FileLinkReadModelLinksContainer {
	this := FileLinkReadModelLinksContainer{}
	this.Href = href
...
func (o FileLinkReadModelLinksContainer) MarshalJSON() ([]byte, error) {
...
func (o FileLinkReadModelLinksContainer) ToMap() (map[string]interface{}, error) {
...
func (o *FileLinkReadModelLinksContainer) UnmarshalJSON(data []byte) (err error) {
	...
	varFileLinkReadModelLinksContainer := _FileLinkReadModelLinksContainer{}

	err = json.Unmarshal(data, &varFileLinkReadModelLinksContainer)

	if err != nil {
		return err
	}

	*o = FileLinkReadModelLinksContainer(varFileLinkReadModelLinksContainer)
...
type NullableFileLinkReadModelLinksContainer struct {
	value *FileLinkReadModelLinksContainer
	isSet bool
}

func (v NullableFileLinkReadModelLinksContainer) Get() *FileLinkReadModelLinksContainer {
	return v.value
}

func (v *NullableFileLinkReadModelLinksContainer) Set(val *FileLinkReadModelLinksContainer) {
	v.value = val
	v.isSet = true
}

func (v NullableFileLinkReadModelLinksContainer) IsSet() bool {
	return v.isSet
}

func (v *NullableFileLinkReadModelLinksContainer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileLinkReadModelLinksContainer(val *FileLinkReadModelLinksContainer) *NullableFileLinkReadModelLinksContainer {
	return &NullableFileLinkReadModelLinksContainer{value: val, isSet: true}
}

func (v NullableFileLinkReadModelLinksContainer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileLinkReadModelLinksContainer) UnmarshalJSON(src []byte) error {
	v.isSet = true
