...
// checks if the MembershipWriteModelMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipWriteModelMeta{}

// MembershipWriteModelMeta struct for MembershipWriteModelMeta
type MembershipWriteModelMeta struct {
	NotificationMessage *MembershipWriteModelMetaNotificationMessage `json:"notificationMessage,omitempty"`
	// Set to false, if no notification should get sent.
	SendNotification *bool `json:"sendNotification,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MembershipWriteModelMeta MembershipWriteModelMeta
...
func (o *MembershipWriteModelMeta) GetNotificationMessage() MembershipWriteModelMetaNotificationMessage {
	if o == nil || IsNil(o.NotificationMessage) {
		var ret MembershipWriteModelMetaNotificationMessage
		return ret
	}
...
// SetNotificationMessage gets a reference to the given MembershipWriteModelMetaNotificationMessage and assigns it to the NotificationMessage field.
...
func (o MembershipWriteModelMeta) MarshalJSON() ([]byte, error) {
...
func (o MembershipWriteModelMeta) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipWriteModelMeta) UnmarshalJSON(data []byte) (err error) {
	varMembershipWriteModelMeta := _MembershipWriteModelMeta{}

	err = json.Unmarshal(data, &varMembershipWriteModelMeta)

	if err != nil {
		return err
	}

	*o = MembershipWriteModelMeta(varMembershipWriteModelMeta)
...
type NullableMembershipWriteModelMeta struct {
	value *MembershipWriteModelMeta
	isSet bool
}

func (v NullableMembershipWriteModelMeta) Get() *MembershipWriteModelMeta {
	return v.value
}

func (v *NullableMembershipWriteModelMeta) Set(val *MembershipWriteModelMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipWriteModelMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipWriteModelMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipWriteModelMeta(val *MembershipWriteModelMeta) *NullableMembershipWriteModelMeta {
	return &NullableMembershipWriteModelMeta{value: val, isSet: true}
}

func (v NullableMembershipWriteModelMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipWriteModelMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
