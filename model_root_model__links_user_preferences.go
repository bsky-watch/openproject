...
// checks if the RootModelLinksUserPreferences type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksUserPreferences{}

// RootModelLinksUserPreferences struct for RootModelLinksUserPreferences
type RootModelLinksUserPreferences struct {
...
type _RootModelLinksUserPreferences RootModelLinksUserPreferences
...
func NewRootModelLinksUserPreferences(href string) *RootModelLinksUserPreferences {
	this := RootModelLinksUserPreferences{}
	this.Href = href
...
func (o RootModelLinksUserPreferences) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksUserPreferences) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksUserPreferences) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksUserPreferences := _RootModelLinksUserPreferences{}

	err = json.Unmarshal(data, &varRootModelLinksUserPreferences)

	if err != nil {
		return err
	}

	*o = RootModelLinksUserPreferences(varRootModelLinksUserPreferences)
...
type NullableRootModelLinksUserPreferences struct {
	value *RootModelLinksUserPreferences
	isSet bool
}

func (v NullableRootModelLinksUserPreferences) Get() *RootModelLinksUserPreferences {
	return v.value
}

func (v *NullableRootModelLinksUserPreferences) Set(val *RootModelLinksUserPreferences) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksUserPreferences) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksUserPreferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksUserPreferences(val *RootModelLinksUserPreferences) *NullableRootModelLinksUserPreferences {
	return &NullableRootModelLinksUserPreferences{value: val, isSet: true}
}

func (v NullableRootModelLinksUserPreferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksUserPreferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
