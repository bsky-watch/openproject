...
// checks if the OAuthApplicationReadModelLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OAuthApplicationReadModelLinks{}

// OAuthApplicationReadModelLinks struct for OAuthApplicationReadModelLinks
type OAuthApplicationReadModelLinks struct {
...
type _OAuthApplicationReadModelLinks OAuthApplicationReadModelLinks
...
func (o *OAuthApplicationReadModelLinks) GetSelf() OAuthApplicationReadModelLinksSelf {
	if o == nil {
		var ret OAuthApplicationReadModelLinksSelf
		return ret
	}
...
func (o *OAuthApplicationReadModelLinks) GetOwner() OAuthApplicationReadModelLinksOwner {
	if o == nil {
		var ret OAuthApplicationReadModelLinksOwner
		return ret
	}
...
func (o *OAuthApplicationReadModelLinks) GetIntegration() OAuthApplicationReadModelLinksIntegration {
	if o == nil || IsNil(o.Integration) {
		var ret OAuthApplicationReadModelLinksIntegration
		return ret
	}
...
// SetIntegration gets a reference to the given OAuthApplicationReadModelLinksIntegration and assigns it to the Integration field.
...
func (o OAuthApplicationReadModelLinks) MarshalJSON() ([]byte, error) {
...
func (o OAuthApplicationReadModelLinks) ToMap() (map[string]interface{}, error) {
...
func (o *OAuthApplicationReadModelLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varOAuthApplicationReadModelLinks := _OAuthApplicationReadModelLinks{}

	err = json.Unmarshal(data, &varOAuthApplicationReadModelLinks)

	if err != nil {
		return err
	}

	*o = OAuthApplicationReadModelLinks(varOAuthApplicationReadModelLinks)
...
type NullableOAuthApplicationReadModelLinks struct {
	value *OAuthApplicationReadModelLinks
	isSet bool
}

func (v NullableOAuthApplicationReadModelLinks) Get() *OAuthApplicationReadModelLinks {
	return v.value
}

func (v *NullableOAuthApplicationReadModelLinks) Set(val *OAuthApplicationReadModelLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableOAuthApplicationReadModelLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableOAuthApplicationReadModelLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOAuthApplicationReadModelLinks(val *OAuthApplicationReadModelLinks) *NullableOAuthApplicationReadModelLinks {
	return &NullableOAuthApplicationReadModelLinks{value: val, isSet: true}
}

func (v NullableOAuthApplicationReadModelLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOAuthApplicationReadModelLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
