...
// checks if the WorkPackageModelLinksAddRelation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksAddRelation{}

// WorkPackageModelLinksAddRelation struct for WorkPackageModelLinksAddRelation
type WorkPackageModelLinksAddRelation struct {
...
type _WorkPackageModelLinksAddRelation WorkPackageModelLinksAddRelation
...
func NewWorkPackageModelLinksAddRelation(href string) *WorkPackageModelLinksAddRelation {
	this := WorkPackageModelLinksAddRelation{}
	this.Href = href
...
func (o WorkPackageModelLinksAddRelation) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksAddRelation) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksAddRelation) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksAddRelation := _WorkPackageModelLinksAddRelation{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksAddRelation)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksAddRelation(varWorkPackageModelLinksAddRelation)
...
type NullableWorkPackageModelLinksAddRelation struct {
	value *WorkPackageModelLinksAddRelation
	isSet bool
}

func (v NullableWorkPackageModelLinksAddRelation) Get() *WorkPackageModelLinksAddRelation {
	return v.value
}

func (v *NullableWorkPackageModelLinksAddRelation) Set(val *WorkPackageModelLinksAddRelation) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksAddRelation) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksAddRelation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksAddRelation(val *WorkPackageModelLinksAddRelation) *NullableWorkPackageModelLinksAddRelation {
	return &NullableWorkPackageModelLinksAddRelation{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksAddRelation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksAddRelation) UnmarshalJSON(src []byte) error {
	v.isSet = true
