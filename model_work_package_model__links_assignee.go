...
// checks if the WorkPackageModelLinksAssignee type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksAssignee{}

// WorkPackageModelLinksAssignee struct for WorkPackageModelLinksAssignee
type WorkPackageModelLinksAssignee struct {
...
type _WorkPackageModelLinksAssignee WorkPackageModelLinksAssignee
...
func NewWorkPackageModelLinksAssignee(href string) *WorkPackageModelLinksAssignee {
	this := WorkPackageModelLinksAssignee{}
	this.Href = href
...
func (o *WorkPackageModelLinksAssignee) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksAssignee) GetMethod() string {
...
func (o WorkPackageModelLinksAssignee) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksAssignee) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksAssignee) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksAssignee := _WorkPackageModelLinksAssignee{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksAssignee)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksAssignee(varWorkPackageModelLinksAssignee)
...
type NullableWorkPackageModelLinksAssignee struct {
	value *WorkPackageModelLinksAssignee
	isSet bool
}

func (v NullableWorkPackageModelLinksAssignee) Get() *WorkPackageModelLinksAssignee {
	return v.value
}

func (v *NullableWorkPackageModelLinksAssignee) Set(val *WorkPackageModelLinksAssignee) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksAssignee) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksAssignee) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksAssignee(val *WorkPackageModelLinksAssignee) *NullableWorkPackageModelLinksAssignee {
	return &NullableWorkPackageModelLinksAssignee{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksAssignee) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksAssignee) UnmarshalJSON(src []byte) error {
	v.isSet = true
