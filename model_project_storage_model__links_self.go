...
// checks if the ProjectStorageModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectStorageModelLinksSelf{}

// ProjectStorageModelLinksSelf struct for ProjectStorageModelLinksSelf
type ProjectStorageModelLinksSelf struct {
...
type _ProjectStorageModelLinksSelf ProjectStorageModelLinksSelf
...
func NewProjectStorageModelLinksSelf(href string) *ProjectStorageModelLinksSelf {
	this := ProjectStorageModelLinksSelf{}
	this.Href = href
...
func (o *ProjectStorageModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectStorageModelLinksSelf) GetMethod() string {
...
func (o ProjectStorageModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o ProjectStorageModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectStorageModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectStorageModelLinksSelf := _ProjectStorageModelLinksSelf{}

	err = json.Unmarshal(data, &varProjectStorageModelLinksSelf)

	if err != nil {
		return err
	}

	*o = ProjectStorageModelLinksSelf(varProjectStorageModelLinksSelf)
...
type NullableProjectStorageModelLinksSelf struct {
	value *ProjectStorageModelLinksSelf
	isSet bool
}

func (v NullableProjectStorageModelLinksSelf) Get() *ProjectStorageModelLinksSelf {
	return v.value
}

func (v *NullableProjectStorageModelLinksSelf) Set(val *ProjectStorageModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectStorageModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectStorageModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectStorageModelLinksSelf(val *ProjectStorageModelLinksSelf) *NullableProjectStorageModelLinksSelf {
	return &NullableProjectStorageModelLinksSelf{value: val, isSet: true}
}

func (v NullableProjectStorageModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectStorageModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
