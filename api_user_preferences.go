...
type ApiShowMyPreferencesRequest struct {
	ctx context.Context
...
ShowMyPreferences Show my preferences
 ...
 @return ApiShowMyPreferencesRequest
*/
func (a *UserPreferencesAPIService) ShowMyPreferences(ctx context.Context) ApiShowMyPreferencesRequest {
	return ApiShowMyPreferencesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UserPreferencesAPIService) ShowMyPreferencesExecute(r ApiShowMyPreferencesRequest) (*UserPreferencesModel, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/my_preferences"
