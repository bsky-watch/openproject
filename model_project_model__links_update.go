...
// checks if the ProjectModelLinksUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksUpdate{}

// ProjectModelLinksUpdate struct for ProjectModelLinksUpdate
type ProjectModelLinksUpdate struct {
...
type _ProjectModelLinksUpdate ProjectModelLinksUpdate
...
func (o ProjectModelLinksUpdate) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksUpdate := _ProjectModelLinksUpdate{}

	err = json.Unmarshal(data, &varProjectModelLinksUpdate)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksUpdate(varProjectModelLinksUpdate)
...
type NullableProjectModelLinksUpdate struct {
	value *ProjectModelLinksUpdate
	isSet bool
}

func (v NullableProjectModelLinksUpdate) Get() *ProjectModelLinksUpdate {
	return v.value
}

func (v *NullableProjectModelLinksUpdate) Set(val *ProjectModelLinksUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksUpdate(val *ProjectModelLinksUpdate) *NullableProjectModelLinksUpdate {
	return &NullableProjectModelLinksUpdate{value: val, isSet: true}
}

func (v NullableProjectModelLinksUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
