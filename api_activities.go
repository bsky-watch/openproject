...
func (r ApiUpdateActivityRequest) Execute() (*ActivityModel, *http.Response, error) {
...
func (a *ActivitiesAPIService) UpdateActivityExecute(r ApiUpdateActivityRequest) (*ActivityModel, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v3/activities/{id}"
...
func (r ApiViewActivityRequest) Execute() (*ActivityModel, *http.Response, error) {
	return r.ApiService.ViewActivityExecute(r)
}
...
// Execute executes the request
//  @return ActivityModel
func (a *ActivitiesAPIService) ViewActivityExecute(r ApiViewActivityRequest) (*ActivityModel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActivitiesAPIService.ViewActivity")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
