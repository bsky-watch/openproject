...
// checks if the HelpTextModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HelpTextModel{}

// HelpTextModel struct for HelpTextModel
type HelpTextModel struct {
	Type string `json:"_type"`
	Id int64 `json:"id"`
	// The attribute the help text is assigned to.
	Attribute string `json:"attribute"`
	Scope string `json:"scope"`
	HelpText Formattable `json:"helpText"`
	Links HelpTextModelLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _HelpTextModel HelpTextModel
...
func (o HelpTextModel) MarshalJSON() ([]byte, error) {
...
func (o HelpTextModel) ToMap() (map[string]interface{}, error) {
...
func (o *HelpTextModel) UnmarshalJSON(data []byte) (err error) {
	...
	varHelpTextModel := _HelpTextModel{}

	err = json.Unmarshal(data, &varHelpTextModel)

	if err != nil {
		return err
	}

	*o = HelpTextModel(varHelpTextModel)
...
type NullableHelpTextModel struct {
	value *HelpTextModel
	isSet bool
}

func (v NullableHelpTextModel) Get() *HelpTextModel {
	return v.value
}

func (v *NullableHelpTextModel) Set(val *HelpTextModel) {
	v.value = val
	v.isSet = true
}

func (v NullableHelpTextModel) IsSet() bool {
	return v.isSet
}

func (v *NullableHelpTextModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHelpTextModel(val *HelpTextModel) *NullableHelpTextModel {
	return &NullableHelpTextModel{value: val, isSet: true}
}

func (v NullableHelpTextModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHelpTextModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
