...
// checks if the SchemaModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchemaModelLinksSelf{}

// SchemaModelLinksSelf struct for SchemaModelLinksSelf
type SchemaModelLinksSelf struct {
...
type _SchemaModelLinksSelf SchemaModelLinksSelf
...
func (o *SchemaModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *SchemaModelLinksSelf) GetMethod() string {
...
func (o SchemaModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o SchemaModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *SchemaModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varSchemaModelLinksSelf := _SchemaModelLinksSelf{}

	err = json.Unmarshal(data, &varSchemaModelLinksSelf)

	if err != nil {
		return err
	}

	*o = SchemaModelLinksSelf(varSchemaModelLinksSelf)
...
type NullableSchemaModelLinksSelf struct {
	value *SchemaModelLinksSelf
	isSet bool
}

func (v NullableSchemaModelLinksSelf) Get() *SchemaModelLinksSelf {
	return v.value
}

func (v *NullableSchemaModelLinksSelf) Set(val *SchemaModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableSchemaModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableSchemaModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchemaModelLinksSelf(val *SchemaModelLinksSelf) *NullableSchemaModelLinksSelf {
	return &NullableSchemaModelLinksSelf{value: val, isSet: true}
}

func (v NullableSchemaModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchemaModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
