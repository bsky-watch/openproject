...
func (r ApiViewMeetingRequest) Execute() (*MeetingModel, *http.Response, error) {
	return r.ApiService.ViewMeetingExecute(r)
}

/*
ViewMeeting View Meeting Page
...
//  @return MeetingModel
func (a *MeetingsAPIService) ViewMeetingExecute(r ApiViewMeetingRequest) (*MeetingModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MeetingModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MeetingsAPIService.ViewMeeting")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/meetings/{id}"
