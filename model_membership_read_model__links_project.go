...
// checks if the MembershipReadModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipReadModelLinksProject{}

// MembershipReadModelLinksProject struct for MembershipReadModelLinksProject
type MembershipReadModelLinksProject struct {
...
type _MembershipReadModelLinksProject MembershipReadModelLinksProject
...
func NewMembershipReadModelLinksProject(href string) *MembershipReadModelLinksProject {
	this := MembershipReadModelLinksProject{}
	this.Href = href
...
func (o MembershipReadModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o MembershipReadModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipReadModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipReadModelLinksProject := _MembershipReadModelLinksProject{}

	err = json.Unmarshal(data, &varMembershipReadModelLinksProject)

	if err != nil {
		return err
	}

	*o = MembershipReadModelLinksProject(varMembershipReadModelLinksProject)
...
type NullableMembershipReadModelLinksProject struct {
	value *MembershipReadModelLinksProject
	isSet bool
}

func (v NullableMembershipReadModelLinksProject) Get() *MembershipReadModelLinksProject {
	return v.value
}

func (v *NullableMembershipReadModelLinksProject) Set(val *MembershipReadModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipReadModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipReadModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipReadModelLinksProject(val *MembershipReadModelLinksProject) *NullableMembershipReadModelLinksProject {
	return &NullableMembershipReadModelLinksProject{value: val, isSet: true}
}

func (v NullableMembershipReadModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipReadModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
