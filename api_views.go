...
func (r ApiCreateViewsRequest) CreateViewsRequest(createViewsRequest CreateViewsRequest) ApiCreateViewsRequest {
	r.createViewsRequest = &createViewsRequest
	return r
}

func (r ApiCreateViewsRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *ViewsAPIService) CreateViews(ctx context.Context, id string) ApiCreateViewsRequest {
	return ApiCreateViewsRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *ViewsAPIService) CreateViewsExecute(r ApiCreateViewsRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v3/views/{id}"
	...
	// body params
	localVarPostBody = r.createViewsRequest
...
func (r ApiListViewsRequest) Filters(filters string) ApiListViewsRequest {
	r.filters = &filters
	return r
}

func (r ApiListViewsRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *ViewsAPIService) ListViewsExecute(r ApiListViewsRequest) (*http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v3/views"
...
func (r ApiViewViewRequest) Execute() (*http.Response, error) {
	return r.ApiService.ViewViewExecute(r)
}
...
// Execute executes the request
func (a *ViewsAPIService) ViewViewExecute(r ApiViewViewRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ViewsAPIService.ViewView")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
