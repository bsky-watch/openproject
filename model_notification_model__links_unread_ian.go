...
// checks if the NotificationModelLinksUnreadIAN type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationModelLinksUnreadIAN{}

// NotificationModelLinksUnreadIAN struct for NotificationModelLinksUnreadIAN
type NotificationModelLinksUnreadIAN struct {
...
type _NotificationModelLinksUnreadIAN NotificationModelLinksUnreadIAN
...
func NewNotificationModelLinksUnreadIAN(href string) *NotificationModelLinksUnreadIAN {
	this := NotificationModelLinksUnreadIAN{}
	this.Href = href
...
func (o NotificationModelLinksUnreadIAN) MarshalJSON() ([]byte, error) {
...
func (o NotificationModelLinksUnreadIAN) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationModelLinksUnreadIAN) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationModelLinksUnreadIAN := _NotificationModelLinksUnreadIAN{}

	err = json.Unmarshal(data, &varNotificationModelLinksUnreadIAN)

	if err != nil {
		return err
	}

	*o = NotificationModelLinksUnreadIAN(varNotificationModelLinksUnreadIAN)
...
type NullableNotificationModelLinksUnreadIAN struct {
	value *NotificationModelLinksUnreadIAN
	isSet bool
}

func (v NullableNotificationModelLinksUnreadIAN) Get() *NotificationModelLinksUnreadIAN {
	return v.value
}

func (v *NullableNotificationModelLinksUnreadIAN) Set(val *NotificationModelLinksUnreadIAN) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationModelLinksUnreadIAN) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationModelLinksUnreadIAN) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationModelLinksUnreadIAN(val *NotificationModelLinksUnreadIAN) *NullableNotificationModelLinksUnreadIAN {
	return &NullableNotificationModelLinksUnreadIAN{value: val, isSet: true}
}

func (v NullableNotificationModelLinksUnreadIAN) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationModelLinksUnreadIAN) UnmarshalJSON(src []byte) error {
	v.isSet = true
