...
func (r ApiViewBudgetRequest) Execute() (*BudgetModel, *http.Response, error) {
	return r.ApiService.ViewBudgetExecute(r)
}
...
//  @return BudgetModel
func (a *BudgetsAPIService) ViewBudgetExecute(r ApiViewBudgetRequest) (*BudgetModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BudgetModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BudgetsAPIService.ViewBudget")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/budgets/{id}"
...
func (r ApiViewBudgetsOfAProjectRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ViewBudgetsOfAProjectExecute(r)
}
...
func (a *BudgetsAPIService) ViewBudgetsOfAProjectExecute(r ApiViewBudgetsOfAProjectRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BudgetsAPIService.ViewBudgetsOfAProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/projects/{id}/budgets"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
