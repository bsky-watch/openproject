...
// checks if the TypesByProjectModelAllOfLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TypesByProjectModelAllOfLinksSelf{}

// TypesByProjectModelAllOfLinksSelf struct for TypesByProjectModelAllOfLinksSelf
type TypesByProjectModelAllOfLinksSelf struct {
...
type _TypesByProjectModelAllOfLinksSelf TypesByProjectModelAllOfLinksSelf
...
func NewTypesByProjectModelAllOfLinksSelf(href string) *TypesByProjectModelAllOfLinksSelf {
	this := TypesByProjectModelAllOfLinksSelf{}
	this.Href = href
...
func (o TypesByProjectModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o TypesByProjectModelAllOfLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *TypesByProjectModelAllOfLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varTypesByProjectModelAllOfLinksSelf := _TypesByProjectModelAllOfLinksSelf{}

	err = json.Unmarshal(data, &varTypesByProjectModelAllOfLinksSelf)

	if err != nil {
		return err
	}

	*o = TypesByProjectModelAllOfLinksSelf(varTypesByProjectModelAllOfLinksSelf)
...
type NullableTypesByProjectModelAllOfLinksSelf struct {
	value *TypesByProjectModelAllOfLinksSelf
	isSet bool
}

func (v NullableTypesByProjectModelAllOfLinksSelf) Get() *TypesByProjectModelAllOfLinksSelf {
	return v.value
}

func (v *NullableTypesByProjectModelAllOfLinksSelf) Set(val *TypesByProjectModelAllOfLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableTypesByProjectModelAllOfLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableTypesByProjectModelAllOfLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTypesByProjectModelAllOfLinksSelf(val *TypesByProjectModelAllOfLinksSelf) *NullableTypesByProjectModelAllOfLinksSelf {
	return &NullableTypesByProjectModelAllOfLinksSelf{value: val, isSet: true}
}

func (v NullableTypesByProjectModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTypesByProjectModelAllOfLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
