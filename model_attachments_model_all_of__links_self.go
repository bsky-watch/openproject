...
// checks if the AttachmentsModelAllOfLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttachmentsModelAllOfLinksSelf{}

// AttachmentsModelAllOfLinksSelf struct for AttachmentsModelAllOfLinksSelf
type AttachmentsModelAllOfLinksSelf struct {
...
type _AttachmentsModelAllOfLinksSelf AttachmentsModelAllOfLinksSelf
...
func NewAttachmentsModelAllOfLinksSelf(href string) *AttachmentsModelAllOfLinksSelf {
	this := AttachmentsModelAllOfLinksSelf{}
	this.Href = href
...
func (o AttachmentsModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o AttachmentsModelAllOfLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *AttachmentsModelAllOfLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varAttachmentsModelAllOfLinksSelf := _AttachmentsModelAllOfLinksSelf{}

	err = json.Unmarshal(data, &varAttachmentsModelAllOfLinksSelf)

	if err != nil {
		return err
	}

	*o = AttachmentsModelAllOfLinksSelf(varAttachmentsModelAllOfLinksSelf)
...
type NullableAttachmentsModelAllOfLinksSelf struct {
	value *AttachmentsModelAllOfLinksSelf
	isSet bool
}

func (v NullableAttachmentsModelAllOfLinksSelf) Get() *AttachmentsModelAllOfLinksSelf {
	return v.value
}

func (v *NullableAttachmentsModelAllOfLinksSelf) Set(val *AttachmentsModelAllOfLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableAttachmentsModelAllOfLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableAttachmentsModelAllOfLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttachmentsModelAllOfLinksSelf(val *AttachmentsModelAllOfLinksSelf) *NullableAttachmentsModelAllOfLinksSelf {
	return &NullableAttachmentsModelAllOfLinksSelf{value: val, isSet: true}
}

func (v NullableAttachmentsModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttachmentsModelAllOfLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
