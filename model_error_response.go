...
type ErrorResponse struct {
	Embedded *ErrorResponseEmbedded `json:"_embedded,omitempty"`
...
// SetEmbedded gets a reference to the given ErrorResponseEmbedded and assigns it to the Embedded field.
...
// GetErrorIdentifier returns the ErrorIdentifier field value
func (o *ErrorResponse) GetErrorIdentifier() string {
	...
	return o.ErrorIdentifier
}

// GetErrorIdentifierOk returns a tuple with the ErrorIdentifier field value
// and a boolean to check if the value has been set.
func (o *ErrorResponse) GetErrorIdentifierOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ErrorIdentifier, true
}

// SetErrorIdentifier sets field value
...
func (o ErrorResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["errorIdentifier"] = o.ErrorIdentifier
...
func (o *ErrorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ErrorResponse(varErrorResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "errorIdentifier")
