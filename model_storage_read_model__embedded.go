...
var _ MappedNullable = &StorageReadModelEmbedded{}
...
type _StorageReadModelEmbedded StorageReadModelEmbedded
...
func (o *StorageReadModelEmbedded) UnmarshalJSON(data []byte) (err error) {
	...
	*o = StorageReadModelEmbedded(varStorageReadModelEmbedded)
...
type NullableStorageReadModelEmbedded struct {
	value *StorageReadModelEmbedded
	isSet bool
}

func (v NullableStorageReadModelEmbedded) Get() *StorageReadModelEmbedded {
	return v.value
}

func (v *NullableStorageReadModelEmbedded) Set(val *StorageReadModelEmbedded) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageReadModelEmbedded) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageReadModelEmbedded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageReadModelEmbedded(val *StorageReadModelEmbedded) *NullableStorageReadModelEmbedded {
	return &NullableStorageReadModelEmbedded{value: val, isSet: true}
}

func (v NullableStorageReadModelEmbedded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageReadModelEmbedded) UnmarshalJSON(src []byte) error {
	v.isSet = true
