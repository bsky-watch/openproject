...
type GroupModel struct {
	...
	Links GroupModelAllOfLinks `json:"_links"`
	Embedded GroupModelAllOfEmbedded `json:"_embedded"`
...
func NewGroupModel(type_ string, id int, name string, links GroupModelAllOfLinks, embedded GroupModelAllOfEmbedded) *GroupModel {
	this := GroupModel{}
	this.Type = type_
	this.Id = id
	this.Name = name
...
// and a boolean to check if the value has been set.
func (o *GroupModel) GetIdOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *GroupModel) GetEmbedded() GroupModelAllOfEmbedded {
	if o == nil {
		var ret GroupModelAllOfEmbedded
		return ret
	}
