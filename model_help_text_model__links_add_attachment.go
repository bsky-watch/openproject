...
// checks if the HelpTextModelLinksAddAttachment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HelpTextModelLinksAddAttachment{}

// HelpTextModelLinksAddAttachment struct for HelpTextModelLinksAddAttachment
type HelpTextModelLinksAddAttachment struct {
...
type _HelpTextModelLinksAddAttachment HelpTextModelLinksAddAttachment
...
func NewHelpTextModelLinksAddAttachment(href string) *HelpTextModelLinksAddAttachment {
	this := HelpTextModelLinksAddAttachment{}
	this.Href = href
...
func (o HelpTextModelLinksAddAttachment) MarshalJSON() ([]byte, error) {
...
func (o HelpTextModelLinksAddAttachment) ToMap() (map[string]interface{}, error) {
...
func (o *HelpTextModelLinksAddAttachment) UnmarshalJSON(data []byte) (err error) {
	...
	varHelpTextModelLinksAddAttachment := _HelpTextModelLinksAddAttachment{}

	err = json.Unmarshal(data, &varHelpTextModelLinksAddAttachment)

	if err != nil {
		return err
	}

	*o = HelpTextModelLinksAddAttachment(varHelpTextModelLinksAddAttachment)
...
type NullableHelpTextModelLinksAddAttachment struct {
	value *HelpTextModelLinksAddAttachment
	isSet bool
}

func (v NullableHelpTextModelLinksAddAttachment) Get() *HelpTextModelLinksAddAttachment {
	return v.value
}

func (v *NullableHelpTextModelLinksAddAttachment) Set(val *HelpTextModelLinksAddAttachment) {
	v.value = val
	v.isSet = true
}

func (v NullableHelpTextModelLinksAddAttachment) IsSet() bool {
	return v.isSet
}

func (v *NullableHelpTextModelLinksAddAttachment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHelpTextModelLinksAddAttachment(val *HelpTextModelLinksAddAttachment) *NullableHelpTextModelLinksAddAttachment {
	return &NullableHelpTextModelLinksAddAttachment{value: val, isSet: true}
}

func (v NullableHelpTextModelLinksAddAttachment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHelpTextModelLinksAddAttachment) UnmarshalJSON(src []byte) error {
	v.isSet = true
