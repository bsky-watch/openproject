...
func (r ApiCreateGroupRequest) GroupWriteModel(groupWriteModel GroupWriteModel) ApiCreateGroupRequest {
	r.groupWriteModel = &groupWriteModel
	return r
}

func (r ApiCreateGroupRequest) Execute() (*GroupModel, *http.Response, error) {
...
//  @return GroupModel
func (a *GroupsAPIService) CreateGroupExecute(r ApiCreateGroupRequest) (*GroupModel, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.groupWriteModel
...
func (a *GroupsAPIService) DeleteGroupExecute(r ApiDeleteGroupRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/groups/{id}"
...
func (r ApiListGroupsRequest) Execute() (*GroupCollectionModel, *http.Response, error) {
...
func (a *GroupsAPIService) ListGroupsExecute(r ApiListGroupsRequest) (*GroupCollectionModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GroupCollectionModel
	)
...
func (r ApiUpdateGroupRequest) GroupWriteModel(groupWriteModel GroupWriteModel) ApiUpdateGroupRequest {
	r.groupWriteModel = &groupWriteModel
	return r
}

func (r ApiUpdateGroupRequest) Execute() (*GroupModel, *http.Response, error) {
...
// Execute executes the request
//  @return GroupModel
func (a *GroupsAPIService) UpdateGroupExecute(r ApiUpdateGroupRequest) (*GroupModel, *http.Response, error) {
	var (
