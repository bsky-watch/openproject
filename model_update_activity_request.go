...
type UpdateActivityRequest struct {
	...
	Links *UpdateActivityRequestLinks `json:"_links,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UpdateActivityRequest UpdateActivityRequest
...
func (o *UpdateActivityRequest) GetLinks() UpdateActivityRequestLinks {
	if o == nil || IsNil(o.Links) {
		var ret UpdateActivityRequestLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given UpdateActivityRequestLinks and assigns it to the Links field.
...
func (o *UpdateActivityRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdateActivityRequest := _UpdateActivityRequest{}

	err = json.Unmarshal(data, &varUpdateActivityRequest)

	if err != nil {
		return err
	}

	*o = UpdateActivityRequest(varUpdateActivityRequest)
