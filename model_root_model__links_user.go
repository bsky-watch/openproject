...
// checks if the RootModelLinksUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksUser{}

// RootModelLinksUser struct for RootModelLinksUser
type RootModelLinksUser struct {
...
type _RootModelLinksUser RootModelLinksUser
...
func (o RootModelLinksUser) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksUser) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksUser) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksUser := _RootModelLinksUser{}

	err = json.Unmarshal(data, &varRootModelLinksUser)

	if err != nil {
		return err
	}

	*o = RootModelLinksUser(varRootModelLinksUser)
...
type NullableRootModelLinksUser struct {
	value *RootModelLinksUser
	isSet bool
}

func (v NullableRootModelLinksUser) Get() *RootModelLinksUser {
	return v.value
}

func (v *NullableRootModelLinksUser) Set(val *RootModelLinksUser) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksUser) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksUser(val *RootModelLinksUser) *NullableRootModelLinksUser {
	return &NullableRootModelLinksUser{value: val, isSet: true}
}

func (v NullableRootModelLinksUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
