...
// checks if the ProjectModelLinksParent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksParent{}

// ProjectModelLinksParent struct for ProjectModelLinksParent
type ProjectModelLinksParent struct {
...
type _ProjectModelLinksParent ProjectModelLinksParent
...
func (o *ProjectModelLinksParent) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectModelLinksParent) GetMethod() string {
...
func (o ProjectModelLinksParent) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksParent) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksParent) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksParent := _ProjectModelLinksParent{}

	err = json.Unmarshal(data, &varProjectModelLinksParent)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksParent(varProjectModelLinksParent)
...
type NullableProjectModelLinksParent struct {
	value *ProjectModelLinksParent
	isSet bool
}

func (v NullableProjectModelLinksParent) Get() *ProjectModelLinksParent {
	return v.value
}

func (v *NullableProjectModelLinksParent) Set(val *ProjectModelLinksParent) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksParent) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksParent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksParent(val *ProjectModelLinksParent) *NullableProjectModelLinksParent {
	return &NullableProjectModelLinksParent{value: val, isSet: true}
}

func (v NullableProjectModelLinksParent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksParent) UnmarshalJSON(src []byte) error {
	v.isSet = true
