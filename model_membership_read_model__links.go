...
// checks if the MembershipReadModelLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipReadModelLinks{}

// MembershipReadModelLinks struct for MembershipReadModelLinks
type MembershipReadModelLinks struct {
	Self MembershipReadModelLinksSelf `json:"self"`
	Schema MembershipReadModelLinksSchema `json:"schema"`
	Update *MembershipReadModelLinksUpdate `json:"update,omitempty"`
	UpdateImmediately *MembershipReadModelLinksUpdateImmediately `json:"updateImmediately,omitempty"`
	Project MembershipReadModelLinksProject `json:"project"`
	Principal MembershipReadModelLinksPrincipal `json:"principal"`
	Roles []MembershipReadModelLinksRolesInner `json:"roles"`
	AdditionalProperties map[string]interface{}
}

type _MembershipReadModelLinks MembershipReadModelLinks
...
func (o *MembershipReadModelLinks) GetSelf() MembershipReadModelLinksSelf {
	if o == nil {
		var ret MembershipReadModelLinksSelf
		return ret
	}
...
func (o *MembershipReadModelLinks) GetSchema() MembershipReadModelLinksSchema {
	if o == nil {
		var ret MembershipReadModelLinksSchema
		return ret
	}
...
func (o *MembershipReadModelLinks) GetUpdate() MembershipReadModelLinksUpdate {
	if o == nil || IsNil(o.Update) {
		var ret MembershipReadModelLinksUpdate
		return ret
	}
	return *o.Update
}
...
// SetUpdate gets a reference to the given MembershipReadModelLinksUpdate and assigns it to the Update field.
...
func (o *MembershipReadModelLinks) GetUpdateImmediately() MembershipReadModelLinksUpdateImmediately {
	if o == nil || IsNil(o.UpdateImmediately) {
		var ret MembershipReadModelLinksUpdateImmediately
		return ret
	}
...
// SetUpdateImmediately gets a reference to the given MembershipReadModelLinksUpdateImmediately and assigns it to the UpdateImmediately field.
...
func (o *MembershipReadModelLinks) GetProject() MembershipReadModelLinksProject {
	if o == nil {
		var ret MembershipReadModelLinksProject
		return ret
	}
...
func (o *MembershipReadModelLinks) GetPrincipal() MembershipReadModelLinksPrincipal {
	if o == nil {
		var ret MembershipReadModelLinksPrincipal
		return ret
	}
...
func (o *MembershipReadModelLinks) GetRoles() []MembershipReadModelLinksRolesInner {
	if o == nil {
		var ret []MembershipReadModelLinksRolesInner
		return ret
	}
...
func (o MembershipReadModelLinks) MarshalJSON() ([]byte, error) {
...
func (o MembershipReadModelLinks) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipReadModelLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipReadModelLinks := _MembershipReadModelLinks{}

	err = json.Unmarshal(data, &varMembershipReadModelLinks)

	if err != nil {
		return err
	}

	*o = MembershipReadModelLinks(varMembershipReadModelLinks)
...
type NullableMembershipReadModelLinks struct {
	value *MembershipReadModelLinks
	isSet bool
}

func (v NullableMembershipReadModelLinks) Get() *MembershipReadModelLinks {
	return v.value
}

func (v *NullableMembershipReadModelLinks) Set(val *MembershipReadModelLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipReadModelLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipReadModelLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipReadModelLinks(val *MembershipReadModelLinks) *NullableMembershipReadModelLinks {
	return &NullableMembershipReadModelLinks{value: val, isSet: true}
}

func (v NullableMembershipReadModelLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipReadModelLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
