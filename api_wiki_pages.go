...
func (r ApiViewWikiPageRequest) Execute() (*WikiPageModel, *http.Response, error) {
	return r.ApiService.ViewWikiPageExecute(r)
}
...
func (a *WikiPagesAPIService) ViewWikiPageExecute(r ApiViewWikiPageRequest) (*WikiPageModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WikiPageModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WikiPagesAPIService.ViewWikiPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/wiki_pages/{id}"
