...
type RelationModelLinks struct {
	Update *RelationModelLinksUpdate `json:"update,omitempty"`
	...
	Schema RelationModelLinksSchema `json:"schema"`
...
func (o *RelationModelLinks) GetUpdate() RelationModelLinksUpdate {
	if o == nil || IsNil(o.Update) {
		var ret RelationModelLinksUpdate
		return ret
	}
	return *o.Update
}
...
// SetUpdate gets a reference to the given RelationModelLinksUpdate and assigns it to the Update field.
...
func (o *RelationModelLinks) GetSchema() RelationModelLinksSchema {
	if o == nil {
		var ret RelationModelLinksSchema
		return ret
	}
