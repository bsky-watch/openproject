...
// checks if the MembershipFormModelLinksCommit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipFormModelLinksCommit{}

// MembershipFormModelLinksCommit struct for MembershipFormModelLinksCommit
type MembershipFormModelLinksCommit struct {
...
type _MembershipFormModelLinksCommit MembershipFormModelLinksCommit
...
func NewMembershipFormModelLinksCommit(href string) *MembershipFormModelLinksCommit {
	this := MembershipFormModelLinksCommit{}
	this.Href = href
...
func (o MembershipFormModelLinksCommit) MarshalJSON() ([]byte, error) {
...
func (o MembershipFormModelLinksCommit) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipFormModelLinksCommit) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipFormModelLinksCommit := _MembershipFormModelLinksCommit{}

	err = json.Unmarshal(data, &varMembershipFormModelLinksCommit)

	if err != nil {
		return err
	}

	*o = MembershipFormModelLinksCommit(varMembershipFormModelLinksCommit)
...
type NullableMembershipFormModelLinksCommit struct {
	value *MembershipFormModelLinksCommit
	isSet bool
}

func (v NullableMembershipFormModelLinksCommit) Get() *MembershipFormModelLinksCommit {
	return v.value
}

func (v *NullableMembershipFormModelLinksCommit) Set(val *MembershipFormModelLinksCommit) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipFormModelLinksCommit) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipFormModelLinksCommit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipFormModelLinksCommit(val *MembershipFormModelLinksCommit) *NullableMembershipFormModelLinksCommit {
	return &NullableMembershipFormModelLinksCommit{value: val, isSet: true}
}

func (v NullableMembershipFormModelLinksCommit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipFormModelLinksCommit) UnmarshalJSON(src []byte) error {
	v.isSet = true
