...
// checks if the OAuthApplicationReadModelLinksOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OAuthApplicationReadModelLinksOwner{}

// OAuthApplicationReadModelLinksOwner struct for OAuthApplicationReadModelLinksOwner
type OAuthApplicationReadModelLinksOwner struct {
...
type _OAuthApplicationReadModelLinksOwner OAuthApplicationReadModelLinksOwner
...
func NewOAuthApplicationReadModelLinksOwner(href string) *OAuthApplicationReadModelLinksOwner {
	this := OAuthApplicationReadModelLinksOwner{}
	this.Href = href
...
// and a boolean to check if the value has been set.
func (o *OAuthApplicationReadModelLinksOwner) GetIdentifierOk() (*string, bool) {
	if o == nil || IsNil(o.Identifier) {
		return nil, false
	}
...
func (o OAuthApplicationReadModelLinksOwner) MarshalJSON() ([]byte, error) {
...
func (o OAuthApplicationReadModelLinksOwner) ToMap() (map[string]interface{}, error) {
...
func (o *OAuthApplicationReadModelLinksOwner) UnmarshalJSON(data []byte) (err error) {
	...
	varOAuthApplicationReadModelLinksOwner := _OAuthApplicationReadModelLinksOwner{}

	err = json.Unmarshal(data, &varOAuthApplicationReadModelLinksOwner)

	if err != nil {
		return err
	}

	*o = OAuthApplicationReadModelLinksOwner(varOAuthApplicationReadModelLinksOwner)
...
type NullableOAuthApplicationReadModelLinksOwner struct {
	value *OAuthApplicationReadModelLinksOwner
	isSet bool
}

func (v NullableOAuthApplicationReadModelLinksOwner) Get() *OAuthApplicationReadModelLinksOwner {
	return v.value
}

func (v *NullableOAuthApplicationReadModelLinksOwner) Set(val *OAuthApplicationReadModelLinksOwner) {
	v.value = val
	v.isSet = true
}

func (v NullableOAuthApplicationReadModelLinksOwner) IsSet() bool {
	return v.isSet
}

func (v *NullableOAuthApplicationReadModelLinksOwner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOAuthApplicationReadModelLinksOwner(val *OAuthApplicationReadModelLinksOwner) *NullableOAuthApplicationReadModelLinksOwner {
	return &NullableOAuthApplicationReadModelLinksOwner{value: val, isSet: true}
}

func (v NullableOAuthApplicationReadModelLinksOwner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOAuthApplicationReadModelLinksOwner) UnmarshalJSON(src []byte) error {
	v.isSet = true
