...
// checks if the ProjectModelLinksCategories type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksCategories{}

// ProjectModelLinksCategories struct for ProjectModelLinksCategories
type ProjectModelLinksCategories struct {
...
type _ProjectModelLinksCategories ProjectModelLinksCategories
...
func NewProjectModelLinksCategories(href string) *ProjectModelLinksCategories {
	this := ProjectModelLinksCategories{}
	this.Href = href
...
func (o *ProjectModelLinksCategories) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectModelLinksCategories) GetMethod() string {
...
func (o ProjectModelLinksCategories) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksCategories) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksCategories) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksCategories := _ProjectModelLinksCategories{}

	err = json.Unmarshal(data, &varProjectModelLinksCategories)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksCategories(varProjectModelLinksCategories)
...
type NullableProjectModelLinksCategories struct {
	value *ProjectModelLinksCategories
	isSet bool
}

func (v NullableProjectModelLinksCategories) Get() *ProjectModelLinksCategories {
	return v.value
}

func (v *NullableProjectModelLinksCategories) Set(val *ProjectModelLinksCategories) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksCategories) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksCategories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksCategories(val *ProjectModelLinksCategories) *NullableProjectModelLinksCategories {
	return &NullableProjectModelLinksCategories{value: val, isSet: true}
}

func (v NullableProjectModelLinksCategories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksCategories) UnmarshalJSON(src []byte) error {
	v.isSet = true
