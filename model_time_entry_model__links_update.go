...
// checks if the TimeEntryModelLinksUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryModelLinksUpdate{}

// TimeEntryModelLinksUpdate struct for TimeEntryModelLinksUpdate
type TimeEntryModelLinksUpdate struct {
...
type _TimeEntryModelLinksUpdate TimeEntryModelLinksUpdate
...
func NewTimeEntryModelLinksUpdate(href string) *TimeEntryModelLinksUpdate {
	this := TimeEntryModelLinksUpdate{}
	this.Href = href
...
func (o *TimeEntryModelLinksUpdate) SetHref(v string) {
	o.Href = v
}
...
func (o *TimeEntryModelLinksUpdate) GetMethod() string {
...
func (o TimeEntryModelLinksUpdate) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryModelLinksUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryModelLinksUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryModelLinksUpdate := _TimeEntryModelLinksUpdate{}

	err = json.Unmarshal(data, &varTimeEntryModelLinksUpdate)

	if err != nil {
		return err
	}

	*o = TimeEntryModelLinksUpdate(varTimeEntryModelLinksUpdate)
...
type NullableTimeEntryModelLinksUpdate struct {
	value *TimeEntryModelLinksUpdate
	isSet bool
}

func (v NullableTimeEntryModelLinksUpdate) Get() *TimeEntryModelLinksUpdate {
	return v.value
}

func (v *NullableTimeEntryModelLinksUpdate) Set(val *TimeEntryModelLinksUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryModelLinksUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryModelLinksUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryModelLinksUpdate(val *TimeEntryModelLinksUpdate) *NullableTimeEntryModelLinksUpdate {
	return &NullableTimeEntryModelLinksUpdate{value: val, isSet: true}
}

func (v NullableTimeEntryModelLinksUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryModelLinksUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
