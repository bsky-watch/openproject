...
// checks if the WorkPackageModelLinksWatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksWatch{}

// WorkPackageModelLinksWatch struct for WorkPackageModelLinksWatch
type WorkPackageModelLinksWatch struct {
...
type _WorkPackageModelLinksWatch WorkPackageModelLinksWatch
...
func NewWorkPackageModelLinksWatch(href string) *WorkPackageModelLinksWatch {
	this := WorkPackageModelLinksWatch{}
	this.Href = href
...
func (o WorkPackageModelLinksWatch) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksWatch) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksWatch) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksWatch := _WorkPackageModelLinksWatch{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksWatch)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksWatch(varWorkPackageModelLinksWatch)
...
type NullableWorkPackageModelLinksWatch struct {
	value *WorkPackageModelLinksWatch
	isSet bool
}

func (v NullableWorkPackageModelLinksWatch) Get() *WorkPackageModelLinksWatch {
	return v.value
}

func (v *NullableWorkPackageModelLinksWatch) Set(val *WorkPackageModelLinksWatch) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksWatch) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksWatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksWatch(val *WorkPackageModelLinksWatch) *NullableWorkPackageModelLinksWatch {
	return &NullableWorkPackageModelLinksWatch{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksWatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksWatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
