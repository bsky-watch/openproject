...
// checks if the RelationModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelationModelLinksSelf{}

// RelationModelLinksSelf struct for RelationModelLinksSelf
type RelationModelLinksSelf struct {
...
type _RelationModelLinksSelf RelationModelLinksSelf
...
func (o RelationModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o RelationModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *RelationModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varRelationModelLinksSelf := _RelationModelLinksSelf{}

	err = json.Unmarshal(data, &varRelationModelLinksSelf)

	if err != nil {
		return err
	}

	*o = RelationModelLinksSelf(varRelationModelLinksSelf)
...
type NullableRelationModelLinksSelf struct {
	value *RelationModelLinksSelf
	isSet bool
}

func (v NullableRelationModelLinksSelf) Get() *RelationModelLinksSelf {
	return v.value
}

func (v *NullableRelationModelLinksSelf) Set(val *RelationModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableRelationModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableRelationModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRelationModelLinksSelf(val *RelationModelLinksSelf) *NullableRelationModelLinksSelf {
	return &NullableRelationModelLinksSelf{value: val, isSet: true}
}

func (v NullableRelationModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRelationModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
