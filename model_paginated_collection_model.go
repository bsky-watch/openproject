...
// checks if the PaginatedCollectionModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedCollectionModel{}

// PaginatedCollectionModel struct for PaginatedCollectionModel
...
type _PaginatedCollectionModel PaginatedCollectionModel
...
func (o PaginatedCollectionModel) MarshalJSON() ([]byte, error) {
...
func (o PaginatedCollectionModel) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedCollectionModel) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedCollectionModel := _PaginatedCollectionModel{}

	err = json.Unmarshal(data, &varPaginatedCollectionModel)

	if err != nil {
		return err
	}

	*o = PaginatedCollectionModel(varPaginatedCollectionModel)
...
type NullablePaginatedCollectionModel struct {
	value *PaginatedCollectionModel
	isSet bool
}

func (v NullablePaginatedCollectionModel) Get() *PaginatedCollectionModel {
	return v.value
}

func (v *NullablePaginatedCollectionModel) Set(val *PaginatedCollectionModel) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCollectionModel) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCollectionModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCollectionModel(val *PaginatedCollectionModel) *NullablePaginatedCollectionModel {
	return &NullablePaginatedCollectionModel{value: val, isSet: true}
}

func (v NullablePaginatedCollectionModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCollectionModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
