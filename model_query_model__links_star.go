...
// checks if the QueryModelLinksStar type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryModelLinksStar{}

// QueryModelLinksStar struct for QueryModelLinksStar
type QueryModelLinksStar struct {
...
type _QueryModelLinksStar QueryModelLinksStar
...
func (o QueryModelLinksStar) MarshalJSON() ([]byte, error) {
...
func (o QueryModelLinksStar) ToMap() (map[string]interface{}, error) {
...
func (o *QueryModelLinksStar) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryModelLinksStar := _QueryModelLinksStar{}

	err = json.Unmarshal(data, &varQueryModelLinksStar)

	if err != nil {
		return err
	}

	*o = QueryModelLinksStar(varQueryModelLinksStar)
...
type NullableQueryModelLinksStar struct {
	value *QueryModelLinksStar
	isSet bool
}

func (v NullableQueryModelLinksStar) Get() *QueryModelLinksStar {
	return v.value
}

func (v *NullableQueryModelLinksStar) Set(val *QueryModelLinksStar) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryModelLinksStar) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryModelLinksStar) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryModelLinksStar(val *QueryModelLinksStar) *NullableQueryModelLinksStar {
	return &NullableQueryModelLinksStar{value: val, isSet: true}
}

func (v NullableQueryModelLinksStar) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryModelLinksStar) UnmarshalJSON(src []byte) error {
	v.isSet = true
