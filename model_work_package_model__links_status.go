...
// checks if the WorkPackageModelLinksStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksStatus{}

// WorkPackageModelLinksStatus struct for WorkPackageModelLinksStatus
type WorkPackageModelLinksStatus struct {
...
type _WorkPackageModelLinksStatus WorkPackageModelLinksStatus
...
func NewWorkPackageModelLinksStatus(href string) *WorkPackageModelLinksStatus {
	this := WorkPackageModelLinksStatus{}
	this.Href = href
...
func (o *WorkPackageModelLinksStatus) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksStatus) GetMethod() string {
...
func (o WorkPackageModelLinksStatus) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksStatus) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksStatus := _WorkPackageModelLinksStatus{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksStatus)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksStatus(varWorkPackageModelLinksStatus)
...
type NullableWorkPackageModelLinksStatus struct {
	value *WorkPackageModelLinksStatus
	isSet bool
}

func (v NullableWorkPackageModelLinksStatus) Get() *WorkPackageModelLinksStatus {
	return v.value
}

func (v *NullableWorkPackageModelLinksStatus) Set(val *WorkPackageModelLinksStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksStatus(val *WorkPackageModelLinksStatus) *NullableWorkPackageModelLinksStatus {
	return &NullableWorkPackageModelLinksStatus{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
