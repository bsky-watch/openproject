...
// checks if the DocumentModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentModelLinksProject{}

// DocumentModelLinksProject struct for DocumentModelLinksProject
type DocumentModelLinksProject struct {
...
type _DocumentModelLinksProject DocumentModelLinksProject
...
func NewDocumentModelLinksProject(href string) *DocumentModelLinksProject {
	this := DocumentModelLinksProject{}
	this.Href = href
...
func (o DocumentModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o DocumentModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *DocumentModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varDocumentModelLinksProject := _DocumentModelLinksProject{}

	err = json.Unmarshal(data, &varDocumentModelLinksProject)

	if err != nil {
		return err
	}

	*o = DocumentModelLinksProject(varDocumentModelLinksProject)
...
type NullableDocumentModelLinksProject struct {
	value *DocumentModelLinksProject
	isSet bool
}

func (v NullableDocumentModelLinksProject) Get() *DocumentModelLinksProject {
	return v.value
}

func (v *NullableDocumentModelLinksProject) Set(val *DocumentModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentModelLinksProject(val *DocumentModelLinksProject) *NullableDocumentModelLinksProject {
	return &NullableDocumentModelLinksProject{value: val, isSet: true}
}

func (v NullableDocumentModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
