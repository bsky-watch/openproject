...
// TimeEntryActivitiesAPIService TimeEntryActivitiesAPI service
type TimeEntryActivitiesAPIService service
...
func (r ApiGetTimeEntriesActivityRequest) Execute() (*TimeEntryActivityModel, *http.Response, error) {
	return r.ApiService.GetTimeEntriesActivityExecute(r)
}
...
func (a *TimeEntryActivitiesAPIService) GetTimeEntriesActivityExecute(r ApiGetTimeEntriesActivityRequest) (*TimeEntryActivityModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TimeEntryActivityModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TimeEntryActivitiesAPIService.GetTimeEntriesActivity")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/time_entries/activity/{id}"
