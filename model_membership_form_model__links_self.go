...
// checks if the MembershipFormModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipFormModelLinksSelf{}

// MembershipFormModelLinksSelf struct for MembershipFormModelLinksSelf
type MembershipFormModelLinksSelf struct {
...
type _MembershipFormModelLinksSelf MembershipFormModelLinksSelf
...
func NewMembershipFormModelLinksSelf(href string) *MembershipFormModelLinksSelf {
	this := MembershipFormModelLinksSelf{}
	this.Href = href
...
func (o MembershipFormModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o MembershipFormModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipFormModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipFormModelLinksSelf := _MembershipFormModelLinksSelf{}

	err = json.Unmarshal(data, &varMembershipFormModelLinksSelf)

	if err != nil {
		return err
	}

	*o = MembershipFormModelLinksSelf(varMembershipFormModelLinksSelf)
...
type NullableMembershipFormModelLinksSelf struct {
	value *MembershipFormModelLinksSelf
	isSet bool
}

func (v NullableMembershipFormModelLinksSelf) Get() *MembershipFormModelLinksSelf {
	return v.value
}

func (v *NullableMembershipFormModelLinksSelf) Set(val *MembershipFormModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipFormModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipFormModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipFormModelLinksSelf(val *MembershipFormModelLinksSelf) *NullableMembershipFormModelLinksSelf {
	return &NullableMembershipFormModelLinksSelf{value: val, isSet: true}
}

func (v NullableMembershipFormModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipFormModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
