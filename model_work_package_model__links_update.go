...
// checks if the WorkPackageModelLinksUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksUpdate{}

// WorkPackageModelLinksUpdate struct for WorkPackageModelLinksUpdate
type WorkPackageModelLinksUpdate struct {
...
type _WorkPackageModelLinksUpdate WorkPackageModelLinksUpdate
...
func NewWorkPackageModelLinksUpdate(href string) *WorkPackageModelLinksUpdate {
	this := WorkPackageModelLinksUpdate{}
	this.Href = href
...
func (o *WorkPackageModelLinksUpdate) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksUpdate) GetMethod() string {
...
func (o WorkPackageModelLinksUpdate) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksUpdate := _WorkPackageModelLinksUpdate{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksUpdate)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksUpdate(varWorkPackageModelLinksUpdate)
...
type NullableWorkPackageModelLinksUpdate struct {
	value *WorkPackageModelLinksUpdate
	isSet bool
}

func (v NullableWorkPackageModelLinksUpdate) Get() *WorkPackageModelLinksUpdate {
	return v.value
}

func (v *NullableWorkPackageModelLinksUpdate) Set(val *WorkPackageModelLinksUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksUpdate(val *WorkPackageModelLinksUpdate) *NullableWorkPackageModelLinksUpdate {
	return &NullableWorkPackageModelLinksUpdate{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
