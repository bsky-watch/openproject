...
// checks if the UserModelAllOfLinksUnlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserModelAllOfLinksUnlock{}

// UserModelAllOfLinksUnlock struct for UserModelAllOfLinksUnlock
type UserModelAllOfLinksUnlock struct {
...
type _UserModelAllOfLinksUnlock UserModelAllOfLinksUnlock
...
func NewUserModelAllOfLinksUnlock(href string) *UserModelAllOfLinksUnlock {
	this := UserModelAllOfLinksUnlock{}
	this.Href = href
...
func (o *UserModelAllOfLinksUnlock) SetHref(v string) {
	o.Href = v
}
...
func (o *UserModelAllOfLinksUnlock) GetMethod() string {
...
func (o UserModelAllOfLinksUnlock) MarshalJSON() ([]byte, error) {
...
func (o UserModelAllOfLinksUnlock) ToMap() (map[string]interface{}, error) {
...
func (o *UserModelAllOfLinksUnlock) UnmarshalJSON(data []byte) (err error) {
	...
	varUserModelAllOfLinksUnlock := _UserModelAllOfLinksUnlock{}

	err = json.Unmarshal(data, &varUserModelAllOfLinksUnlock)

	if err != nil {
		return err
	}

	*o = UserModelAllOfLinksUnlock(varUserModelAllOfLinksUnlock)
...
type NullableUserModelAllOfLinksUnlock struct {
	value *UserModelAllOfLinksUnlock
	isSet bool
}

func (v NullableUserModelAllOfLinksUnlock) Get() *UserModelAllOfLinksUnlock {
	return v.value
}

func (v *NullableUserModelAllOfLinksUnlock) Set(val *UserModelAllOfLinksUnlock) {
	v.value = val
	v.isSet = true
}

func (v NullableUserModelAllOfLinksUnlock) IsSet() bool {
	return v.isSet
}

func (v *NullableUserModelAllOfLinksUnlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserModelAllOfLinksUnlock(val *UserModelAllOfLinksUnlock) *NullableUserModelAllOfLinksUnlock {
	return &NullableUserModelAllOfLinksUnlock{value: val, isSet: true}
}

func (v NullableUserModelAllOfLinksUnlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserModelAllOfLinksUnlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
