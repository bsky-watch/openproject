...
// checks if the PrincipalModelLinksMemberships type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrincipalModelLinksMemberships{}

// PrincipalModelLinksMemberships struct for PrincipalModelLinksMemberships
type PrincipalModelLinksMemberships struct {
...
type _PrincipalModelLinksMemberships PrincipalModelLinksMemberships
...
func NewPrincipalModelLinksMemberships(href string) *PrincipalModelLinksMemberships {
	this := PrincipalModelLinksMemberships{}
	this.Href = href
...
func (o PrincipalModelLinksMemberships) MarshalJSON() ([]byte, error) {
...
func (o PrincipalModelLinksMemberships) ToMap() (map[string]interface{}, error) {
...
func (o *PrincipalModelLinksMemberships) UnmarshalJSON(data []byte) (err error) {
	...
	varPrincipalModelLinksMemberships := _PrincipalModelLinksMemberships{}

	err = json.Unmarshal(data, &varPrincipalModelLinksMemberships)

	if err != nil {
		return err
	}

	*o = PrincipalModelLinksMemberships(varPrincipalModelLinksMemberships)
...
type NullablePrincipalModelLinksMemberships struct {
	value *PrincipalModelLinksMemberships
	isSet bool
}

func (v NullablePrincipalModelLinksMemberships) Get() *PrincipalModelLinksMemberships {
	return v.value
}

func (v *NullablePrincipalModelLinksMemberships) Set(val *PrincipalModelLinksMemberships) {
	v.value = val
	v.isSet = true
}

func (v NullablePrincipalModelLinksMemberships) IsSet() bool {
	return v.isSet
}

func (v *NullablePrincipalModelLinksMemberships) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrincipalModelLinksMemberships(val *PrincipalModelLinksMemberships) *NullablePrincipalModelLinksMemberships {
	return &NullablePrincipalModelLinksMemberships{value: val, isSet: true}
}

func (v NullablePrincipalModelLinksMemberships) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrincipalModelLinksMemberships) UnmarshalJSON(src []byte) error {
	v.isSet = true
