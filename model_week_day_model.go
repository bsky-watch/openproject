...
// checks if the WeekDayModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WeekDayModel{}

// WeekDayModel struct for WeekDayModel
type WeekDayModel struct {
	...
	Links *WeekDaySelfLinkModel `json:"_links,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _WeekDayModel WeekDayModel
...
// SetLinks gets a reference to the given WeekDaySelfLinkModel and assigns it to the Links field.
func (o *WeekDayModel) SetLinks(v WeekDaySelfLinkModel) {
	o.Links = &v
}

func (o WeekDayModel) MarshalJSON() ([]byte, error) {
...
func (o WeekDayModel) ToMap() (map[string]interface{}, error) {
...
func (o *WeekDayModel) UnmarshalJSON(data []byte) (err error) {
	...
	varWeekDayModel := _WeekDayModel{}

	err = json.Unmarshal(data, &varWeekDayModel)

	if err != nil {
		return err
	}

	*o = WeekDayModel(varWeekDayModel)
...
type NullableWeekDayModel struct {
	value *WeekDayModel
	isSet bool
}

func (v NullableWeekDayModel) Get() *WeekDayModel {
	return v.value
}

func (v *NullableWeekDayModel) Set(val *WeekDayModel) {
	v.value = val
	v.isSet = true
}

func (v NullableWeekDayModel) IsSet() bool {
	return v.isSet
}

func (v *NullableWeekDayModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWeekDayModel(val *WeekDayModel) *NullableWeekDayModel {
	return &NullableWeekDayModel{value: val, isSet: true}
}

func (v NullableWeekDayModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWeekDayModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
