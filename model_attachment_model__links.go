...
// checks if the AttachmentModelLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttachmentModelLinks{}

// AttachmentModelLinks struct for AttachmentModelLinks
type AttachmentModelLinks struct {
	Delete *AttachmentModelLinksDelete `json:"delete,omitempty"`
	Self AttachmentModelLinksSelf `json:"self"`
	Container AttachmentModelLinksContainer `json:"container"`
	Author AttachmentModelLinksAuthor `json:"author"`
	DownloadLocation AttachmentModelLinksDownloadLocation `json:"downloadLocation"`
	AdditionalProperties map[string]interface{}
}

type _AttachmentModelLinks AttachmentModelLinks
...
func (o *AttachmentModelLinks) GetDelete() AttachmentModelLinksDelete {
	if o == nil || IsNil(o.Delete) {
		var ret AttachmentModelLinksDelete
		return ret
	}
	return *o.Delete
}
...
// SetDelete gets a reference to the given AttachmentModelLinksDelete and assigns it to the Delete field.
...
func (o *AttachmentModelLinks) GetSelf() AttachmentModelLinksSelf {
	if o == nil {
		var ret AttachmentModelLinksSelf
		return ret
	}
...
func (o *AttachmentModelLinks) GetContainer() AttachmentModelLinksContainer {
	if o == nil {
		var ret AttachmentModelLinksContainer
		return ret
	}
...
func (o *AttachmentModelLinks) GetAuthor() AttachmentModelLinksAuthor {
	if o == nil {
		var ret AttachmentModelLinksAuthor
		return ret
	}
...
func (o *AttachmentModelLinks) GetDownloadLocation() AttachmentModelLinksDownloadLocation {
	if o == nil {
		var ret AttachmentModelLinksDownloadLocation
		return ret
	}
...
func (o AttachmentModelLinks) MarshalJSON() ([]byte, error) {
...
func (o AttachmentModelLinks) ToMap() (map[string]interface{}, error) {
...
func (o *AttachmentModelLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varAttachmentModelLinks := _AttachmentModelLinks{}

	err = json.Unmarshal(data, &varAttachmentModelLinks)

	if err != nil {
		return err
	}

	*o = AttachmentModelLinks(varAttachmentModelLinks)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "downloadLocation")
...
type NullableAttachmentModelLinks struct {
	value *AttachmentModelLinks
	isSet bool
}

func (v NullableAttachmentModelLinks) Get() *AttachmentModelLinks {
	return v.value
}

func (v *NullableAttachmentModelLinks) Set(val *AttachmentModelLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableAttachmentModelLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableAttachmentModelLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttachmentModelLinks(val *AttachmentModelLinks) *NullableAttachmentModelLinks {
	return &NullableAttachmentModelLinks{value: val, isSet: true}
}

func (v NullableAttachmentModelLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttachmentModelLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
