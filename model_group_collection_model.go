...
func NewGroupCollectionModel(type_ string, total int, count int, links GroupCollectionModelAllOfLinks, embedded GroupCollectionModelAllOfEmbedded) *GroupCollectionModel {
...
func (o *GroupCollectionModel) GetTotal() int {
	if o == nil {
		var ret int
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GroupCollectionModel) GetTotalOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Total, true
...
func (o *GroupCollectionModel) SetTotal(v int) {
	o.Total = v
}

// GetCount returns the Count field value
func (o *GroupCollectionModel) GetCount() int {
	if o == nil {
		var ret int
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GroupCollectionModel) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Count, true
...
func (o *GroupCollectionModel) SetCount(v int) {
	o.Count = v
}
