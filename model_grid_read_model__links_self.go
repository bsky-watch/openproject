...
// checks if the GridReadModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridReadModelLinksSelf{}

// GridReadModelLinksSelf struct for GridReadModelLinksSelf
type GridReadModelLinksSelf struct {
...
type _GridReadModelLinksSelf GridReadModelLinksSelf
...
func (o *GridReadModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *GridReadModelLinksSelf) GetMethod() string {
...
func (o GridReadModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o GridReadModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *GridReadModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varGridReadModelLinksSelf := _GridReadModelLinksSelf{}

	err = json.Unmarshal(data, &varGridReadModelLinksSelf)

	if err != nil {
		return err
	}

	*o = GridReadModelLinksSelf(varGridReadModelLinksSelf)
...
type NullableGridReadModelLinksSelf struct {
	value *GridReadModelLinksSelf
	isSet bool
}

func (v NullableGridReadModelLinksSelf) Get() *GridReadModelLinksSelf {
	return v.value
}

func (v *NullableGridReadModelLinksSelf) Set(val *GridReadModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableGridReadModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableGridReadModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridReadModelLinksSelf(val *GridReadModelLinksSelf) *NullableGridReadModelLinksSelf {
	return &NullableGridReadModelLinksSelf{value: val, isSet: true}
}

func (v NullableGridReadModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridReadModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
