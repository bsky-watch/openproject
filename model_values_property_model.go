...
// checks if the ValuesPropertyModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuesPropertyModel{}
...
type _ValuesPropertyModel ValuesPropertyModel
...
func (o *ValuesPropertyModel) GetLinks() ValuesPropertyModelLinks {
	if o == nil {
		var ret ValuesPropertyModelLinks
		return ret
	}
...
func (o ValuesPropertyModel) MarshalJSON() ([]byte, error) {
...
func (o *ValuesPropertyModel) UnmarshalJSON(data []byte) (err error) {
	...
	varValuesPropertyModel := _ValuesPropertyModel{}

	err = json.Unmarshal(data, &varValuesPropertyModel)

	if err != nil {
		return err
	}

	*o = ValuesPropertyModel(varValuesPropertyModel)
...
type NullableValuesPropertyModel struct {
	value *ValuesPropertyModel
	isSet bool
}

func (v NullableValuesPropertyModel) Get() *ValuesPropertyModel {
	return v.value
}

func (v *NullableValuesPropertyModel) Set(val *ValuesPropertyModel) {
	v.value = val
	v.isSet = true
}

func (v NullableValuesPropertyModel) IsSet() bool {
	return v.isSet
}

func (v *NullableValuesPropertyModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuesPropertyModel(val *ValuesPropertyModel) *NullableValuesPropertyModel {
	return &NullableValuesPropertyModel{value: val, isSet: true}
}

func (v NullableValuesPropertyModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuesPropertyModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
