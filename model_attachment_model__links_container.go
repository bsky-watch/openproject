...
// checks if the AttachmentModelLinksContainer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttachmentModelLinksContainer{}

// AttachmentModelLinksContainer struct for AttachmentModelLinksContainer
type AttachmentModelLinksContainer struct {
...
type _AttachmentModelLinksContainer AttachmentModelLinksContainer
...
func NewAttachmentModelLinksContainer(href string) *AttachmentModelLinksContainer {
	this := AttachmentModelLinksContainer{}
	this.Href = href
...
func (o AttachmentModelLinksContainer) MarshalJSON() ([]byte, error) {
...
func (o AttachmentModelLinksContainer) ToMap() (map[string]interface{}, error) {
...
func (o *AttachmentModelLinksContainer) UnmarshalJSON(data []byte) (err error) {
	...
	varAttachmentModelLinksContainer := _AttachmentModelLinksContainer{}

	err = json.Unmarshal(data, &varAttachmentModelLinksContainer)

	if err != nil {
		return err
	}

	*o = AttachmentModelLinksContainer(varAttachmentModelLinksContainer)
...
type NullableAttachmentModelLinksContainer struct {
	value *AttachmentModelLinksContainer
	isSet bool
}

func (v NullableAttachmentModelLinksContainer) Get() *AttachmentModelLinksContainer {
	return v.value
}

func (v *NullableAttachmentModelLinksContainer) Set(val *AttachmentModelLinksContainer) {
	v.value = val
	v.isSet = true
}

func (v NullableAttachmentModelLinksContainer) IsSet() bool {
	return v.isSet
}

func (v *NullableAttachmentModelLinksContainer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttachmentModelLinksContainer(val *AttachmentModelLinksContainer) *NullableAttachmentModelLinksContainer {
	return &NullableAttachmentModelLinksContainer{value: val, isSet: true}
}

func (v NullableAttachmentModelLinksContainer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttachmentModelLinksContainer) UnmarshalJSON(src []byte) error {
	v.isSet = true
