...
// checks if the VersionModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionModelLinksSelf{}

// VersionModelLinksSelf struct for VersionModelLinksSelf
type VersionModelLinksSelf struct {
...
type _VersionModelLinksSelf VersionModelLinksSelf
...
func (o *VersionModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *VersionModelLinksSelf) GetMethod() string {
...
func (o VersionModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o VersionModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *VersionModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varVersionModelLinksSelf := _VersionModelLinksSelf{}

	err = json.Unmarshal(data, &varVersionModelLinksSelf)

	if err != nil {
		return err
	}

	*o = VersionModelLinksSelf(varVersionModelLinksSelf)
...
type NullableVersionModelLinksSelf struct {
	value *VersionModelLinksSelf
	isSet bool
}

func (v NullableVersionModelLinksSelf) Get() *VersionModelLinksSelf {
	return v.value
}

func (v *NullableVersionModelLinksSelf) Set(val *VersionModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionModelLinksSelf(val *VersionModelLinksSelf) *NullableVersionModelLinksSelf {
	return &NullableVersionModelLinksSelf{value: val, isSet: true}
}

func (v NullableVersionModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
