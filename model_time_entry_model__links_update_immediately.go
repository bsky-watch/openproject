...
// checks if the TimeEntryModelLinksUpdateImmediately type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryModelLinksUpdateImmediately{}

// TimeEntryModelLinksUpdateImmediately struct for TimeEntryModelLinksUpdateImmediately
type TimeEntryModelLinksUpdateImmediately struct {
...
type _TimeEntryModelLinksUpdateImmediately TimeEntryModelLinksUpdateImmediately
...
func NewTimeEntryModelLinksUpdateImmediately(href string) *TimeEntryModelLinksUpdateImmediately {
	this := TimeEntryModelLinksUpdateImmediately{}
	this.Href = href
...
func (o TimeEntryModelLinksUpdateImmediately) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryModelLinksUpdateImmediately) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryModelLinksUpdateImmediately) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryModelLinksUpdateImmediately := _TimeEntryModelLinksUpdateImmediately{}

	err = json.Unmarshal(data, &varTimeEntryModelLinksUpdateImmediately)

	if err != nil {
		return err
	}

	*o = TimeEntryModelLinksUpdateImmediately(varTimeEntryModelLinksUpdateImmediately)
...
type NullableTimeEntryModelLinksUpdateImmediately struct {
	value *TimeEntryModelLinksUpdateImmediately
	isSet bool
}

func (v NullableTimeEntryModelLinksUpdateImmediately) Get() *TimeEntryModelLinksUpdateImmediately {
	return v.value
}

func (v *NullableTimeEntryModelLinksUpdateImmediately) Set(val *TimeEntryModelLinksUpdateImmediately) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryModelLinksUpdateImmediately) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryModelLinksUpdateImmediately) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryModelLinksUpdateImmediately(val *TimeEntryModelLinksUpdateImmediately) *NullableTimeEntryModelLinksUpdateImmediately {
	return &NullableTimeEntryModelLinksUpdateImmediately{value: val, isSet: true}
}

func (v NullableTimeEntryModelLinksUpdateImmediately) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryModelLinksUpdateImmediately) UnmarshalJSON(src []byte) error {
	v.isSet = true
