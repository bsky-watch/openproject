...
// checks if the WorkPackageModelLinksAuthor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksAuthor{}

// WorkPackageModelLinksAuthor struct for WorkPackageModelLinksAuthor
type WorkPackageModelLinksAuthor struct {
...
type _WorkPackageModelLinksAuthor WorkPackageModelLinksAuthor
...
func NewWorkPackageModelLinksAuthor(href string) *WorkPackageModelLinksAuthor {
	this := WorkPackageModelLinksAuthor{}
	this.Href = href
...
func (o WorkPackageModelLinksAuthor) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksAuthor) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksAuthor) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksAuthor := _WorkPackageModelLinksAuthor{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksAuthor)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksAuthor(varWorkPackageModelLinksAuthor)
...
type NullableWorkPackageModelLinksAuthor struct {
	value *WorkPackageModelLinksAuthor
	isSet bool
}

func (v NullableWorkPackageModelLinksAuthor) Get() *WorkPackageModelLinksAuthor {
	return v.value
}

func (v *NullableWorkPackageModelLinksAuthor) Set(val *WorkPackageModelLinksAuthor) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksAuthor) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksAuthor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksAuthor(val *WorkPackageModelLinksAuthor) *NullableWorkPackageModelLinksAuthor {
	return &NullableWorkPackageModelLinksAuthor{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksAuthor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksAuthor) UnmarshalJSON(src []byte) error {
	v.isSet = true
