...
// checks if the TimeEntryModelLinksUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryModelLinksUser{}

// TimeEntryModelLinksUser struct for TimeEntryModelLinksUser
type TimeEntryModelLinksUser struct {
...
type _TimeEntryModelLinksUser TimeEntryModelLinksUser
...
func (o *TimeEntryModelLinksUser) SetHref(v string) {
	o.Href = v
}
...
func (o *TimeEntryModelLinksUser) GetMethod() string {
...
func (o TimeEntryModelLinksUser) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryModelLinksUser) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryModelLinksUser) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryModelLinksUser := _TimeEntryModelLinksUser{}

	err = json.Unmarshal(data, &varTimeEntryModelLinksUser)

	if err != nil {
		return err
	}

	*o = TimeEntryModelLinksUser(varTimeEntryModelLinksUser)
...
type NullableTimeEntryModelLinksUser struct {
	value *TimeEntryModelLinksUser
	isSet bool
}

func (v NullableTimeEntryModelLinksUser) Get() *TimeEntryModelLinksUser {
	return v.value
}

func (v *NullableTimeEntryModelLinksUser) Set(val *TimeEntryModelLinksUser) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryModelLinksUser) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryModelLinksUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryModelLinksUser(val *TimeEntryModelLinksUser) *NullableTimeEntryModelLinksUser {
	return &NullableTimeEntryModelLinksUser{value: val, isSet: true}
}

func (v NullableTimeEntryModelLinksUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryModelLinksUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
