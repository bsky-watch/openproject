...
// checks if the WorkPackageActivitiesModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageActivitiesModel{}

// WorkPackageActivitiesModel struct for WorkPackageActivitiesModel
...
type _WorkPackageActivitiesModel WorkPackageActivitiesModel
...
func (o *WorkPackageActivitiesModel) GetEmbedded() WorkPackageActivitiesModelAllOfEmbedded {
	if o == nil || IsNil(o.Embedded) {
		var ret WorkPackageActivitiesModelAllOfEmbedded
		return ret
	}
	return *o.Embedded
}
...
// SetEmbedded gets a reference to the given WorkPackageActivitiesModelAllOfEmbedded and assigns it to the Embedded field.
func (o *WorkPackageActivitiesModel) SetEmbedded(v WorkPackageActivitiesModelAllOfEmbedded) {
	o.Embedded = &v
}

func (o WorkPackageActivitiesModel) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageActivitiesModel) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageActivitiesModel) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageActivitiesModel := _WorkPackageActivitiesModel{}

	err = json.Unmarshal(data, &varWorkPackageActivitiesModel)

	if err != nil {
		return err
	}

	*o = WorkPackageActivitiesModel(varWorkPackageActivitiesModel)
...
type NullableWorkPackageActivitiesModel struct {
	value *WorkPackageActivitiesModel
	isSet bool
}

func (v NullableWorkPackageActivitiesModel) Get() *WorkPackageActivitiesModel {
	return v.value
}

func (v *NullableWorkPackageActivitiesModel) Set(val *WorkPackageActivitiesModel) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageActivitiesModel) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageActivitiesModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageActivitiesModel(val *WorkPackageActivitiesModel) *NullableWorkPackageActivitiesModel {
	return &NullableWorkPackageActivitiesModel{value: val, isSet: true}
}

func (v NullableWorkPackageActivitiesModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageActivitiesModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
