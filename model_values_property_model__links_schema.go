...
// checks if the ValuesPropertyModelLinksSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuesPropertyModelLinksSchema{}

// ValuesPropertyModelLinksSchema struct for ValuesPropertyModelLinksSchema
type ValuesPropertyModelLinksSchema struct {
...
type _ValuesPropertyModelLinksSchema ValuesPropertyModelLinksSchema
...
func NewValuesPropertyModelLinksSchema(href string) *ValuesPropertyModelLinksSchema {
	this := ValuesPropertyModelLinksSchema{}
	this.Href = href
...
func (o ValuesPropertyModelLinksSchema) MarshalJSON() ([]byte, error) {
...
func (o ValuesPropertyModelLinksSchema) ToMap() (map[string]interface{}, error) {
...
func (o *ValuesPropertyModelLinksSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varValuesPropertyModelLinksSchema := _ValuesPropertyModelLinksSchema{}

	err = json.Unmarshal(data, &varValuesPropertyModelLinksSchema)

	if err != nil {
		return err
	}

	*o = ValuesPropertyModelLinksSchema(varValuesPropertyModelLinksSchema)
...
type NullableValuesPropertyModelLinksSchema struct {
	value *ValuesPropertyModelLinksSchema
	isSet bool
}

func (v NullableValuesPropertyModelLinksSchema) Get() *ValuesPropertyModelLinksSchema {
	return v.value
}

func (v *NullableValuesPropertyModelLinksSchema) Set(val *ValuesPropertyModelLinksSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableValuesPropertyModelLinksSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableValuesPropertyModelLinksSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuesPropertyModelLinksSchema(val *ValuesPropertyModelLinksSchema) *NullableValuesPropertyModelLinksSchema {
	return &NullableValuesPropertyModelLinksSchema{value: val, isSet: true}
}

func (v NullableValuesPropertyModelLinksSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuesPropertyModelLinksSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
