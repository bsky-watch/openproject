...
func (r ApiListDocumentsRequest) SortBy(sortBy string) ApiListDocumentsRequest {
	r.sortBy = &sortBy
	return r
}

func (r ApiListDocumentsRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *DocumentsAPIService) ListDocumentsExecute(r ApiListDocumentsRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v3/documents"
...
func (r ApiViewDocumentRequest) Execute() (*DocumentModel, *http.Response, error) {
	return r.ApiService.ViewDocumentExecute(r)
}
...
func (a *DocumentsAPIService) ViewDocumentExecute(r ApiViewDocumentRequest) (*DocumentModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DocumentModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DocumentsAPIService.ViewDocument")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/documents/{id}"
