...
// checks if the PostModelLinksAddAttachment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostModelLinksAddAttachment{}

// PostModelLinksAddAttachment struct for PostModelLinksAddAttachment
type PostModelLinksAddAttachment struct {
...
type _PostModelLinksAddAttachment PostModelLinksAddAttachment
...
func NewPostModelLinksAddAttachment(href string) *PostModelLinksAddAttachment {
	this := PostModelLinksAddAttachment{}
	this.Href = href
...
func (o PostModelLinksAddAttachment) MarshalJSON() ([]byte, error) {
...
func (o PostModelLinksAddAttachment) ToMap() (map[string]interface{}, error) {
...
func (o *PostModelLinksAddAttachment) UnmarshalJSON(data []byte) (err error) {
	...
	varPostModelLinksAddAttachment := _PostModelLinksAddAttachment{}

	err = json.Unmarshal(data, &varPostModelLinksAddAttachment)

	if err != nil {
		return err
	}

	*o = PostModelLinksAddAttachment(varPostModelLinksAddAttachment)
...
type NullablePostModelLinksAddAttachment struct {
	value *PostModelLinksAddAttachment
	isSet bool
}

func (v NullablePostModelLinksAddAttachment) Get() *PostModelLinksAddAttachment {
	return v.value
}

func (v *NullablePostModelLinksAddAttachment) Set(val *PostModelLinksAddAttachment) {
	v.value = val
	v.isSet = true
}

func (v NullablePostModelLinksAddAttachment) IsSet() bool {
	return v.isSet
}

func (v *NullablePostModelLinksAddAttachment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostModelLinksAddAttachment(val *PostModelLinksAddAttachment) *NullablePostModelLinksAddAttachment {
	return &NullablePostModelLinksAddAttachment{value: val, isSet: true}
}

func (v NullablePostModelLinksAddAttachment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostModelLinksAddAttachment) UnmarshalJSON(src []byte) error {
	v.isSet = true
