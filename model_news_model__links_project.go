...
// checks if the NewsModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewsModelLinksProject{}

// NewsModelLinksProject struct for NewsModelLinksProject
type NewsModelLinksProject struct {
...
type _NewsModelLinksProject NewsModelLinksProject
...
func (o NewsModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o NewsModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *NewsModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varNewsModelLinksProject := _NewsModelLinksProject{}

	err = json.Unmarshal(data, &varNewsModelLinksProject)

	if err != nil {
		return err
	}

	*o = NewsModelLinksProject(varNewsModelLinksProject)
...
type NullableNewsModelLinksProject struct {
	value *NewsModelLinksProject
	isSet bool
}

func (v NullableNewsModelLinksProject) Get() *NewsModelLinksProject {
	return v.value
}

func (v *NullableNewsModelLinksProject) Set(val *NewsModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableNewsModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableNewsModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewsModelLinksProject(val *NewsModelLinksProject) *NullableNewsModelLinksProject {
	return &NullableNewsModelLinksProject{value: val, isSet: true}
}

func (v NullableNewsModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewsModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
