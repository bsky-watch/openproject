...
// checks if the TimeEntryModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryModelLinksProject{}

// TimeEntryModelLinksProject struct for TimeEntryModelLinksProject
type TimeEntryModelLinksProject struct {
...
type _TimeEntryModelLinksProject TimeEntryModelLinksProject
...
func NewTimeEntryModelLinksProject(href string) *TimeEntryModelLinksProject {
	this := TimeEntryModelLinksProject{}
	this.Href = href
...
func (o *TimeEntryModelLinksProject) SetHref(v string) {
	o.Href = v
}
...
func (o *TimeEntryModelLinksProject) GetMethod() string {
...
func (o TimeEntryModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryModelLinksProject := _TimeEntryModelLinksProject{}

	err = json.Unmarshal(data, &varTimeEntryModelLinksProject)

	if err != nil {
		return err
	}

	*o = TimeEntryModelLinksProject(varTimeEntryModelLinksProject)
...
type NullableTimeEntryModelLinksProject struct {
	value *TimeEntryModelLinksProject
	isSet bool
}

func (v NullableTimeEntryModelLinksProject) Get() *TimeEntryModelLinksProject {
	return v.value
}

func (v *NullableTimeEntryModelLinksProject) Set(val *TimeEntryModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryModelLinksProject(val *TimeEntryModelLinksProject) *NullableTimeEntryModelLinksProject {
	return &NullableTimeEntryModelLinksProject{value: val, isSet: true}
}

func (v NullableTimeEntryModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
