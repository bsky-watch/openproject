...
// checks if the StorageReadModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageReadModelLinksSelf{}

// StorageReadModelLinksSelf struct for StorageReadModelLinksSelf
type StorageReadModelLinksSelf struct {
...
type _StorageReadModelLinksSelf StorageReadModelLinksSelf
...
func NewStorageReadModelLinksSelf(href string) *StorageReadModelLinksSelf {
	this := StorageReadModelLinksSelf{}
	this.Href = href
...
func (o StorageReadModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o StorageReadModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *StorageReadModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageReadModelLinksSelf := _StorageReadModelLinksSelf{}

	err = json.Unmarshal(data, &varStorageReadModelLinksSelf)

	if err != nil {
		return err
	}

	*o = StorageReadModelLinksSelf(varStorageReadModelLinksSelf)
...
type NullableStorageReadModelLinksSelf struct {
	value *StorageReadModelLinksSelf
	isSet bool
}

func (v NullableStorageReadModelLinksSelf) Get() *StorageReadModelLinksSelf {
	return v.value
}

func (v *NullableStorageReadModelLinksSelf) Set(val *StorageReadModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageReadModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageReadModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageReadModelLinksSelf(val *StorageReadModelLinksSelf) *NullableStorageReadModelLinksSelf {
	return &NullableStorageReadModelLinksSelf{value: val, isSet: true}
}

func (v NullableStorageReadModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageReadModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
