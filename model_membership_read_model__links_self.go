...
// checks if the MembershipReadModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipReadModelLinksSelf{}

// MembershipReadModelLinksSelf struct for MembershipReadModelLinksSelf
type MembershipReadModelLinksSelf struct {
...
type _MembershipReadModelLinksSelf MembershipReadModelLinksSelf
...
func NewMembershipReadModelLinksSelf(href string) *MembershipReadModelLinksSelf {
	this := MembershipReadModelLinksSelf{}
	this.Href = href
...
func (o *MembershipReadModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *MembershipReadModelLinksSelf) GetMethod() string {
...
func (o MembershipReadModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o MembershipReadModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipReadModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipReadModelLinksSelf := _MembershipReadModelLinksSelf{}

	err = json.Unmarshal(data, &varMembershipReadModelLinksSelf)

	if err != nil {
		return err
	}

	*o = MembershipReadModelLinksSelf(varMembershipReadModelLinksSelf)
...
type NullableMembershipReadModelLinksSelf struct {
	value *MembershipReadModelLinksSelf
	isSet bool
}

func (v NullableMembershipReadModelLinksSelf) Get() *MembershipReadModelLinksSelf {
	return v.value
}

func (v *NullableMembershipReadModelLinksSelf) Set(val *MembershipReadModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipReadModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipReadModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipReadModelLinksSelf(val *MembershipReadModelLinksSelf) *NullableMembershipReadModelLinksSelf {
	return &NullableMembershipReadModelLinksSelf{value: val, isSet: true}
}

func (v NullableMembershipReadModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipReadModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
