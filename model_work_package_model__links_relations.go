...
// checks if the WorkPackageModelLinksRelations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksRelations{}

// WorkPackageModelLinksRelations struct for WorkPackageModelLinksRelations
type WorkPackageModelLinksRelations struct {
...
type _WorkPackageModelLinksRelations WorkPackageModelLinksRelations
...
func NewWorkPackageModelLinksRelations(href string) *WorkPackageModelLinksRelations {
	this := WorkPackageModelLinksRelations{}
	this.Href = href
...
func (o WorkPackageModelLinksRelations) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksRelations) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksRelations) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksRelations := _WorkPackageModelLinksRelations{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksRelations)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksRelations(varWorkPackageModelLinksRelations)
...
type NullableWorkPackageModelLinksRelations struct {
	value *WorkPackageModelLinksRelations
	isSet bool
}

func (v NullableWorkPackageModelLinksRelations) Get() *WorkPackageModelLinksRelations {
	return v.value
}

func (v *NullableWorkPackageModelLinksRelations) Set(val *WorkPackageModelLinksRelations) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksRelations) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksRelations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksRelations(val *WorkPackageModelLinksRelations) *NullableWorkPackageModelLinksRelations {
	return &NullableWorkPackageModelLinksRelations{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksRelations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksRelations) UnmarshalJSON(src []byte) error {
	v.isSet = true
