...
// checks if the ProjectModelLinksVersions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksVersions{}

// ProjectModelLinksVersions struct for ProjectModelLinksVersions
type ProjectModelLinksVersions struct {
...
type _ProjectModelLinksVersions ProjectModelLinksVersions
...
func NewProjectModelLinksVersions(href string) *ProjectModelLinksVersions {
	this := ProjectModelLinksVersions{}
	this.Href = href
...
func (o *ProjectModelLinksVersions) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectModelLinksVersions) GetMethod() string {
...
func (o ProjectModelLinksVersions) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksVersions) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksVersions) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksVersions := _ProjectModelLinksVersions{}

	err = json.Unmarshal(data, &varProjectModelLinksVersions)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksVersions(varProjectModelLinksVersions)
...
type NullableProjectModelLinksVersions struct {
	value *ProjectModelLinksVersions
	isSet bool
}

func (v NullableProjectModelLinksVersions) Get() *ProjectModelLinksVersions {
	return v.value
}

func (v *NullableProjectModelLinksVersions) Set(val *ProjectModelLinksVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksVersions(val *ProjectModelLinksVersions) *NullableProjectModelLinksVersions {
	return &NullableProjectModelLinksVersions{value: val, isSet: true}
}

func (v NullableProjectModelLinksVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
