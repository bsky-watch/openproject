...
// checks if the CustomOptionModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomOptionModelLinksSelf{}

// CustomOptionModelLinksSelf struct for CustomOptionModelLinksSelf
type CustomOptionModelLinksSelf struct {
...
type _CustomOptionModelLinksSelf CustomOptionModelLinksSelf
...
func NewCustomOptionModelLinksSelf(href string) *CustomOptionModelLinksSelf {
	this := CustomOptionModelLinksSelf{}
	this.Href = href
...
func (o *CustomOptionModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *CustomOptionModelLinksSelf) GetMethod() string {
...
func (o CustomOptionModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o CustomOptionModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *CustomOptionModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomOptionModelLinksSelf := _CustomOptionModelLinksSelf{}

	err = json.Unmarshal(data, &varCustomOptionModelLinksSelf)

	if err != nil {
		return err
	}

	*o = CustomOptionModelLinksSelf(varCustomOptionModelLinksSelf)
...
type NullableCustomOptionModelLinksSelf struct {
	value *CustomOptionModelLinksSelf
	isSet bool
}

func (v NullableCustomOptionModelLinksSelf) Get() *CustomOptionModelLinksSelf {
	return v.value
}

func (v *NullableCustomOptionModelLinksSelf) Set(val *CustomOptionModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomOptionModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomOptionModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomOptionModelLinksSelf(val *CustomOptionModelLinksSelf) *NullableCustomOptionModelLinksSelf {
	return &NullableCustomOptionModelLinksSelf{value: val, isSet: true}
}

func (v NullableCustomOptionModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomOptionModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
