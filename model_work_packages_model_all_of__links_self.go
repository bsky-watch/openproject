...
// checks if the WorkPackagesModelAllOfLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackagesModelAllOfLinksSelf{}

// WorkPackagesModelAllOfLinksSelf struct for WorkPackagesModelAllOfLinksSelf
type WorkPackagesModelAllOfLinksSelf struct {
...
type _WorkPackagesModelAllOfLinksSelf WorkPackagesModelAllOfLinksSelf
...
func NewWorkPackagesModelAllOfLinksSelf(href string) *WorkPackagesModelAllOfLinksSelf {
	this := WorkPackagesModelAllOfLinksSelf{}
	this.Href = href
...
func (o WorkPackagesModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o WorkPackagesModelAllOfLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackagesModelAllOfLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackagesModelAllOfLinksSelf := _WorkPackagesModelAllOfLinksSelf{}

	err = json.Unmarshal(data, &varWorkPackagesModelAllOfLinksSelf)

	if err != nil {
		return err
	}

	*o = WorkPackagesModelAllOfLinksSelf(varWorkPackagesModelAllOfLinksSelf)
...
type NullableWorkPackagesModelAllOfLinksSelf struct {
	value *WorkPackagesModelAllOfLinksSelf
	isSet bool
}

func (v NullableWorkPackagesModelAllOfLinksSelf) Get() *WorkPackagesModelAllOfLinksSelf {
	return v.value
}

func (v *NullableWorkPackagesModelAllOfLinksSelf) Set(val *WorkPackagesModelAllOfLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackagesModelAllOfLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackagesModelAllOfLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackagesModelAllOfLinksSelf(val *WorkPackagesModelAllOfLinksSelf) *NullableWorkPackagesModelAllOfLinksSelf {
	return &NullableWorkPackagesModelAllOfLinksSelf{value: val, isSet: true}
}

func (v NullableWorkPackagesModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackagesModelAllOfLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
