...
func (r ApiCreateUserRequest) UserCreateModel(userCreateModel UserCreateModel) ApiCreateUserRequest {
	r.userCreateModel = &userCreateModel
	return r
}
...
//  @return UserModel
func (a *UsersAPIService) CreateUserExecute(r ApiCreateUserRequest) (*UserModel, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.userCreateModel
...
func (a *UsersAPIService) DeleteUserExecute(r ApiDeleteUserRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/users/{id}"
...
func (r ApiListUsersRequest) Filters(filters string) ApiListUsersRequest {
	r.filters = &filters
	return r
}
...
func (r ApiListUsersRequest) Execute() (*UserCollectionModel, *http.Response, error) {
...
func (a *UsersAPIService) ListUsersExecute(r ApiListUsersRequest) (*UserCollectionModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UserCollectionModel
	)
...
// Execute executes the request
//  @return UserModel
func (a *UsersAPIService) LockUserExecute(r ApiLockUserRequest) (*UserModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/api/v3/users/{id}/lock"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
// Execute executes the request
//  @return UserModel
func (a *UsersAPIService) UnlockUserExecute(r ApiUnlockUserRequest) (*UserModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.UnlockUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateUserRequest) UserCreateModel(userCreateModel UserCreateModel) ApiUpdateUserRequest {
	r.userCreateModel = &userCreateModel
	return r
}
...
// Execute executes the request
//  @return UserModel
func (a *UsersAPIService) UpdateUserExecute(r ApiUpdateUserRequest) (*UserModel, *http.Response, error) {
	var (
...
func (r ApiUserUpdateFormRequest) Execute() (*http.Response, error) {
	return r.ApiService.UserUpdateFormExecute(r)
}
...
// Execute executes the request
func (a *UsersAPIService) UserUpdateFormExecute(r ApiUserUpdateFormRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.UserUpdateForm")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/users/{id}/form"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiViewUserRequest struct {
	ctx context.Context
	ApiService *UsersAPIService
	id string
}

func (r ApiViewUserRequest) Execute() (*UserModel, *http.Response, error) {
	return r.ApiService.ViewUserExecute(r)
}
...
ViewUser View user
 ...
 @return ApiViewUserRequest
*/
func (a *UsersAPIService) ViewUser(ctx context.Context, id string) ApiViewUserRequest {
	return ApiViewUserRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return UserModel
func (a *UsersAPIService) ViewUserExecute(r ApiViewUserRequest) (*UserModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.ViewUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiViewUserSchemaRequest struct {
	ctx context.Context
	ApiService *UsersAPIService
}

func (r ApiViewUserSchemaRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ViewUserSchemaExecute(r)
}

/*
ViewUserSchema View user schema
...
The schema response use two exemplary custom fields that extend the schema response. Depending on your instance and custom field configuration, the response will look somewhat different.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiViewUserSchemaRequest
*/
func (a *UsersAPIService) ViewUserSchema(ctx context.Context) ApiViewUserSchemaRequest {
	return ApiViewUserSchemaRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UsersAPIService) ViewUserSchemaExecute(r ApiViewUserSchemaRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.ViewUserSchema")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/users/schema"
