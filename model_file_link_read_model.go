...
// checks if the FileLinkReadModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileLinkReadModel{}
...
type FileLinkReadModel struct {
	...
	OriginData FileLinkOriginDataModel `json:"originData"`
	Embedded *FileLinkReadModelEmbedded `json:"_embedded,omitempty"`
	Links FileLinkReadModelLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _FileLinkReadModel FileLinkReadModel
...
// GetOriginData returns the OriginData field value
func (o *FileLinkReadModel) GetOriginData() FileLinkOriginDataModel {
	if o == nil {
		var ret FileLinkOriginDataModel
		return ret
	}
...
// GetOriginDataOk returns a tuple with the OriginData field value
// and a boolean to check if the value has been set.
func (o *FileLinkReadModel) GetOriginDataOk() (*FileLinkOriginDataModel, bool) {
	if o == nil {
		return nil, false
	}
	return &o.OriginData, true
}

// SetOriginData sets field value
...
func (o *FileLinkReadModel) GetEmbedded() FileLinkReadModelEmbedded {
	if o == nil || IsNil(o.Embedded) {
		var ret FileLinkReadModelEmbedded
		return ret
	}
	return *o.Embedded
}
...
// SetEmbedded gets a reference to the given FileLinkReadModelEmbedded and assigns it to the Embedded field.
...
func (o *FileLinkReadModel) GetLinks() FileLinkReadModelLinks {
	if o == nil {
		var ret FileLinkReadModelLinks
		return ret
	}
...
func (o FileLinkReadModel) MarshalJSON() ([]byte, error) {
...
func (o FileLinkReadModel) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["originData"] = o.OriginData
	if !IsNil(o.Embedded) {
...
func (o *FileLinkReadModel) UnmarshalJSON(data []byte) (err error) {
	...
	varFileLinkReadModel := _FileLinkReadModel{}

	err = json.Unmarshal(data, &varFileLinkReadModel)

	if err != nil {
		return err
	}

	*o = FileLinkReadModel(varFileLinkReadModel)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "originData")
...
type NullableFileLinkReadModel struct {
	value *FileLinkReadModel
	isSet bool
}

func (v NullableFileLinkReadModel) Get() *FileLinkReadModel {
	return v.value
}

func (v *NullableFileLinkReadModel) Set(val *FileLinkReadModel) {
	v.value = val
	v.isSet = true
}

func (v NullableFileLinkReadModel) IsSet() bool {
	return v.isSet
}

func (v *NullableFileLinkReadModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileLinkReadModel(val *FileLinkReadModel) *NullableFileLinkReadModel {
	return &NullableFileLinkReadModel{value: val, isSet: true}
}

func (v NullableFileLinkReadModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileLinkReadModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
