...
// checks if the WorkPackageModelLinksPreviewMarkup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksPreviewMarkup{}

// WorkPackageModelLinksPreviewMarkup struct for WorkPackageModelLinksPreviewMarkup
type WorkPackageModelLinksPreviewMarkup struct {
...
type _WorkPackageModelLinksPreviewMarkup WorkPackageModelLinksPreviewMarkup
...
func NewWorkPackageModelLinksPreviewMarkup(href string) *WorkPackageModelLinksPreviewMarkup {
	this := WorkPackageModelLinksPreviewMarkup{}
	this.Href = href
...
func (o WorkPackageModelLinksPreviewMarkup) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksPreviewMarkup) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksPreviewMarkup) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksPreviewMarkup := _WorkPackageModelLinksPreviewMarkup{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksPreviewMarkup)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksPreviewMarkup(varWorkPackageModelLinksPreviewMarkup)
...
type NullableWorkPackageModelLinksPreviewMarkup struct {
	value *WorkPackageModelLinksPreviewMarkup
	isSet bool
}

func (v NullableWorkPackageModelLinksPreviewMarkup) Get() *WorkPackageModelLinksPreviewMarkup {
	return v.value
}

func (v *NullableWorkPackageModelLinksPreviewMarkup) Set(val *WorkPackageModelLinksPreviewMarkup) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksPreviewMarkup) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksPreviewMarkup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksPreviewMarkup(val *WorkPackageModelLinksPreviewMarkup) *NullableWorkPackageModelLinksPreviewMarkup {
	return &NullableWorkPackageModelLinksPreviewMarkup{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksPreviewMarkup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksPreviewMarkup) UnmarshalJSON(src []byte) error {
	v.isSet = true
