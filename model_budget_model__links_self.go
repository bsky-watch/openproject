...
// checks if the BudgetModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BudgetModelLinksSelf{}

// BudgetModelLinksSelf struct for BudgetModelLinksSelf
type BudgetModelLinksSelf struct {
...
type _BudgetModelLinksSelf BudgetModelLinksSelf
...
func (o *BudgetModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *BudgetModelLinksSelf) GetMethod() string {
...
func (o BudgetModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o BudgetModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *BudgetModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varBudgetModelLinksSelf := _BudgetModelLinksSelf{}

	err = json.Unmarshal(data, &varBudgetModelLinksSelf)

	if err != nil {
		return err
	}

	*o = BudgetModelLinksSelf(varBudgetModelLinksSelf)
...
type NullableBudgetModelLinksSelf struct {
	value *BudgetModelLinksSelf
	isSet bool
}

func (v NullableBudgetModelLinksSelf) Get() *BudgetModelLinksSelf {
	return v.value
}

func (v *NullableBudgetModelLinksSelf) Set(val *BudgetModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableBudgetModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableBudgetModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBudgetModelLinksSelf(val *BudgetModelLinksSelf) *NullableBudgetModelLinksSelf {
	return &NullableBudgetModelLinksSelf{value: val, isSet: true}
}

func (v NullableBudgetModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBudgetModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
