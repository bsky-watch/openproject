...
// checks if the SchemaModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchemaModel{}

// SchemaModel struct for SchemaModel
...
func (o SchemaModel) ToMap() (map[string]interface{}, error) {
...
func (o *SchemaModel) UnmarshalJSON(data []byte) (err error) {
	...
	varSchemaModel := _SchemaModel{}

	err = json.Unmarshal(data, &varSchemaModel)

	if err != nil {
		return err
	}

	*o = SchemaModel(varSchemaModel)
