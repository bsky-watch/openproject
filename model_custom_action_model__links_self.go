...
// checks if the CustomActionModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomActionModelLinksSelf{}

// CustomActionModelLinksSelf struct for CustomActionModelLinksSelf
type CustomActionModelLinksSelf struct {
...
type _CustomActionModelLinksSelf CustomActionModelLinksSelf
...
func NewCustomActionModelLinksSelf(href string) *CustomActionModelLinksSelf {
	this := CustomActionModelLinksSelf{}
	this.Href = href
...
func (o *CustomActionModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *CustomActionModelLinksSelf) GetMethod() string {
...
func (o CustomActionModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o CustomActionModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *CustomActionModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomActionModelLinksSelf := _CustomActionModelLinksSelf{}

	err = json.Unmarshal(data, &varCustomActionModelLinksSelf)

	if err != nil {
		return err
	}

	*o = CustomActionModelLinksSelf(varCustomActionModelLinksSelf)
...
type NullableCustomActionModelLinksSelf struct {
	value *CustomActionModelLinksSelf
	isSet bool
}

func (v NullableCustomActionModelLinksSelf) Get() *CustomActionModelLinksSelf {
	return v.value
}

func (v *NullableCustomActionModelLinksSelf) Set(val *CustomActionModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomActionModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomActionModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomActionModelLinksSelf(val *CustomActionModelLinksSelf) *NullableCustomActionModelLinksSelf {
	return &NullableCustomActionModelLinksSelf{value: val, isSet: true}
}

func (v NullableCustomActionModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomActionModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
