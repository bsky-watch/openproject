...
// checks if the NotificationModelLinksResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationModelLinksResource{}

// NotificationModelLinksResource struct for NotificationModelLinksResource
type NotificationModelLinksResource struct {
...
type _NotificationModelLinksResource NotificationModelLinksResource
...
func NewNotificationModelLinksResource(href string) *NotificationModelLinksResource {
	this := NotificationModelLinksResource{}
	this.Href = href
...
func (o NotificationModelLinksResource) MarshalJSON() ([]byte, error) {
...
func (o NotificationModelLinksResource) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationModelLinksResource) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationModelLinksResource := _NotificationModelLinksResource{}

	err = json.Unmarshal(data, &varNotificationModelLinksResource)

	if err != nil {
		return err
	}

	*o = NotificationModelLinksResource(varNotificationModelLinksResource)
...
type NullableNotificationModelLinksResource struct {
	value *NotificationModelLinksResource
	isSet bool
}

func (v NullableNotificationModelLinksResource) Get() *NotificationModelLinksResource {
	return v.value
}

func (v *NullableNotificationModelLinksResource) Set(val *NotificationModelLinksResource) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationModelLinksResource) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationModelLinksResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationModelLinksResource(val *NotificationModelLinksResource) *NullableNotificationModelLinksResource {
	return &NullableNotificationModelLinksResource{value: val, isSet: true}
}

func (v NullableNotificationModelLinksResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationModelLinksResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
