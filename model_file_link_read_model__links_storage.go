...
// checks if the FileLinkReadModelLinksStorage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileLinkReadModelLinksStorage{}

// FileLinkReadModelLinksStorage struct for FileLinkReadModelLinksStorage
type FileLinkReadModelLinksStorage struct {
...
type _FileLinkReadModelLinksStorage FileLinkReadModelLinksStorage
...
func NewFileLinkReadModelLinksStorage(href string) *FileLinkReadModelLinksStorage {
	this := FileLinkReadModelLinksStorage{}
	this.Href = href
...
func (o FileLinkReadModelLinksStorage) MarshalJSON() ([]byte, error) {
...
func (o FileLinkReadModelLinksStorage) ToMap() (map[string]interface{}, error) {
...
func (o *FileLinkReadModelLinksStorage) UnmarshalJSON(data []byte) (err error) {
	...
	varFileLinkReadModelLinksStorage := _FileLinkReadModelLinksStorage{}

	err = json.Unmarshal(data, &varFileLinkReadModelLinksStorage)

	if err != nil {
		return err
	}

	*o = FileLinkReadModelLinksStorage(varFileLinkReadModelLinksStorage)
...
type NullableFileLinkReadModelLinksStorage struct {
	value *FileLinkReadModelLinksStorage
	isSet bool
}

func (v NullableFileLinkReadModelLinksStorage) Get() *FileLinkReadModelLinksStorage {
	return v.value
}

func (v *NullableFileLinkReadModelLinksStorage) Set(val *FileLinkReadModelLinksStorage) {
	v.value = val
	v.isSet = true
}

func (v NullableFileLinkReadModelLinksStorage) IsSet() bool {
	return v.isSet
}

func (v *NullableFileLinkReadModelLinksStorage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileLinkReadModelLinksStorage(val *FileLinkReadModelLinksStorage) *NullableFileLinkReadModelLinksStorage {
	return &NullableFileLinkReadModelLinksStorage{value: val, isSet: true}
}

func (v NullableFileLinkReadModelLinksStorage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileLinkReadModelLinksStorage) UnmarshalJSON(src []byte) error {
	v.isSet = true
