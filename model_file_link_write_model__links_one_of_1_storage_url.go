...
// checks if the FileLinkWriteModelLinksOneOf1StorageUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileLinkWriteModelLinksOneOf1StorageUrl{}

// FileLinkWriteModelLinksOneOf1StorageUrl struct for FileLinkWriteModelLinksOneOf1StorageUrl
type FileLinkWriteModelLinksOneOf1StorageUrl struct {
...
type _FileLinkWriteModelLinksOneOf1StorageUrl FileLinkWriteModelLinksOneOf1StorageUrl
...
func NewFileLinkWriteModelLinksOneOf1StorageUrl(href string) *FileLinkWriteModelLinksOneOf1StorageUrl {
	this := FileLinkWriteModelLinksOneOf1StorageUrl{}
	this.Href = href
...
func (o FileLinkWriteModelLinksOneOf1StorageUrl) MarshalJSON() ([]byte, error) {
...
func (o FileLinkWriteModelLinksOneOf1StorageUrl) ToMap() (map[string]interface{}, error) {
...
func (o *FileLinkWriteModelLinksOneOf1StorageUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varFileLinkWriteModelLinksOneOf1StorageUrl := _FileLinkWriteModelLinksOneOf1StorageUrl{}

	err = json.Unmarshal(data, &varFileLinkWriteModelLinksOneOf1StorageUrl)

	if err != nil {
		return err
	}

	*o = FileLinkWriteModelLinksOneOf1StorageUrl(varFileLinkWriteModelLinksOneOf1StorageUrl)
...
type NullableFileLinkWriteModelLinksOneOf1StorageUrl struct {
	value *FileLinkWriteModelLinksOneOf1StorageUrl
	isSet bool
}

func (v NullableFileLinkWriteModelLinksOneOf1StorageUrl) Get() *FileLinkWriteModelLinksOneOf1StorageUrl {
	return v.value
}

func (v *NullableFileLinkWriteModelLinksOneOf1StorageUrl) Set(val *FileLinkWriteModelLinksOneOf1StorageUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableFileLinkWriteModelLinksOneOf1StorageUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableFileLinkWriteModelLinksOneOf1StorageUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileLinkWriteModelLinksOneOf1StorageUrl(val *FileLinkWriteModelLinksOneOf1StorageUrl) *NullableFileLinkWriteModelLinksOneOf1StorageUrl {
	return &NullableFileLinkWriteModelLinksOneOf1StorageUrl{value: val, isSet: true}
}

func (v NullableFileLinkWriteModelLinksOneOf1StorageUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileLinkWriteModelLinksOneOf1StorageUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
