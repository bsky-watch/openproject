...
// checks if the WorkPackageModelLinksWatchers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksWatchers{}

// WorkPackageModelLinksWatchers struct for WorkPackageModelLinksWatchers
type WorkPackageModelLinksWatchers struct {
...
type _WorkPackageModelLinksWatchers WorkPackageModelLinksWatchers
...
func NewWorkPackageModelLinksWatchers(href string) *WorkPackageModelLinksWatchers {
	this := WorkPackageModelLinksWatchers{}
	this.Href = href
...
func (o WorkPackageModelLinksWatchers) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksWatchers) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksWatchers) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksWatchers := _WorkPackageModelLinksWatchers{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksWatchers)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksWatchers(varWorkPackageModelLinksWatchers)
...
type NullableWorkPackageModelLinksWatchers struct {
	value *WorkPackageModelLinksWatchers
	isSet bool
}

func (v NullableWorkPackageModelLinksWatchers) Get() *WorkPackageModelLinksWatchers {
	return v.value
}

func (v *NullableWorkPackageModelLinksWatchers) Set(val *WorkPackageModelLinksWatchers) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksWatchers) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksWatchers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksWatchers(val *WorkPackageModelLinksWatchers) *NullableWorkPackageModelLinksWatchers {
	return &NullableWorkPackageModelLinksWatchers{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksWatchers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksWatchers) UnmarshalJSON(src []byte) error {
	v.isSet = true
