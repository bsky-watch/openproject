...
// checks if the TypeModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TypeModel{}

// TypeModel struct for TypeModel
...
func (o *TypeModel) GetIdOk() (*int, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *TypeModel) GetPosition() int {
...
// and a boolean to check if the value has been set.
func (o *TypeModel) GetPositionOk() (*int, bool) {
	if o == nil || IsNil(o.Position) {
		return nil, false
	}
...
func (o *TypeModel) SetPosition(v int) {
	o.Position = &v
}
...
func (o TypeModel) MarshalJSON() ([]byte, error) {
...
func (o TypeModel) ToMap() (map[string]interface{}, error) {
...
func (o *TypeModel) UnmarshalJSON(data []byte) (err error) {
	varTypeModel := _TypeModel{}

	err = json.Unmarshal(data, &varTypeModel)

	if err != nil {
		return err
	}

	*o = TypeModel(varTypeModel)
...
type NullableTypeModel struct {
	value *TypeModel
	isSet bool
}

func (v NullableTypeModel) Get() *TypeModel {
	return v.value
}

func (v *NullableTypeModel) Set(val *TypeModel) {
	v.value = val
	v.isSet = true
}

func (v NullableTypeModel) IsSet() bool {
	return v.isSet
}

func (v *NullableTypeModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTypeModel(val *TypeModel) *NullableTypeModel {
	return &NullableTypeModel{value: val, isSet: true}
}

func (v NullableTypeModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTypeModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
