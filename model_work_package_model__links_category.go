...
// checks if the WorkPackageModelLinksCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksCategory{}

// WorkPackageModelLinksCategory struct for WorkPackageModelLinksCategory
type WorkPackageModelLinksCategory struct {
...
type _WorkPackageModelLinksCategory WorkPackageModelLinksCategory
...
func NewWorkPackageModelLinksCategory(href string) *WorkPackageModelLinksCategory {
	this := WorkPackageModelLinksCategory{}
	this.Href = href
...
func (o *WorkPackageModelLinksCategory) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksCategory) GetMethod() string {
...
func (o WorkPackageModelLinksCategory) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksCategory) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksCategory := _WorkPackageModelLinksCategory{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksCategory)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksCategory(varWorkPackageModelLinksCategory)
...
type NullableWorkPackageModelLinksCategory struct {
	value *WorkPackageModelLinksCategory
	isSet bool
}

func (v NullableWorkPackageModelLinksCategory) Get() *WorkPackageModelLinksCategory {
	return v.value
}

func (v *NullableWorkPackageModelLinksCategory) Set(val *WorkPackageModelLinksCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksCategory(val *WorkPackageModelLinksCategory) *NullableWorkPackageModelLinksCategory {
	return &NullableWorkPackageModelLinksCategory{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
