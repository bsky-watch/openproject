...
// checks if the MembershipReadModelLinksSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipReadModelLinksSchema{}

// MembershipReadModelLinksSchema struct for MembershipReadModelLinksSchema
type MembershipReadModelLinksSchema struct {
...
type _MembershipReadModelLinksSchema MembershipReadModelLinksSchema
...
func NewMembershipReadModelLinksSchema(href string) *MembershipReadModelLinksSchema {
	this := MembershipReadModelLinksSchema{}
	this.Href = href
...
func (o MembershipReadModelLinksSchema) MarshalJSON() ([]byte, error) {
...
func (o MembershipReadModelLinksSchema) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipReadModelLinksSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipReadModelLinksSchema := _MembershipReadModelLinksSchema{}

	err = json.Unmarshal(data, &varMembershipReadModelLinksSchema)

	if err != nil {
		return err
	}

	*o = MembershipReadModelLinksSchema(varMembershipReadModelLinksSchema)
...
type NullableMembershipReadModelLinksSchema struct {
	value *MembershipReadModelLinksSchema
	isSet bool
}

func (v NullableMembershipReadModelLinksSchema) Get() *MembershipReadModelLinksSchema {
	return v.value
}

func (v *NullableMembershipReadModelLinksSchema) Set(val *MembershipReadModelLinksSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipReadModelLinksSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipReadModelLinksSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipReadModelLinksSchema(val *MembershipReadModelLinksSchema) *NullableMembershipReadModelLinksSchema {
	return &NullableMembershipReadModelLinksSchema{value: val, isSet: true}
}

func (v NullableMembershipReadModelLinksSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipReadModelLinksSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
