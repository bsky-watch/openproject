...
// checks if the WorkPackageModelLinksResponsible type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksResponsible{}

// WorkPackageModelLinksResponsible struct for WorkPackageModelLinksResponsible
type WorkPackageModelLinksResponsible struct {
...
type _WorkPackageModelLinksResponsible WorkPackageModelLinksResponsible
...
func NewWorkPackageModelLinksResponsible(href string) *WorkPackageModelLinksResponsible {
	this := WorkPackageModelLinksResponsible{}
	this.Href = href
...
func (o WorkPackageModelLinksResponsible) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksResponsible) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksResponsible) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksResponsible := _WorkPackageModelLinksResponsible{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksResponsible)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksResponsible(varWorkPackageModelLinksResponsible)
...
type NullableWorkPackageModelLinksResponsible struct {
	value *WorkPackageModelLinksResponsible
	isSet bool
}

func (v NullableWorkPackageModelLinksResponsible) Get() *WorkPackageModelLinksResponsible {
	return v.value
}

func (v *NullableWorkPackageModelLinksResponsible) Set(val *WorkPackageModelLinksResponsible) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksResponsible) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksResponsible) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksResponsible(val *WorkPackageModelLinksResponsible) *NullableWorkPackageModelLinksResponsible {
	return &NullableWorkPackageModelLinksResponsible{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksResponsible) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksResponsible) UnmarshalJSON(src []byte) error {
	v.isSet = true
