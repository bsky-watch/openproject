...
// checks if the WorkPackageModelLinksBudget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksBudget{}

// WorkPackageModelLinksBudget struct for WorkPackageModelLinksBudget
type WorkPackageModelLinksBudget struct {
...
type _WorkPackageModelLinksBudget WorkPackageModelLinksBudget
...
func NewWorkPackageModelLinksBudget(href string) *WorkPackageModelLinksBudget {
	this := WorkPackageModelLinksBudget{}
	this.Href = href
...
func (o *WorkPackageModelLinksBudget) SetHref(v string) {
	o.Href = v
}
...
func (o *WorkPackageModelLinksBudget) GetMethod() string {
...
func (o WorkPackageModelLinksBudget) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksBudget) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksBudget) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksBudget := _WorkPackageModelLinksBudget{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksBudget)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksBudget(varWorkPackageModelLinksBudget)
...
type NullableWorkPackageModelLinksBudget struct {
	value *WorkPackageModelLinksBudget
	isSet bool
}

func (v NullableWorkPackageModelLinksBudget) Get() *WorkPackageModelLinksBudget {
	return v.value
}

func (v *NullableWorkPackageModelLinksBudget) Set(val *WorkPackageModelLinksBudget) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksBudget) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksBudget) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksBudget(val *WorkPackageModelLinksBudget) *NullableWorkPackageModelLinksBudget {
	return &NullableWorkPackageModelLinksBudget{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksBudget) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksBudget) UnmarshalJSON(src []byte) error {
	v.isSet = true
