...
// checks if the MembershipWriteModelLinksPrincipal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipWriteModelLinksPrincipal{}

// MembershipWriteModelLinksPrincipal struct for MembershipWriteModelLinksPrincipal
type MembershipWriteModelLinksPrincipal struct {
...
type _MembershipWriteModelLinksPrincipal MembershipWriteModelLinksPrincipal
...
func NewMembershipWriteModelLinksPrincipal(href string) *MembershipWriteModelLinksPrincipal {
	this := MembershipWriteModelLinksPrincipal{}
	this.Href = href
...
func (o MembershipWriteModelLinksPrincipal) MarshalJSON() ([]byte, error) {
...
func (o MembershipWriteModelLinksPrincipal) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipWriteModelLinksPrincipal) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipWriteModelLinksPrincipal := _MembershipWriteModelLinksPrincipal{}

	err = json.Unmarshal(data, &varMembershipWriteModelLinksPrincipal)

	if err != nil {
		return err
	}

	*o = MembershipWriteModelLinksPrincipal(varMembershipWriteModelLinksPrincipal)
...
type NullableMembershipWriteModelLinksPrincipal struct {
	value *MembershipWriteModelLinksPrincipal
	isSet bool
}

func (v NullableMembershipWriteModelLinksPrincipal) Get() *MembershipWriteModelLinksPrincipal {
	return v.value
}

func (v *NullableMembershipWriteModelLinksPrincipal) Set(val *MembershipWriteModelLinksPrincipal) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipWriteModelLinksPrincipal) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipWriteModelLinksPrincipal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipWriteModelLinksPrincipal(val *MembershipWriteModelLinksPrincipal) *NullableMembershipWriteModelLinksPrincipal {
	return &NullableMembershipWriteModelLinksPrincipal{value: val, isSet: true}
}

func (v NullableMembershipWriteModelLinksPrincipal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipWriteModelLinksPrincipal) UnmarshalJSON(src []byte) error {
	v.isSet = true
