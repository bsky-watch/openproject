...
func (r ApiViewRevisionRequest) Execute() (*RevisionModel, *http.Response, error) {
	return r.ApiService.ViewRevisionExecute(r)
}
...
func (a *RevisionsAPIService) ViewRevisionExecute(r ApiViewRevisionRequest) (*RevisionModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RevisionModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RevisionsAPIService.ViewRevision")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/revisions/{id}"
