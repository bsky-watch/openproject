...
// checks if the ValuesPropertyModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuesPropertyModelLinksSelf{}

// ValuesPropertyModelLinksSelf struct for ValuesPropertyModelLinksSelf
type ValuesPropertyModelLinksSelf struct {
...
type _ValuesPropertyModelLinksSelf ValuesPropertyModelLinksSelf
...
func NewValuesPropertyModelLinksSelf(href string) *ValuesPropertyModelLinksSelf {
	this := ValuesPropertyModelLinksSelf{}
	this.Href = href
...
func (o ValuesPropertyModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o ValuesPropertyModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *ValuesPropertyModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varValuesPropertyModelLinksSelf := _ValuesPropertyModelLinksSelf{}

	err = json.Unmarshal(data, &varValuesPropertyModelLinksSelf)

	if err != nil {
		return err
	}

	*o = ValuesPropertyModelLinksSelf(varValuesPropertyModelLinksSelf)
...
type NullableValuesPropertyModelLinksSelf struct {
	value *ValuesPropertyModelLinksSelf
	isSet bool
}

func (v NullableValuesPropertyModelLinksSelf) Get() *ValuesPropertyModelLinksSelf {
	return v.value
}

func (v *NullableValuesPropertyModelLinksSelf) Set(val *ValuesPropertyModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableValuesPropertyModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableValuesPropertyModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuesPropertyModelLinksSelf(val *ValuesPropertyModelLinksSelf) *NullableValuesPropertyModelLinksSelf {
	return &NullableValuesPropertyModelLinksSelf{value: val, isSet: true}
}

func (v NullableValuesPropertyModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuesPropertyModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
