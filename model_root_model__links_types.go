...
// checks if the RootModelLinksTypes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksTypes{}

// RootModelLinksTypes struct for RootModelLinksTypes
type RootModelLinksTypes struct {
...
type _RootModelLinksTypes RootModelLinksTypes
...
func (o *RootModelLinksTypes) SetHref(v string) {
	o.Href = v
}
...
func (o *RootModelLinksTypes) GetMethod() string {
...
func (o RootModelLinksTypes) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksTypes) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksTypes) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksTypes := _RootModelLinksTypes{}

	err = json.Unmarshal(data, &varRootModelLinksTypes)

	if err != nil {
		return err
	}

	*o = RootModelLinksTypes(varRootModelLinksTypes)
...
type NullableRootModelLinksTypes struct {
	value *RootModelLinksTypes
	isSet bool
}

func (v NullableRootModelLinksTypes) Get() *RootModelLinksTypes {
	return v.value
}

func (v *NullableRootModelLinksTypes) Set(val *RootModelLinksTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksTypes(val *RootModelLinksTypes) *NullableRootModelLinksTypes {
	return &NullableRootModelLinksTypes{value: val, isSet: true}
}

func (v NullableRootModelLinksTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
