...
// checks if the ProjectModelLinksMemberships type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectModelLinksMemberships{}

// ProjectModelLinksMemberships struct for ProjectModelLinksMemberships
type ProjectModelLinksMemberships struct {
...
type _ProjectModelLinksMemberships ProjectModelLinksMemberships
...
func NewProjectModelLinksMemberships(href string) *ProjectModelLinksMemberships {
	this := ProjectModelLinksMemberships{}
	this.Href = href
...
func (o *ProjectModelLinksMemberships) SetHref(v string) {
	o.Href = v
}
...
func (o *ProjectModelLinksMemberships) GetMethod() string {
...
func (o ProjectModelLinksMemberships) MarshalJSON() ([]byte, error) {
...
func (o ProjectModelLinksMemberships) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectModelLinksMemberships) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectModelLinksMemberships := _ProjectModelLinksMemberships{}

	err = json.Unmarshal(data, &varProjectModelLinksMemberships)

	if err != nil {
		return err
	}

	*o = ProjectModelLinksMemberships(varProjectModelLinksMemberships)
...
type NullableProjectModelLinksMemberships struct {
	value *ProjectModelLinksMemberships
	isSet bool
}

func (v NullableProjectModelLinksMemberships) Get() *ProjectModelLinksMemberships {
	return v.value
}

func (v *NullableProjectModelLinksMemberships) Set(val *ProjectModelLinksMemberships) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectModelLinksMemberships) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectModelLinksMemberships) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectModelLinksMemberships(val *ProjectModelLinksMemberships) *NullableProjectModelLinksMemberships {
	return &NullableProjectModelLinksMemberships{value: val, isSet: true}
}

func (v NullableProjectModelLinksMemberships) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectModelLinksMemberships) UnmarshalJSON(src []byte) error {
	v.isSet = true
