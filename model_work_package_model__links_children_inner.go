...
// checks if the WorkPackageModelLinksChildrenInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkPackageModelLinksChildrenInner{}

// WorkPackageModelLinksChildrenInner struct for WorkPackageModelLinksChildrenInner
type WorkPackageModelLinksChildrenInner struct {
...
type _WorkPackageModelLinksChildrenInner WorkPackageModelLinksChildrenInner
...
func NewWorkPackageModelLinksChildrenInner(href string) *WorkPackageModelLinksChildrenInner {
	this := WorkPackageModelLinksChildrenInner{}
	this.Href = href
...
func (o WorkPackageModelLinksChildrenInner) MarshalJSON() ([]byte, error) {
...
func (o WorkPackageModelLinksChildrenInner) ToMap() (map[string]interface{}, error) {
...
func (o *WorkPackageModelLinksChildrenInner) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkPackageModelLinksChildrenInner := _WorkPackageModelLinksChildrenInner{}

	err = json.Unmarshal(data, &varWorkPackageModelLinksChildrenInner)

	if err != nil {
		return err
	}

	*o = WorkPackageModelLinksChildrenInner(varWorkPackageModelLinksChildrenInner)
...
type NullableWorkPackageModelLinksChildrenInner struct {
	value *WorkPackageModelLinksChildrenInner
	isSet bool
}

func (v NullableWorkPackageModelLinksChildrenInner) Get() *WorkPackageModelLinksChildrenInner {
	return v.value
}

func (v *NullableWorkPackageModelLinksChildrenInner) Set(val *WorkPackageModelLinksChildrenInner) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkPackageModelLinksChildrenInner) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkPackageModelLinksChildrenInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkPackageModelLinksChildrenInner(val *WorkPackageModelLinksChildrenInner) *NullableWorkPackageModelLinksChildrenInner {
	return &NullableWorkPackageModelLinksChildrenInner{value: val, isSet: true}
}

func (v NullableWorkPackageModelLinksChildrenInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkPackageModelLinksChildrenInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
