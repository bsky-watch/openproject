...
// checks if the DocumentModelLinksAttachments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentModelLinksAttachments{}

// DocumentModelLinksAttachments struct for DocumentModelLinksAttachments
type DocumentModelLinksAttachments struct {
...
type _DocumentModelLinksAttachments DocumentModelLinksAttachments
...
func NewDocumentModelLinksAttachments(href string) *DocumentModelLinksAttachments {
	this := DocumentModelLinksAttachments{}
	this.Href = href
...
func (o DocumentModelLinksAttachments) MarshalJSON() ([]byte, error) {
...
func (o DocumentModelLinksAttachments) ToMap() (map[string]interface{}, error) {
...
func (o *DocumentModelLinksAttachments) UnmarshalJSON(data []byte) (err error) {
	...
	varDocumentModelLinksAttachments := _DocumentModelLinksAttachments{}

	err = json.Unmarshal(data, &varDocumentModelLinksAttachments)

	if err != nil {
		return err
	}

	*o = DocumentModelLinksAttachments(varDocumentModelLinksAttachments)
...
type NullableDocumentModelLinksAttachments struct {
	value *DocumentModelLinksAttachments
	isSet bool
}

func (v NullableDocumentModelLinksAttachments) Get() *DocumentModelLinksAttachments {
	return v.value
}

func (v *NullableDocumentModelLinksAttachments) Set(val *DocumentModelLinksAttachments) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentModelLinksAttachments) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentModelLinksAttachments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentModelLinksAttachments(val *DocumentModelLinksAttachments) *NullableDocumentModelLinksAttachments {
	return &NullableDocumentModelLinksAttachments{value: val, isSet: true}
}

func (v NullableDocumentModelLinksAttachments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentModelLinksAttachments) UnmarshalJSON(src []byte) error {
	v.isSet = true
