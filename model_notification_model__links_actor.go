...
// checks if the NotificationModelLinksActor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationModelLinksActor{}

// NotificationModelLinksActor struct for NotificationModelLinksActor
type NotificationModelLinksActor struct {
...
type _NotificationModelLinksActor NotificationModelLinksActor
...
func NewNotificationModelLinksActor(href string) *NotificationModelLinksActor {
	this := NotificationModelLinksActor{}
	this.Href = href
...
func (o NotificationModelLinksActor) MarshalJSON() ([]byte, error) {
...
func (o NotificationModelLinksActor) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationModelLinksActor) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationModelLinksActor := _NotificationModelLinksActor{}

	err = json.Unmarshal(data, &varNotificationModelLinksActor)

	if err != nil {
		return err
	}

	*o = NotificationModelLinksActor(varNotificationModelLinksActor)
...
type NullableNotificationModelLinksActor struct {
	value *NotificationModelLinksActor
	isSet bool
}

func (v NullableNotificationModelLinksActor) Get() *NotificationModelLinksActor {
	return v.value
}

func (v *NullableNotificationModelLinksActor) Set(val *NotificationModelLinksActor) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationModelLinksActor) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationModelLinksActor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationModelLinksActor(val *NotificationModelLinksActor) *NullableNotificationModelLinksActor {
	return &NullableNotificationModelLinksActor{value: val, isSet: true}
}

func (v NullableNotificationModelLinksActor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationModelLinksActor) UnmarshalJSON(src []byte) error {
	v.isSet = true
