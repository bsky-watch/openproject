...
// checks if the MembershipWriteModelLinksProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipWriteModelLinksProject{}

// MembershipWriteModelLinksProject struct for MembershipWriteModelLinksProject
type MembershipWriteModelLinksProject struct {
...
type _MembershipWriteModelLinksProject MembershipWriteModelLinksProject
...
func NewMembershipWriteModelLinksProject(href string) *MembershipWriteModelLinksProject {
	this := MembershipWriteModelLinksProject{}
	this.Href = href
...
func (o MembershipWriteModelLinksProject) MarshalJSON() ([]byte, error) {
...
func (o MembershipWriteModelLinksProject) ToMap() (map[string]interface{}, error) {
...
func (o *MembershipWriteModelLinksProject) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipWriteModelLinksProject := _MembershipWriteModelLinksProject{}

	err = json.Unmarshal(data, &varMembershipWriteModelLinksProject)

	if err != nil {
		return err
	}

	*o = MembershipWriteModelLinksProject(varMembershipWriteModelLinksProject)
...
type NullableMembershipWriteModelLinksProject struct {
	value *MembershipWriteModelLinksProject
	isSet bool
}

func (v NullableMembershipWriteModelLinksProject) Get() *MembershipWriteModelLinksProject {
	return v.value
}

func (v *NullableMembershipWriteModelLinksProject) Set(val *MembershipWriteModelLinksProject) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipWriteModelLinksProject) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipWriteModelLinksProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipWriteModelLinksProject(val *MembershipWriteModelLinksProject) *NullableMembershipWriteModelLinksProject {
	return &NullableMembershipWriteModelLinksProject{value: val, isSet: true}
}

func (v NullableMembershipWriteModelLinksProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipWriteModelLinksProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
