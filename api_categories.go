...
func (r ApiListCategoriesOfAProjectRequest) Execute() (*CategoriesByProjectModel, *http.Response, error) {
	return r.ApiService.ListCategoriesOfAProjectExecute(r)
}
...
func (a *CategoriesAPIService) ListCategoriesOfAProjectExecute(r ApiListCategoriesOfAProjectRequest) (*CategoriesByProjectModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CategoriesByProjectModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CategoriesAPIService.ListCategoriesOfAProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/projects/{id}/categories"
...
func (r ApiViewCategoryRequest) Execute() (*CategoryModel, *http.Response, error) {
	return r.ApiService.ViewCategoryExecute(r)
}
...
func (a *CategoriesAPIService) ViewCategoryExecute(r ApiViewCategoryRequest) (*CategoryModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CategoriesAPIService.ViewCategory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/categories/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
