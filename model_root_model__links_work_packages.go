...
// checks if the RootModelLinksWorkPackages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksWorkPackages{}

// RootModelLinksWorkPackages struct for RootModelLinksWorkPackages
type RootModelLinksWorkPackages struct {
...
type _RootModelLinksWorkPackages RootModelLinksWorkPackages
...
func NewRootModelLinksWorkPackages(href string) *RootModelLinksWorkPackages {
	this := RootModelLinksWorkPackages{}
	this.Href = href
...
func (o *RootModelLinksWorkPackages) SetHref(v string) {
	o.Href = v
}
...
func (o *RootModelLinksWorkPackages) GetMethod() string {
...
func (o RootModelLinksWorkPackages) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksWorkPackages) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksWorkPackages) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksWorkPackages := _RootModelLinksWorkPackages{}

	err = json.Unmarshal(data, &varRootModelLinksWorkPackages)

	if err != nil {
		return err
	}

	*o = RootModelLinksWorkPackages(varRootModelLinksWorkPackages)
...
type NullableRootModelLinksWorkPackages struct {
	value *RootModelLinksWorkPackages
	isSet bool
}

func (v NullableRootModelLinksWorkPackages) Get() *RootModelLinksWorkPackages {
	return v.value
}

func (v *NullableRootModelLinksWorkPackages) Set(val *RootModelLinksWorkPackages) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksWorkPackages) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksWorkPackages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksWorkPackages(val *RootModelLinksWorkPackages) *NullableRootModelLinksWorkPackages {
	return &NullableRootModelLinksWorkPackages{value: val, isSet: true}
}

func (v NullableRootModelLinksWorkPackages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksWorkPackages) UnmarshalJSON(src []byte) error {
	v.isSet = true
