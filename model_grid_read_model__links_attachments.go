...
// checks if the GridReadModelLinksAttachments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridReadModelLinksAttachments{}

// GridReadModelLinksAttachments struct for GridReadModelLinksAttachments
type GridReadModelLinksAttachments struct {
...
type _GridReadModelLinksAttachments GridReadModelLinksAttachments
...
func NewGridReadModelLinksAttachments(href string) *GridReadModelLinksAttachments {
	this := GridReadModelLinksAttachments{}
	this.Href = href
...
func (o GridReadModelLinksAttachments) MarshalJSON() ([]byte, error) {
...
func (o GridReadModelLinksAttachments) ToMap() (map[string]interface{}, error) {
...
func (o *GridReadModelLinksAttachments) UnmarshalJSON(data []byte) (err error) {
	...
	varGridReadModelLinksAttachments := _GridReadModelLinksAttachments{}

	err = json.Unmarshal(data, &varGridReadModelLinksAttachments)

	if err != nil {
		return err
	}

	*o = GridReadModelLinksAttachments(varGridReadModelLinksAttachments)
...
type NullableGridReadModelLinksAttachments struct {
	value *GridReadModelLinksAttachments
	isSet bool
}

func (v NullableGridReadModelLinksAttachments) Get() *GridReadModelLinksAttachments {
	return v.value
}

func (v *NullableGridReadModelLinksAttachments) Set(val *GridReadModelLinksAttachments) {
	v.value = val
	v.isSet = true
}

func (v NullableGridReadModelLinksAttachments) IsSet() bool {
	return v.isSet
}

func (v *NullableGridReadModelLinksAttachments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridReadModelLinksAttachments(val *GridReadModelLinksAttachments) *NullableGridReadModelLinksAttachments {
	return &NullableGridReadModelLinksAttachments{value: val, isSet: true}
}

func (v NullableGridReadModelLinksAttachments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridReadModelLinksAttachments) UnmarshalJSON(src []byte) error {
	v.isSet = true
