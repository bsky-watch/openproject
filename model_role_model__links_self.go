...
// checks if the RoleModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleModelLinksSelf{}

// RoleModelLinksSelf struct for RoleModelLinksSelf
type RoleModelLinksSelf struct {
...
type _RoleModelLinksSelf RoleModelLinksSelf
...
func (o *RoleModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *RoleModelLinksSelf) GetMethod() string {
...
func (o RoleModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o RoleModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *RoleModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleModelLinksSelf := _RoleModelLinksSelf{}

	err = json.Unmarshal(data, &varRoleModelLinksSelf)

	if err != nil {
		return err
	}

	*o = RoleModelLinksSelf(varRoleModelLinksSelf)
...
type NullableRoleModelLinksSelf struct {
	value *RoleModelLinksSelf
	isSet bool
}

func (v NullableRoleModelLinksSelf) Get() *RoleModelLinksSelf {
	return v.value
}

func (v *NullableRoleModelLinksSelf) Set(val *RoleModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleModelLinksSelf(val *RoleModelLinksSelf) *NullableRoleModelLinksSelf {
	return &NullableRoleModelLinksSelf{value: val, isSet: true}
}

func (v NullableRoleModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
