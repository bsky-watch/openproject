...
// checks if the QueryModelLinksUnstar type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryModelLinksUnstar{}

// QueryModelLinksUnstar struct for QueryModelLinksUnstar
type QueryModelLinksUnstar struct {
...
type _QueryModelLinksUnstar QueryModelLinksUnstar
...
func (o QueryModelLinksUnstar) MarshalJSON() ([]byte, error) {
...
func (o QueryModelLinksUnstar) ToMap() (map[string]interface{}, error) {
...
func (o *QueryModelLinksUnstar) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryModelLinksUnstar := _QueryModelLinksUnstar{}

	err = json.Unmarshal(data, &varQueryModelLinksUnstar)

	if err != nil {
		return err
	}

	*o = QueryModelLinksUnstar(varQueryModelLinksUnstar)
...
type NullableQueryModelLinksUnstar struct {
	value *QueryModelLinksUnstar
	isSet bool
}

func (v NullableQueryModelLinksUnstar) Get() *QueryModelLinksUnstar {
	return v.value
}

func (v *NullableQueryModelLinksUnstar) Set(val *QueryModelLinksUnstar) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryModelLinksUnstar) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryModelLinksUnstar) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryModelLinksUnstar(val *QueryModelLinksUnstar) *NullableQueryModelLinksUnstar {
	return &NullableQueryModelLinksUnstar{value: val, isSet: true}
}

func (v NullableQueryModelLinksUnstar) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryModelLinksUnstar) UnmarshalJSON(src []byte) error {
	v.isSet = true
