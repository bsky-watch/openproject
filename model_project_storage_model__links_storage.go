...
// checks if the ProjectStorageModelLinksStorage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectStorageModelLinksStorage{}

// ProjectStorageModelLinksStorage struct for ProjectStorageModelLinksStorage
type ProjectStorageModelLinksStorage struct {
...
type _ProjectStorageModelLinksStorage ProjectStorageModelLinksStorage
...
func NewProjectStorageModelLinksStorage(href string) *ProjectStorageModelLinksStorage {
	this := ProjectStorageModelLinksStorage{}
	this.Href = href
...
func (o ProjectStorageModelLinksStorage) MarshalJSON() ([]byte, error) {
...
func (o ProjectStorageModelLinksStorage) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectStorageModelLinksStorage) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectStorageModelLinksStorage := _ProjectStorageModelLinksStorage{}

	err = json.Unmarshal(data, &varProjectStorageModelLinksStorage)

	if err != nil {
		return err
	}

	*o = ProjectStorageModelLinksStorage(varProjectStorageModelLinksStorage)
...
type NullableProjectStorageModelLinksStorage struct {
	value *ProjectStorageModelLinksStorage
	isSet bool
}

func (v NullableProjectStorageModelLinksStorage) Get() *ProjectStorageModelLinksStorage {
	return v.value
}

func (v *NullableProjectStorageModelLinksStorage) Set(val *ProjectStorageModelLinksStorage) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectStorageModelLinksStorage) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectStorageModelLinksStorage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectStorageModelLinksStorage(val *ProjectStorageModelLinksStorage) *NullableProjectStorageModelLinksStorage {
	return &NullableProjectStorageModelLinksStorage{value: val, isSet: true}
}

func (v NullableProjectStorageModelLinksStorage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectStorageModelLinksStorage) UnmarshalJSON(src []byte) error {
	v.isSet = true
