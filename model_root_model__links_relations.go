...
// checks if the RootModelLinksRelations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootModelLinksRelations{}

// RootModelLinksRelations struct for RootModelLinksRelations
type RootModelLinksRelations struct {
...
type _RootModelLinksRelations RootModelLinksRelations
...
func (o *RootModelLinksRelations) SetHref(v string) {
	o.Href = v
}
...
func (o *RootModelLinksRelations) GetMethod() string {
...
func (o RootModelLinksRelations) MarshalJSON() ([]byte, error) {
...
func (o RootModelLinksRelations) ToMap() (map[string]interface{}, error) {
...
func (o *RootModelLinksRelations) UnmarshalJSON(data []byte) (err error) {
	...
	varRootModelLinksRelations := _RootModelLinksRelations{}

	err = json.Unmarshal(data, &varRootModelLinksRelations)

	if err != nil {
		return err
	}

	*o = RootModelLinksRelations(varRootModelLinksRelations)
...
type NullableRootModelLinksRelations struct {
	value *RootModelLinksRelations
	isSet bool
}

func (v NullableRootModelLinksRelations) Get() *RootModelLinksRelations {
	return v.value
}

func (v *NullableRootModelLinksRelations) Set(val *RootModelLinksRelations) {
	v.value = val
	v.isSet = true
}

func (v NullableRootModelLinksRelations) IsSet() bool {
	return v.isSet
}

func (v *NullableRootModelLinksRelations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootModelLinksRelations(val *RootModelLinksRelations) *NullableRootModelLinksRelations {
	return &NullableRootModelLinksRelations{value: val, isSet: true}
}

func (v NullableRootModelLinksRelations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootModelLinksRelations) UnmarshalJSON(src []byte) error {
	v.isSet = true
