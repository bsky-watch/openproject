...
// checks if the DayCollectionModelAllOfLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DayCollectionModelAllOfLinksSelf{}

// DayCollectionModelAllOfLinksSelf struct for DayCollectionModelAllOfLinksSelf
type DayCollectionModelAllOfLinksSelf struct {
...
type _DayCollectionModelAllOfLinksSelf DayCollectionModelAllOfLinksSelf
...
func NewDayCollectionModelAllOfLinksSelf(href string) *DayCollectionModelAllOfLinksSelf {
	this := DayCollectionModelAllOfLinksSelf{}
	this.Href = href
...
func (o DayCollectionModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o DayCollectionModelAllOfLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *DayCollectionModelAllOfLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varDayCollectionModelAllOfLinksSelf := _DayCollectionModelAllOfLinksSelf{}

	err = json.Unmarshal(data, &varDayCollectionModelAllOfLinksSelf)

	if err != nil {
		return err
	}

	*o = DayCollectionModelAllOfLinksSelf(varDayCollectionModelAllOfLinksSelf)
...
type NullableDayCollectionModelAllOfLinksSelf struct {
	value *DayCollectionModelAllOfLinksSelf
	isSet bool
}

func (v NullableDayCollectionModelAllOfLinksSelf) Get() *DayCollectionModelAllOfLinksSelf {
	return v.value
}

func (v *NullableDayCollectionModelAllOfLinksSelf) Set(val *DayCollectionModelAllOfLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableDayCollectionModelAllOfLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableDayCollectionModelAllOfLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDayCollectionModelAllOfLinksSelf(val *DayCollectionModelAllOfLinksSelf) *NullableDayCollectionModelAllOfLinksSelf {
	return &NullableDayCollectionModelAllOfLinksSelf{value: val, isSet: true}
}

func (v NullableDayCollectionModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDayCollectionModelAllOfLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
