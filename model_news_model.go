...
// checks if the NewsModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewsModel{}
...
type NewsModel struct {
	...
	Links *NewsModelLinks `json:"_links,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NewsModel NewsModel
...
// SetLinks gets a reference to the given NewsModelLinks and assigns it to the Links field.
func (o *NewsModel) SetLinks(v NewsModelLinks) {
	o.Links = &v
}

func (o NewsModel) MarshalJSON() ([]byte, error) {
...
func (o NewsModel) ToMap() (map[string]interface{}, error) {
...
func (o *NewsModel) UnmarshalJSON(data []byte) (err error) {
	varNewsModel := _NewsModel{}

	err = json.Unmarshal(data, &varNewsModel)

	if err != nil {
		return err
	}

	*o = NewsModel(varNewsModel)
...
type NullableNewsModel struct {
	value *NewsModel
	isSet bool
}

func (v NullableNewsModel) Get() *NewsModel {
	return v.value
}

func (v *NullableNewsModel) Set(val *NewsModel) {
	v.value = val
	v.isSet = true
}

func (v NullableNewsModel) IsSet() bool {
	return v.isSet
}

func (v *NullableNewsModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewsModel(val *NewsModel) *NullableNewsModel {
	return &NullableNewsModel{value: val, isSet: true}
}

func (v NullableNewsModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewsModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
