...
var _ MappedNullable = &RelationModel{}
...
type _RelationModel RelationModel
...
// GetReverseType returns the ReverseType field value if set, zero value otherwise.
func (o *RelationModel) GetReverseType() string {
	if o == nil || IsNil(o.ReverseType) {
		var ret string
		return ret
	}
	return *o.ReverseType
}

// GetReverseTypeOk returns a tuple with the ReverseType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RelationModel) GetReverseTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ReverseType) {
		return nil, false
	}
	return o.ReverseType, true
}
...
// SetReverseType gets a reference to the given string and assigns it to the ReverseType field.
...
// SetLinks gets a reference to the given RelationModelLinks and assigns it to the Links field.
func (o *RelationModel) SetLinks(v RelationModelLinks) {
	o.Links = &v
}

func (o RelationModel) MarshalJSON() ([]byte, error) {
...
func (o *RelationModel) UnmarshalJSON(data []byte) (err error) {
	...
	*o = RelationModel(varRelationModel)
...
type NullableRelationModel struct {
	value *RelationModel
	isSet bool
}

func (v NullableRelationModel) Get() *RelationModel {
	return v.value
}

func (v *NullableRelationModel) Set(val *RelationModel) {
	v.value = val
	v.isSet = true
}

func (v NullableRelationModel) IsSet() bool {
	return v.isSet
}

func (v *NullableRelationModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRelationModel(val *RelationModel) *NullableRelationModel {
	return &NullableRelationModel{value: val, isSet: true}
}

func (v NullableRelationModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRelationModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
