...
// checks if the StorageReadModelLinksType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageReadModelLinksType{}

// StorageReadModelLinksType struct for StorageReadModelLinksType
type StorageReadModelLinksType struct {
...
type _StorageReadModelLinksType StorageReadModelLinksType
...
func NewStorageReadModelLinksType(href string) *StorageReadModelLinksType {
	this := StorageReadModelLinksType{}
	this.Href = href
...
func (o *StorageReadModelLinksType) SetHref(v string) {
	o.Href = v
}
...
func (o *StorageReadModelLinksType) GetMethod() string {
...
func (o StorageReadModelLinksType) MarshalJSON() ([]byte, error) {
...
func (o StorageReadModelLinksType) ToMap() (map[string]interface{}, error) {
...
func (o *StorageReadModelLinksType) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageReadModelLinksType := _StorageReadModelLinksType{}

	err = json.Unmarshal(data, &varStorageReadModelLinksType)

	if err != nil {
		return err
	}

	*o = StorageReadModelLinksType(varStorageReadModelLinksType)
...
type NullableStorageReadModelLinksType struct {
	value *StorageReadModelLinksType
	isSet bool
}

func (v NullableStorageReadModelLinksType) Get() *StorageReadModelLinksType {
	return v.value
}

func (v *NullableStorageReadModelLinksType) Set(val *StorageReadModelLinksType) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageReadModelLinksType) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageReadModelLinksType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageReadModelLinksType(val *StorageReadModelLinksType) *NullableStorageReadModelLinksType {
	return &NullableStorageReadModelLinksType{value: val, isSet: true}
}

func (v NullableStorageReadModelLinksType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageReadModelLinksType) UnmarshalJSON(src []byte) error {
	v.isSet = true
