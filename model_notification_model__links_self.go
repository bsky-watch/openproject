...
// checks if the NotificationModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationModelLinksSelf{}

// NotificationModelLinksSelf struct for NotificationModelLinksSelf
type NotificationModelLinksSelf struct {
...
type _NotificationModelLinksSelf NotificationModelLinksSelf
...
func NewNotificationModelLinksSelf(href string) *NotificationModelLinksSelf {
	this := NotificationModelLinksSelf{}
	this.Href = href
...
func (o *NotificationModelLinksSelf) SetHref(v string) {
	o.Href = v
}
...
func (o *NotificationModelLinksSelf) GetMethod() string {
...
func (o NotificationModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o NotificationModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationModelLinksSelf := _NotificationModelLinksSelf{}

	err = json.Unmarshal(data, &varNotificationModelLinksSelf)

	if err != nil {
		return err
	}

	*o = NotificationModelLinksSelf(varNotificationModelLinksSelf)
...
type NullableNotificationModelLinksSelf struct {
	value *NotificationModelLinksSelf
	isSet bool
}

func (v NullableNotificationModelLinksSelf) Get() *NotificationModelLinksSelf {
	return v.value
}

func (v *NullableNotificationModelLinksSelf) Set(val *NotificationModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationModelLinksSelf(val *NotificationModelLinksSelf) *NullableNotificationModelLinksSelf {
	return &NullableNotificationModelLinksSelf{value: val, isSet: true}
}

func (v NullableNotificationModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
