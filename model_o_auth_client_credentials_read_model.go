...
// checks if the OAuthClientCredentialsReadModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OAuthClientCredentialsReadModel{}

// OAuthClientCredentialsReadModel struct for OAuthClientCredentialsReadModel
type OAuthClientCredentialsReadModel struct {
	Id int `json:"id"`
	...
	Links OAuthClientCredentialsReadModelLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _OAuthClientCredentialsReadModel OAuthClientCredentialsReadModel
...
func NewOAuthClientCredentialsReadModel(id int, type_ string, clientId string, confidential bool, links OAuthClientCredentialsReadModelLinks) *OAuthClientCredentialsReadModel {
	this := OAuthClientCredentialsReadModel{}
	this.Id = id
	this.Type = type_
...
func (o *OAuthClientCredentialsReadModel) GetId() int {
	if o == nil {
		var ret int
		return ret
	}
...
func (o *OAuthClientCredentialsReadModel) GetIdOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *OAuthClientCredentialsReadModel) SetId(v int) {
	o.Id = v
}
...
func (o *OAuthClientCredentialsReadModel) GetLinks() OAuthClientCredentialsReadModelLinks {
	if o == nil {
		var ret OAuthClientCredentialsReadModelLinks
		return ret
	}
...
func (o OAuthClientCredentialsReadModel) MarshalJSON() ([]byte, error) {
...
func (o OAuthClientCredentialsReadModel) ToMap() (map[string]interface{}, error) {
...
func (o *OAuthClientCredentialsReadModel) UnmarshalJSON(data []byte) (err error) {
	...
	varOAuthClientCredentialsReadModel := _OAuthClientCredentialsReadModel{}

	err = json.Unmarshal(data, &varOAuthClientCredentialsReadModel)

	if err != nil {
		return err
	}

	*o = OAuthClientCredentialsReadModel(varOAuthClientCredentialsReadModel)
...
type NullableOAuthClientCredentialsReadModel struct {
	value *OAuthClientCredentialsReadModel
	isSet bool
}

func (v NullableOAuthClientCredentialsReadModel) Get() *OAuthClientCredentialsReadModel {
	return v.value
}

func (v *NullableOAuthClientCredentialsReadModel) Set(val *OAuthClientCredentialsReadModel) {
	v.value = val
	v.isSet = true
}

func (v NullableOAuthClientCredentialsReadModel) IsSet() bool {
	return v.isSet
}

func (v *NullableOAuthClientCredentialsReadModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOAuthClientCredentialsReadModel(val *OAuthClientCredentialsReadModel) *NullableOAuthClientCredentialsReadModel {
	return &NullableOAuthClientCredentialsReadModel{value: val, isSet: true}
}

func (v NullableOAuthClientCredentialsReadModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOAuthClientCredentialsReadModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
