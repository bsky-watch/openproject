...
// checks if the TimeEntryModelLinksWorkPackage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeEntryModelLinksWorkPackage{}

// TimeEntryModelLinksWorkPackage struct for TimeEntryModelLinksWorkPackage
type TimeEntryModelLinksWorkPackage struct {
...
type _TimeEntryModelLinksWorkPackage TimeEntryModelLinksWorkPackage
...
func NewTimeEntryModelLinksWorkPackage(href string) *TimeEntryModelLinksWorkPackage {
	this := TimeEntryModelLinksWorkPackage{}
	this.Href = href
...
func (o TimeEntryModelLinksWorkPackage) MarshalJSON() ([]byte, error) {
...
func (o TimeEntryModelLinksWorkPackage) ToMap() (map[string]interface{}, error) {
...
func (o *TimeEntryModelLinksWorkPackage) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeEntryModelLinksWorkPackage := _TimeEntryModelLinksWorkPackage{}

	err = json.Unmarshal(data, &varTimeEntryModelLinksWorkPackage)

	if err != nil {
		return err
	}

	*o = TimeEntryModelLinksWorkPackage(varTimeEntryModelLinksWorkPackage)
...
type NullableTimeEntryModelLinksWorkPackage struct {
	value *TimeEntryModelLinksWorkPackage
	isSet bool
}

func (v NullableTimeEntryModelLinksWorkPackage) Get() *TimeEntryModelLinksWorkPackage {
	return v.value
}

func (v *NullableTimeEntryModelLinksWorkPackage) Set(val *TimeEntryModelLinksWorkPackage) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeEntryModelLinksWorkPackage) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeEntryModelLinksWorkPackage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeEntryModelLinksWorkPackage(val *TimeEntryModelLinksWorkPackage) *NullableTimeEntryModelLinksWorkPackage {
	return &NullableTimeEntryModelLinksWorkPackage{value: val, isSet: true}
}

func (v NullableTimeEntryModelLinksWorkPackage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeEntryModelLinksWorkPackage) UnmarshalJSON(src []byte) error {
	v.isSet = true
