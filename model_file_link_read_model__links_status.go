...
// checks if the FileLinkReadModelLinksStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileLinkReadModelLinksStatus{}

// FileLinkReadModelLinksStatus struct for FileLinkReadModelLinksStatus
type FileLinkReadModelLinksStatus struct {
...
type _FileLinkReadModelLinksStatus FileLinkReadModelLinksStatus
...
func NewFileLinkReadModelLinksStatus(href string) *FileLinkReadModelLinksStatus {
	this := FileLinkReadModelLinksStatus{}
	this.Href = href
...
func (o *FileLinkReadModelLinksStatus) SetHref(v string) {
	o.Href = v
}
...
func (o *FileLinkReadModelLinksStatus) GetMethod() string {
...
func (o FileLinkReadModelLinksStatus) MarshalJSON() ([]byte, error) {
...
func (o FileLinkReadModelLinksStatus) ToMap() (map[string]interface{}, error) {
...
func (o *FileLinkReadModelLinksStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varFileLinkReadModelLinksStatus := _FileLinkReadModelLinksStatus{}

	err = json.Unmarshal(data, &varFileLinkReadModelLinksStatus)

	if err != nil {
		return err
	}

	*o = FileLinkReadModelLinksStatus(varFileLinkReadModelLinksStatus)
...
type NullableFileLinkReadModelLinksStatus struct {
	value *FileLinkReadModelLinksStatus
	isSet bool
}

func (v NullableFileLinkReadModelLinksStatus) Get() *FileLinkReadModelLinksStatus {
	return v.value
}

func (v *NullableFileLinkReadModelLinksStatus) Set(val *FileLinkReadModelLinksStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableFileLinkReadModelLinksStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableFileLinkReadModelLinksStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileLinkReadModelLinksStatus(val *FileLinkReadModelLinksStatus) *NullableFileLinkReadModelLinksStatus {
	return &NullableFileLinkReadModelLinksStatus{value: val, isSet: true}
}

func (v NullableFileLinkReadModelLinksStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileLinkReadModelLinksStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
