...
// checks if the AttachmentModelLinksDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttachmentModelLinksDelete{}

// AttachmentModelLinksDelete struct for AttachmentModelLinksDelete
type AttachmentModelLinksDelete struct {
...
type _AttachmentModelLinksDelete AttachmentModelLinksDelete
...
func NewAttachmentModelLinksDelete(href string) *AttachmentModelLinksDelete {
	this := AttachmentModelLinksDelete{}
	this.Href = href
...
func (o AttachmentModelLinksDelete) MarshalJSON() ([]byte, error) {
...
func (o AttachmentModelLinksDelete) ToMap() (map[string]interface{}, error) {
...
func (o *AttachmentModelLinksDelete) UnmarshalJSON(data []byte) (err error) {
	...
	varAttachmentModelLinksDelete := _AttachmentModelLinksDelete{}

	err = json.Unmarshal(data, &varAttachmentModelLinksDelete)

	if err != nil {
		return err
	}

	*o = AttachmentModelLinksDelete(varAttachmentModelLinksDelete)
...
type NullableAttachmentModelLinksDelete struct {
	value *AttachmentModelLinksDelete
	isSet bool
}

func (v NullableAttachmentModelLinksDelete) Get() *AttachmentModelLinksDelete {
	return v.value
}

func (v *NullableAttachmentModelLinksDelete) Set(val *AttachmentModelLinksDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableAttachmentModelLinksDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableAttachmentModelLinksDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttachmentModelLinksDelete(val *AttachmentModelLinksDelete) *NullableAttachmentModelLinksDelete {
	return &NullableAttachmentModelLinksDelete{value: val, isSet: true}
}

func (v NullableAttachmentModelLinksDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttachmentModelLinksDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
