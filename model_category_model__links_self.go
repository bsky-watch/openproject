...
// checks if the CategoryModelLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryModelLinksSelf{}

// CategoryModelLinksSelf struct for CategoryModelLinksSelf
type CategoryModelLinksSelf struct {
...
type _CategoryModelLinksSelf CategoryModelLinksSelf
...
func (o CategoryModelLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o CategoryModelLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryModelLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryModelLinksSelf := _CategoryModelLinksSelf{}

	err = json.Unmarshal(data, &varCategoryModelLinksSelf)

	if err != nil {
		return err
	}

	*o = CategoryModelLinksSelf(varCategoryModelLinksSelf)
...
type NullableCategoryModelLinksSelf struct {
	value *CategoryModelLinksSelf
	isSet bool
}

func (v NullableCategoryModelLinksSelf) Get() *CategoryModelLinksSelf {
	return v.value
}

func (v *NullableCategoryModelLinksSelf) Set(val *CategoryModelLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryModelLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryModelLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryModelLinksSelf(val *CategoryModelLinksSelf) *NullableCategoryModelLinksSelf {
	return &NullableCategoryModelLinksSelf{value: val, isSet: true}
}

func (v NullableCategoryModelLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryModelLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
