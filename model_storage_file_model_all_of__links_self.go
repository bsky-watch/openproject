...
// checks if the StorageFileModelAllOfLinksSelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageFileModelAllOfLinksSelf{}

// StorageFileModelAllOfLinksSelf struct for StorageFileModelAllOfLinksSelf
type StorageFileModelAllOfLinksSelf struct {
...
type _StorageFileModelAllOfLinksSelf StorageFileModelAllOfLinksSelf
...
func NewStorageFileModelAllOfLinksSelf(href string) *StorageFileModelAllOfLinksSelf {
	this := StorageFileModelAllOfLinksSelf{}
	this.Href = href
...
func (o StorageFileModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
...
func (o StorageFileModelAllOfLinksSelf) ToMap() (map[string]interface{}, error) {
...
func (o *StorageFileModelAllOfLinksSelf) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageFileModelAllOfLinksSelf := _StorageFileModelAllOfLinksSelf{}

	err = json.Unmarshal(data, &varStorageFileModelAllOfLinksSelf)

	if err != nil {
		return err
	}

	*o = StorageFileModelAllOfLinksSelf(varStorageFileModelAllOfLinksSelf)
...
type NullableStorageFileModelAllOfLinksSelf struct {
	value *StorageFileModelAllOfLinksSelf
	isSet bool
}

func (v NullableStorageFileModelAllOfLinksSelf) Get() *StorageFileModelAllOfLinksSelf {
	return v.value
}

func (v *NullableStorageFileModelAllOfLinksSelf) Set(val *StorageFileModelAllOfLinksSelf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageFileModelAllOfLinksSelf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageFileModelAllOfLinksSelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageFileModelAllOfLinksSelf(val *StorageFileModelAllOfLinksSelf) *NullableStorageFileModelAllOfLinksSelf {
	return &NullableStorageFileModelAllOfLinksSelf{value: val, isSet: true}
}

func (v NullableStorageFileModelAllOfLinksSelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageFileModelAllOfLinksSelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
