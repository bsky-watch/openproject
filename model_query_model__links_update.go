...
// checks if the QueryModelLinksUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryModelLinksUpdate{}

// QueryModelLinksUpdate struct for QueryModelLinksUpdate
type QueryModelLinksUpdate struct {
...
type _QueryModelLinksUpdate QueryModelLinksUpdate
...
func (o *QueryModelLinksUpdate) SetHref(v string) {
	o.Href = v
}
...
func (o *QueryModelLinksUpdate) GetMethod() string {
...
func (o QueryModelLinksUpdate) MarshalJSON() ([]byte, error) {
...
func (o QueryModelLinksUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *QueryModelLinksUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryModelLinksUpdate := _QueryModelLinksUpdate{}

	err = json.Unmarshal(data, &varQueryModelLinksUpdate)

	if err != nil {
		return err
	}

	*o = QueryModelLinksUpdate(varQueryModelLinksUpdate)
...
type NullableQueryModelLinksUpdate struct {
	value *QueryModelLinksUpdate
	isSet bool
}

func (v NullableQueryModelLinksUpdate) Get() *QueryModelLinksUpdate {
	return v.value
}

func (v *NullableQueryModelLinksUpdate) Set(val *QueryModelLinksUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryModelLinksUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryModelLinksUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryModelLinksUpdate(val *QueryModelLinksUpdate) *NullableQueryModelLinksUpdate {
	return &NullableQueryModelLinksUpdate{value: val, isSet: true}
}

func (v NullableQueryModelLinksUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryModelLinksUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
