...
// checks if the UserModelAllOfLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserModelAllOfLinks{}

// UserModelAllOfLinks struct for UserModelAllOfLinks
type UserModelAllOfLinks struct {
	ShowUser *UserModelAllOfLinksShowUser `json:"showUser,omitempty"`
	UpdateImmediately *UserModelAllOfLinksUpdateImmediately `json:"updateImmediately,omitempty"`
	Lock *UserModelAllOfLinksLock `json:"lock,omitempty"`
	Unlock *UserModelAllOfLinksUnlock `json:"unlock,omitempty"`
	Delete *UserModelAllOfLinksDelete `json:"delete,omitempty"`
	AuthSource *UserModelAllOfLinksAuthSource `json:"authSource,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UserModelAllOfLinks UserModelAllOfLinks
...
// GetShowUser returns the ShowUser field value if set, zero value otherwise.
func (o *UserModelAllOfLinks) GetShowUser() UserModelAllOfLinksShowUser {
	if o == nil || IsNil(o.ShowUser) {
		var ret UserModelAllOfLinksShowUser
		return ret
	}
	return *o.ShowUser
}

// GetShowUserOk returns a tuple with the ShowUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserModelAllOfLinks) GetShowUserOk() (*UserModelAllOfLinksShowUser, bool) {
	if o == nil || IsNil(o.ShowUser) {
		return nil, false
	}
	return o.ShowUser, true
}
...
// SetShowUser gets a reference to the given UserModelAllOfLinksShowUser and assigns it to the ShowUser field.
...
func (o *UserModelAllOfLinks) GetUpdateImmediately() UserModelAllOfLinksUpdateImmediately {
	if o == nil || IsNil(o.UpdateImmediately) {
		var ret UserModelAllOfLinksUpdateImmediately
		return ret
	}
...
// SetUpdateImmediately gets a reference to the given UserModelAllOfLinksUpdateImmediately and assigns it to the UpdateImmediately field.
...
func (o *UserModelAllOfLinks) GetLock() UserModelAllOfLinksLock {
	if o == nil || IsNil(o.Lock) {
		var ret UserModelAllOfLinksLock
		return ret
	}
	return *o.Lock
}
...
// SetLock gets a reference to the given UserModelAllOfLinksLock and assigns it to the Lock field.
...
func (o *UserModelAllOfLinks) GetUnlock() UserModelAllOfLinksUnlock {
	if o == nil || IsNil(o.Unlock) {
		var ret UserModelAllOfLinksUnlock
		return ret
	}
	return *o.Unlock
}
...
// SetUnlock gets a reference to the given UserModelAllOfLinksUnlock and assigns it to the Unlock field.
...
func (o *UserModelAllOfLinks) GetDelete() UserModelAllOfLinksDelete {
	if o == nil || IsNil(o.Delete) {
		var ret UserModelAllOfLinksDelete
		return ret
	}
	return *o.Delete
}
...
// SetDelete gets a reference to the given UserModelAllOfLinksDelete and assigns it to the Delete field.
...
func (o *UserModelAllOfLinks) GetAuthSource() UserModelAllOfLinksAuthSource {
	if o == nil || IsNil(o.AuthSource) {
		var ret UserModelAllOfLinksAuthSource
		return ret
	}
	return *o.AuthSource
}
...
// SetAuthSource gets a reference to the given UserModelAllOfLinksAuthSource and assigns it to the AuthSource field.
func (o *UserModelAllOfLinks) SetAuthSource(v UserModelAllOfLinksAuthSource) {
	o.AuthSource = &v
}

func (o UserModelAllOfLinks) MarshalJSON() ([]byte, error) {
...
func (o UserModelAllOfLinks) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ShowUser) {
		toSerialize["showUser"] = o.ShowUser
	}
...
func (o *UserModelAllOfLinks) UnmarshalJSON(data []byte) (err error) {
	varUserModelAllOfLinks := _UserModelAllOfLinks{}

	err = json.Unmarshal(data, &varUserModelAllOfLinks)

	if err != nil {
		return err
	}

	*o = UserModelAllOfLinks(varUserModelAllOfLinks)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "showUser")
		...
		delete(additionalProperties, "authSource")
...
type NullableUserModelAllOfLinks struct {
	value *UserModelAllOfLinks
	isSet bool
}

func (v NullableUserModelAllOfLinks) Get() *UserModelAllOfLinks {
	return v.value
}

func (v *NullableUserModelAllOfLinks) Set(val *UserModelAllOfLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableUserModelAllOfLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableUserModelAllOfLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserModelAllOfLinks(val *UserModelAllOfLinks) *NullableUserModelAllOfLinks {
	return &NullableUserModelAllOfLinks{value: val, isSet: true}
}

func (v NullableUserModelAllOfLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserModelAllOfLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
