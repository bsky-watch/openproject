...
// checks if the FileLinkReadModelLinksCreator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileLinkReadModelLinksCreator{}

// FileLinkReadModelLinksCreator struct for FileLinkReadModelLinksCreator
type FileLinkReadModelLinksCreator struct {
...
type _FileLinkReadModelLinksCreator FileLinkReadModelLinksCreator
...
func NewFileLinkReadModelLinksCreator(href string) *FileLinkReadModelLinksCreator {
	this := FileLinkReadModelLinksCreator{}
	this.Href = href
...
func (o *FileLinkReadModelLinksCreator) SetHref(v string) {
	o.Href = v
}
...
func (o *FileLinkReadModelLinksCreator) GetMethod() string {
...
func (o FileLinkReadModelLinksCreator) MarshalJSON() ([]byte, error) {
...
func (o FileLinkReadModelLinksCreator) ToMap() (map[string]interface{}, error) {
...
func (o *FileLinkReadModelLinksCreator) UnmarshalJSON(data []byte) (err error) {
	...
	varFileLinkReadModelLinksCreator := _FileLinkReadModelLinksCreator{}

	err = json.Unmarshal(data, &varFileLinkReadModelLinksCreator)

	if err != nil {
		return err
	}

	*o = FileLinkReadModelLinksCreator(varFileLinkReadModelLinksCreator)
...
type NullableFileLinkReadModelLinksCreator struct {
	value *FileLinkReadModelLinksCreator
	isSet bool
}

func (v NullableFileLinkReadModelLinksCreator) Get() *FileLinkReadModelLinksCreator {
	return v.value
}

func (v *NullableFileLinkReadModelLinksCreator) Set(val *FileLinkReadModelLinksCreator) {
	v.value = val
	v.isSet = true
}

func (v NullableFileLinkReadModelLinksCreator) IsSet() bool {
	return v.isSet
}

func (v *NullableFileLinkReadModelLinksCreator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileLinkReadModelLinksCreator(val *FileLinkReadModelLinksCreator) *NullableFileLinkReadModelLinksCreator {
	return &NullableFileLinkReadModelLinksCreator{value: val, isSet: true}
}

func (v NullableFileLinkReadModelLinksCreator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileLinkReadModelLinksCreator) UnmarshalJSON(src []byte) error {
	v.isSet = true
