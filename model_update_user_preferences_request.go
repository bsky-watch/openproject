...
type UpdateUserPreferencesRequest struct {
	AutoHidePopups *bool `json:"autoHidePopups,omitempty"`
	TimeZone *string `json:"timeZone,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UpdateUserPreferencesRequest UpdateUserPreferencesRequest
...
// GetAutoHidePopups returns the AutoHidePopups field value if set, zero value otherwise.
func (o *UpdateUserPreferencesRequest) GetAutoHidePopups() bool {
	if o == nil || IsNil(o.AutoHidePopups) {
		var ret bool
		return ret
	}
	return *o.AutoHidePopups
}

// GetAutoHidePopupsOk returns a tuple with the AutoHidePopups field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateUserPreferencesRequest) GetAutoHidePopupsOk() (*bool, bool) {
	if o == nil || IsNil(o.AutoHidePopups) {
		return nil, false
	}
	return o.AutoHidePopups, true
}
...
// SetAutoHidePopups gets a reference to the given bool and assigns it to the AutoHidePopups field.
...
func (o UpdateUserPreferencesRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AutoHidePopups) {
		toSerialize["autoHidePopups"] = o.AutoHidePopups
	}
	if !IsNil(o.TimeZone) {
...
func (o *UpdateUserPreferencesRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdateUserPreferencesRequest := _UpdateUserPreferencesRequest{}

	err = json.Unmarshal(data, &varUpdateUserPreferencesRequest)

	if err != nil {
		return err
	}

	*o = UpdateUserPreferencesRequest(varUpdateUserPreferencesRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "autoHidePopups")
